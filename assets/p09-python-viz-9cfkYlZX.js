...
`);d?d.setCode(z):d=V(b,{language:"python",code:z,readOnly:window.innerWidth<768})}o(),v();const E=()=>{o(),v()};return window.addEventListener("resize",E),{destroy(){if(window.removeEventListener("resize",E),d){try{d.destroy()}catch{}d=null}}}}function te(){return`
