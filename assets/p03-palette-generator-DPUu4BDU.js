...
`)}
}`;default:return""}}function qe(){return`
<style id="p3-styles">
/* ── Hero ── */
.p3-hero {
  min-height: 100vh;
...
<div class="page-scroll">
  ...
  `).join(""),requestAnimationFrame(()=>{a.forEach((e,r)=>{const o=document.getElementById(`p3-err-bad-${r}`),n=document.getElementById(`p3-err-good-${r}`);o&&e.badFn(o),n&&e.goodFn(n)})})}function Ee(){const t=document.getElementById("p3-next-btn"),a=document.getElementById("p3-prev-btn");t&&t.addEventListener("click",()=>{try{O("m1-p4")}catch{}}),a&&a.addEventListener("click",()=>{try{O("m1-p2")}catch{}})}function _e(){re(),clearTimeout(H),s.tabInstances.forEach(a=>{try{a.destroy()}catch{}}),s.tabInstances=[],s.copyInstances.forEach(a=>{try{a.destroy()}catch{}}),s.copyInstances=[];const t=document.getElementById("p3-styles");t&&t.remove(),s.generatedColors=[],s.hslValues=[]}export{_e as destroy,Le as init,qe as render};
