import{k as G,g as B,f as x}from"./ScrollAnimations-B5Kyk-Xq.js";import{n as C}from"./index-oP3tVZec.js";let a=[],g=[];const f=[{id:"select",name:"选择工具",shortcut:"V",category:"select",desc:"选中、移动、缩放和旋转完整对象。按住 Shift 多选，拖拽角点等比缩放。",use:"选中并整体移动图表元素、调整整体尺寸",svgDemo:`<svg viewBox="0 0 160 120" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%">
