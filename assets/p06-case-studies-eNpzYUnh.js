    ...
    <div class="p06-ba-row">
      <div>
        ...
        <div style="aspect-ratio:16/9;overflow:hidden;border-radius:var(--radius-md);">
          <img src="/sci-aesthetic/assets/m2/p06-case1-draft.png" alt="Case 1 draft graphical abstract" style="width:100%;height:100%;object-fit:cover;display:block;">
        </div>
      </div>
      <div>
        <p class="p06-ba-label light">最终成果</p>
        <div style="aspect-ratio:16/9;overflow:hidden;border-radius:var(--radius-md);">
          <img src="/sci-aesthetic/assets/m2/p06-case1-final-ga.png" alt="Case 1 final graphical abstract" style="width:100%;height:100%;object-fit:cover;display:block;">
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="max-width:1100px;margin:0 auto;">
    ...
    <div class="p06-ph-wrap">
      ...
      <div style="max-width:900px;margin:0 auto;">
        <img src="/sci-aesthetic/assets/m2/p06-case2-microplastic.png" alt="Microplastic migration methodology figure" style="width:100%;height:auto;border-radius:var(--radius-md);display:block;">
      </div>
    </div>
  </div>
</section>
  ...
  <div style="max-width:1100px;margin:0 auto;">
    ...
    <div class="p06-ph-wrap">
      ...
      <div style="max-width:800px;margin:0 auto;">
        <img src="/sci-aesthetic/assets/m2/p06-case3-carbon.png" alt="Carbon cycle review conceptual figure" style="width:100%;height:auto;border-radius:var(--radius-md);display:block;">
      </div>
    </div>
  </div>
</section>
