import{k as L,g as A,f as k}from"./ScrollAnimations-B5Kyk-Xq.js";import{n as B}from"./index-BY6Mz6oK.js";let z=[],P=[],x=[],i={points:[{x:.15,y:.7,type:"anchor"},{x:.25,y:.2,type:"control"},{x:.75,y:.8,type:"control"},{x:.85,y:.3,type:"anchor"}],mode:"cubic",showHandles:!0,showGrid:!0,dragging:null};const C=()=>[{x:.15,y:.7,type:"anchor"},{x:.25,y:.2,type:"control"},{x:.75,y:.8,type:"control"},{x:.85,y:.3,type:"anchor"}],S=[{name:"S 形曲线",icon:"〜",desc:"表示渐进过渡、S 型增长曲线",points:[{x:.1,y:.7,type:"anchor"},{x:.2,y:.1,type:"control"},{x:.8,y:.9,type:"control"},{x:.9,y:.3,type:"anchor"}]},{name:"弯曲箭头",icon:"↗",desc:"流程图连接线，方向明确",points:[{x:.1,y:.8,type:"anchor"},{x:.1,y:.3,type:"control"},{x:.9,y:.3,type:"control"},{x:.9,y:.2,type:"anchor"}]},{name:"拱形",icon:"⌒",desc:"表示路径、通道、拱门结构",points:[{x:.1,y:.8,type:"anchor"},{x:.1,y:.2,type:"control"},{x:.9,y:.2,type:"control"},{x:.9,y:.8,type:"anchor"}]},{name:"波浪线",icon:"≈",desc:"表示振动、波动现象（单段近似）",points:[{x:.05,y:.5,type:"anchor"},{x:.2,y:.15,type:"control"},{x:.45,y:.85,type:"control"},{x:.5,y:.5,type:"anchor"}]}],b=[{id:"ch1",name:"复现 S 形曲线",difficulty:"⭐",target:[{x:.1,y:.7,type:"anchor"},{x:.2,y:.1,type:"control"},{x:.8,y:.9,type:"control"},{x:.9,y:.3,type:"anchor"}],hint:"把上方控制点向左拉，下方控制点向右拉"},{id:"ch2",name:"画出对称拱形",difficulty:"⭐⭐",target:[{x:.1,y:.85,type:"anchor"},{x:.1,y:.15,type:"control"},{x:.9,y:.15,type:"control"},{x:.9,y:.85,type:"anchor"}],hint:"两个控制手柄应对称，高度相同"},{id:"ch3",name:"弯曲连接箭头",difficulty:"⭐⭐⭐",target:[{x:.1,y:.8,type:"anchor"},{x:.15,y:.2,type:"control"},{x:.85,y:.2,type:"control"},{x:.9,y:.8,type:"anchor"}],hint:"两根手柄垂直向上拉，终点在右上方"}];let g={currentIndex:0,userPoints:null};function j(){return`<div class="page-scroll">
<style>
/* ── p03 hero ── */
