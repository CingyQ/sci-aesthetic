import{k as Xt,g as et}from"./ScrollAnimations-B5Kyk-Xq.js";import{c as Qt}from"./CodeEditor-BiI1SvFS.js";import{c as te}from"./CopyButton-2sIiwDp8.js";import{n as At}from"./index-CKSdhN-L.js";import{a as _t,n as ee,i as Rt,d as ae,e as Ht,f as re,g as oe,l as _,r as ft,b as R,p as Pt,h as Ct,s as Lt}from"./transform-ZU6R_1Oi.js";import{m as D}from"./min-D1slsF82.js";import{m as B}from"./max-DBeXZoyG.js";import{a as ie,c as ht,s as Mt}from"./ramp-BVcNPFnM.js";import{b as ne}from"./bin-mVdl7xVY.js";import{s as wt}from"./sum-CB6J5KXz.js";import{w as le,c as at}from"./path-CbwjOpE9.js";import{t as se,a as K,p as ce}from"./math-CRUJxRjv.js";import{a as M,b as E,c as de}from"./axis-FVV8vvN_.js";import{a as J}from"./area-D7iSONw5.js";import{l as X,c as pe}from"./line-Ci26EkcQ.js";import{n as fe,s as dt,m as Wt}from"./stack-Dxh_ZBJe.js";import{R as he}from"./RdBu-DUpo4zJF.js";import{c as It}from"./catmullRom-Dm0ttBHj.js";function ge(t=_t){if(t===_t)return qt;if(typeof t!="function")throw new TypeError("compare is not a function");return(e,a)=>{const o=t(e,a);return o||o===0?o:(t(a,a)===0)-(t(e,e)===0)}}function qt(t,e){return(t==null||!(t>=t))-(e==null||!(e>=e))||(t<e?-1:t>e?1:0)}function Vt(t,e,a=0,o=1/0,s){if(e=Math.floor(e),a=Math.floor(Math.max(0,a)),o=Math.floor(Math.min(t.length-1,o)),!(a<=e&&e<=o))return t;for(s=s===void 0?qt:ge(s);o>a;){if(o-a>600){const b=o-a+1,y=e-a+1,p=Math.log(b),h=.5*Math.exp(2*p/3),c=.5*Math.sqrt(p*h*(b-h)/b)*(y-b/2<0?-1:1),m=Math.max(a,Math.floor(e-y*h/b+c)),l=Math.min(o,Math.floor(e+(b-y)*h/b+c));Vt(t,e,m,l,s)}const r=t[e];let i=a,f=o;for(N(t,a,e),s(t[o],r)>0&&N(t,a,o);i<f;){for(N(t,i,f),++i,--f;s(t[i],r)<0;)++i;for(;s(t[f],r)>0;)--f}s(t[a],r)===0?N(t,a,f):(++f,N(t,f,o)),f<=e&&(a=f+1),e<=f&&(o=f-1)}return t}function N(t,e,a){const o=t[e];t[e]=t[a],t[a]=o}function O(t,e,a){if(t=Float64Array.from(ee(t)),!(!(o=t.length)||isNaN(e=+e))){if(e<=0||o<2)return D(t);if(e>=1)return B(t);var o,s=(o-1)*e,r=Math.floor(s),i=B(Vt(t,r).subarray(0,r+1)),f=D(t.subarray(r+1));return i+(f-i)*(s-r)}}function pt(t,e){let a=0,o=0;if(e===void 0)for(let s of t)s!=null&&(s=+s)>=s&&(++a,o+=s);else{let s=-1;for(let r of t)(r=e(r,++s,t))!=null&&(r=+r)>=r&&(++a,o+=r)}if(a)return o/a}function me(t,e){e===void 0&&(e=t,t=Rt);for(var a=0,o=e.length-1,s=e[0],r=new Array(o<0?0:o);a<o;)r[a]=t(s,s=e[++a]);return function(i){var f=Math.max(0,Math.min(o-1,Math.floor(i*=o)));return r[f](i-f)}}function be(){var t=0,e=.5,a=1,o=1,s,r,i,f,b,y=Ht,p,h=!1,c;function m(n){return isNaN(n=+n)?c:(n=.5+((n=+p(n))-r)*(o*n<o*r?f:b),y(h?Math.max(0,Math.min(1,n)):n))}m.domain=function(n){return arguments.length?([t,e,a]=n,s=p(t=+t),r=p(e=+e),i=p(a=+a),f=s===r?0:.5/(r-s),b=r===i?0:.5/(i-r),o=r<s?-1:1,m):[t,e,a]},m.clamp=function(n){return arguments.length?(h=!!n,m):h},m.interpolator=function(n){return arguments.length?(y=n,m):y};function l(n){return function(x){var u,d,g;return arguments.length?([u,d,g]=x,y=me(n,[u,d,g]),m):[y(0),y(.5),y(1)]}}return m.range=l(Rt),m.rangeRound=l(oe),m.unknown=function(n){return arguments.length?(c=n,m):c},function(n){return p=n,s=n(t),r=n(e),i=n(a),f=s===r?0:.5/(r-s),b=r===i?0:.5/(i-r),o=r<s?-1:1,m}}function jt(){var t=ae(be()(Ht));return t.copy=function(){return ie(t,jt())},re.apply(t,arguments)}function gt(t){var e=t.length;return function(a){return t[Math.max(0,Math.min(e-1,Math.floor(a*e)))]}}const ue=gt(ht(""));gt(ht(""));gt(ht(""));var xe=gt(ht(""));const kt={draw(t,e){const a=K(e/ce);t.moveTo(a,0),t.arc(0,0,a,0,se)}},ye={draw(t,e){const a=K(e/5)/2;t.moveTo(-3*a,-a),t.lineTo(-a,-a),t.lineTo(-a,-3*a),t.lineTo(a,-3*a),t.lineTo(a,-a),t.lineTo(3*a,-a),t.lineTo(3*a,a),t.lineTo(a,a),t.lineTo(a,3*a),t.lineTo(-a,3*a),t.lineTo(-a,a),t.lineTo(-3*a,a),t.closePath()}},ve={draw(t,e){const a=K(e),o=-a/2;t.rect(o,o,a,a)}},xt=K(3),we={draw(t,e){const a=-K(e/(xt*3));t.moveTo(0,a*2),t.lineTo(-xt*a,-a),t.lineTo(xt*a,-a),t.closePath()}};function St(t,e){let a=null,o=le(s);t=typeof t=="function"?t:at(t||kt),e=typeof e=="function"?e:at(e===void 0?64:+e);function s(){let r;if(a||(a=r=o()),t.apply(this,arguments).draw(a,+e.apply(this,arguments)),r)return a=null,r+""||null}return s.type=function(r){return arguments.length?(t=typeof r=="function"?r:at(r),s):t},s.size=function(r){return arguments.length?(e=typeof r=="function"?r:at(+r),s):e},s.context=function(r){return arguments.length?(a=r??null,s):a},s}function Dt(t,e,a){t._context.bezierCurveTo((2*t._x0+t._x1)/3,(2*t._y0+t._y1)/3,(t._x0+2*t._x1)/3,(t._y0+2*t._y1)/3,(t._x0+4*t._x1+e)/6,(t._y0+4*t._y1+a)/6)}function Ot(t){this._context=t}Ot.prototype={areaStart:function(){this._line=0},areaEnd:function(){this._line=NaN},lineStart:function(){this._x0=this._x1=this._y0=this._y1=NaN,this._point=0},lineEnd:function(){switch(this._point){case 3:Dt(this,this._x1,this._y1);case 2:this._context.lineTo(this._x1,this._y1);break}(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line},point:function(t,e){switch(t=+t,e=+e,this._point){case 0:this._point=1,this._line?this._context.lineTo(t,e):this._context.moveTo(t,e);break;case 1:this._point=2;break;case 2:this._point=3,this._context.lineTo((5*this._x0+this._x1)/6,(5*this._y0+this._y1)/6);default:Dt(this,t,e);break}this._x0=this._x1,this._x1=t,this._y0=this._y1,this._y1=e}};function Y(t){return new Ot(t)}function ke(t,e){if((o=t.length)>0){for(var a,o,s=0,r=t[0].length,i;s<r;++s){for(i=a=0;a<o;++a)i+=t[a][s][1]||0;if(i)for(a=0;a<o;++a)t[a][s][1]/=i}fe(t,e)}}function z(t){let e=t;return()=>(e=e*1664525+1013904223&4294967295,(e>>>0)/4294967295)}function G(t){return()=>{const e=Math.max(1e-10,t()),a=t();return Math.sqrt(-2*Math.log(e))*Math.cos(2*Math.PI*a)}}const zt=(()=>{const t=z(42),e=G(t),a=[{name:"setosa",mx:5,sx:.35,my:1.5,sy:.18},{name:"versicolor",mx:5.9,sx:.52,my:4.3,sy:.47},{name:"virginica",mx:6.6,sx:.63,my:5.5,sy:.55}],o=[];return a.forEach(s=>{for(let r=0;r<20;r++)o.push({x:s.mx+s.sx*e(),y:s.my+s.sy*e(),sp:s.name})}),o})(),Ce=(()=>{const t=z(100);return["Control","Trt-A","Trt-B","Trt-C","Trt-D"].map(a=>({cat:a,values:[{grp:"Week 1",mean:25+t()*25,se:2+t()*4},{grp:"Week 8",mean:40+t()*40,se:3+t()*6}]}))})(),V=(()=>{const t=z(200),e=["W0","W1","W2","W3","W4"];return[{grp:"Control",color:"#7EC8E3",base:30,slope:2},{grp:"Low Dose",color:"#F0B27A",base:30,slope:9},{grp:"High Dose",color:"#95D5B2",base:30,slope:15}].map(a=>({grp:a.grp,color:a.color,pts:e.map((o,s)=>({w:o,val:a.base+a.slope*s+(t()-.5)*10}))}))})(),Tt=(()=>{const t=z(300),e=G(t);return[{name:"Control",mu:25,sigma:5},{name:"Drug A",mu:48,sigma:8},{name:"Drug B",mu:66,sigma:6}].map(a=>({name:a.name,pts:Array.from({length:30},()=>Math.max(0,a.mu+a.sigma*e()))}))})(),rt=(()=>{const t=z(400),e=G(t);return[{name:"Control",mu:25,sigma:5},{name:"Drug A",mu:48,sigma:8},{name:"Drug B",mu:66,sigma:6}].map(a=>({name:a.name,pts:Array.from({length:50},()=>Math.max(0,a.mu+a.sigma*e()))}))})(),ot=(()=>{const t=z(500),e=G(t),a=[];for(let o=0;o<120;o++)a.push(30+8*e());for(let o=0;o<80;o++)a.push(65+10*e());return a})(),yt=(()=>{const t=z(600),e=G(t);return[{grp:"Control",color:"#7EC8E3",mu:30,sigma:6},{grp:"Low Dose",color:"#F0B27A",mu:48,sigma:9},{grp:"High Dose",color:"#95D5B2",mu:62,sigma:7}].map(a=>({grp:a.grp,color:a.color,pts:Array.from({length:80},()=>Math.max(0,a.mu+a.sigma*e()))}))})(),it=(()=>{const t=z(700),e=["BRCA1","TP53","MYC","EGFR","VEGF","CDK4"],a=["Ctrl","Trt-1h","Trt-6h","Trt-24h","Recover"];return e.map((o,s)=>({gene:o,values:a.map((r,i)=>({cond:r,val:(t()-.5)*4+Math.sin(s*1.1+i*.7)*1.5}))}))})(),nt=(()=>{const t=z(800);return["Control","Group A","Group B","Group C","Group D","Group E"].map(a=>{const o=8+Math.floor(t()*12),s=20+t()*60,r=5+t()*15,i=r/Math.sqrt(o);return{grp:a,mean:s,se:i,sd:r,ci95:i*1.96}})})(),Ee=(()=>{const t=z(900);return["BRCA2","KRAS","PIK3CA","APC","PTEN","RB1","SMAD4","VHL"].map(a=>({gene:a,val:(t()-.4)*6}))})(),lt=(()=>{const t=z(1e3),e=G(t);return["Week 0","Week 4","Week 8","Week 12"].map((a,o)=>({tp:a,pts:Array.from({length:50},()=>Math.max(0,30+o*12+(5+o*2)*e()))}))})(),vt={setosa:"#7EC8E3",versicolor:"#F0B27A",virginica:"#95D5B2"},st=["#7EC8E3","#F0B27A"],Gt=["#7EC8E3","#F0B27A","#95D5B2"],Et="#0f1117",Z=[{id:"scatter",name:"散点图",en:"Scatter Plot",tags:["连续 × 连续","相关分析"],desc:"展示两连续变量关系，支持分组着色、回归线",info:"Iris 数据集 · 60 个观测点 · 3 物种"},{id:"bar",name:"柱状图",en:"Bar Chart",tags:["分类 × 连续","组间比较"],desc:"比较不同类别的数值，支持分组/堆叠/百分比",info:"5 个处理组 · 2 个时间点 · 模拟实验数据"},{id:"line",name:"折线图",en:"Line Chart",tags:["时间序列","趋势分析"],desc:"展示随时间变化的趋势，支持面积填充",info:"5 个时间点 · 3 个治疗组 · 纵向研究数据"},{id:"boxplot",name:"箱线图",en:"Box Plot",tags:["分类 × 连续","分布比较"],desc:"展示分布中位数、四分位和异常值",info:"3 组 · 每组 30 个观测值 · 模拟临床数据"},{id:"violin",name:"小提琴图",en:"Violin Plot",tags:["分类 × 连续","分布形态"],desc:"核密度估计展示完整分布形状，比箱线图信息更丰富",info:"3 组 · 每组 50 个观测值 · 模拟临床数据"},{id:"histogram",name:"直方图",en:"Histogram",tags:["单变量","频率分布"],desc:"展示单个连续变量的频率分布，揭示数据偏斜与双峰",info:"200 个观测值 · 双峰分布 · 模拟生物学数据"},{id:"density",name:"密度图",en:"Density Plot",tags:["分布对比","多组叠加"],desc:"核密度估计平滑展示分布，多组重叠对比时优于直方图",info:"3 组 · 每组 80 个观测值 · 模拟测量数据"},{id:"heatmap",name:"热力图",en:"Heatmap",tags:["矩阵数据","表达量"],desc:"用颜色编码矩阵数值，常用于基因表达和相关性矩阵",info:"6 基因 × 5 条件 · 模拟转录组数据"},{id:"area",name:"面积图",en:"Area Chart",tags:["时间序列","组成变化"],desc:"展示随时间变化的组成比例，堆叠面积突出总量变化",info:"5 个时间点 · 3 个处理组 · 比例数据"},{id:"errorbar",name:"误差线图",en:"Error Bar",tags:["均值 ± 误差","统计推断"],desc:"展示均值与不确定性（SE/SD/CI），科研报告标配",info:"6 个处理组 · 模拟实验重复数据"},{id:"lollipop",name:"棒棒糖图",en:"Lollipop",tags:["排名比较","简洁柱状"],desc:"比柱状图更简洁，适合展示排名和单值比较",info:"8 个基因 · 差异表达量 · 模拟 RNA-seq"},{id:"ridgeline",name:"山脊图",en:"Ridgeline",tags:["多组分布","时序演变"],desc:"纵向堆叠的密度图，优雅展示多组分布的变化趋势",info:"4 个时间点 · 每时间点 50 个观测值"}],$e={scatter:`<svg viewBox="0 0 150 95" xmlns="http://www.w3.org/2000/svg" style="width:100%;display:block">
...
</svg>`},$t={scatter:{size:3,alpha:.7,jitter:"none",regression:!1,shape:"circle"},bar:{arrangement:"grouped",barWidth:.7,errorBars:!1},line:{lineType:"solid",lineWidth:1.5,showPoints:!0,smooth:!1,fillArea:!1},boxplot:{boxWidth:.6,showOutliers:!0,fillAlpha:.7,notch:!1,showMean:!0,whisker:"iqr"},violin:{bw:.5,fillAlpha:.7,showBoxplot:!0,halfViolin:"full"},histogram:{bins:20,fillAlpha:.8,densityOverlay:!1},density:{bw:1,fillAlpha:.25,showRug:!1},heatmap:{colorScheme:"rdbu",showValues:!0},area:{arrangement:"stacked",fillAlpha:.65,showLines:!0},errorbar:{errorType:"se",capWidth:.2,lineWidth:1.5,dotSize:5},lollipop:{dotSize:8,lineWidth:1.2,sortBy:"none",horizontal:!1},ridgeline:{overlap:.7,fillAlpha:.7,bw:1}};let w={currentChart:"scatter",params:JSON.parse(JSON.stringify($t)),editor:null,copyBtn:null,cleanups:[]};function $(t){t.select(".domain").attr("stroke","#424245"),t.selectAll(".tick line").attr("stroke","#424245"),t.selectAll("text").attr("fill","#a1a1a6").style("font-size","11px")}function W(t){t.select(".domain").remove(),t.selectAll(".tick line").attr("stroke","rgba(255,255,255,0.05)"),t.selectAll("text").remove()}function A(t,e,a,o,s){a?t.append("text").attr("transform","rotate(-90)").attr("x",-s/2).attr("y",-48).attr("fill","#a1a1a6").attr("text-anchor","middle").style("font-size","12px").text(e):t.append("text").attr("x",o/2).attr("y",s+46).attr("fill","#a1a1a6").attr("text-anchor","middle").style("font-size","12px").text(e)}function mt(t){return e=>Math.exp(-.5*(e/t)**2)/(t*Math.sqrt(2*Math.PI))}function bt(t,e,a){return a.map(o=>({x:o,y:pt(t,s=>e(o-s))}))}function T(t,e,a,o){Lt(t).selectAll("*").remove();const s=Lt(t).append("svg").attr("viewBox",`0 0 ${e} ${a}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("display","block");s.append("rect").attr("width",e).attr("height",a).attr("fill",Et).attr("rx",12);const r=s.append("g").attr("transform",`translate(${o.left},${o.top})`),i=e-o.left-o.right,f=a-o.top-o.bottom;return{svg:s,g:r,iW:i,iH:f}}function Be(t,e){const s={top:25,right:115,bottom:55,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=_().domain([3.8,8.2]).range([0,i]),y=_().domain([.5,8]).range([f,0]);r.append("g").call(E(y).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(b).ticks(6)).call($),r.append("g").call(E(y).ticks(5)).call($),A(r,"Sepal.Length (cm)",!1,i,f),A(r,"Petal.Length (cm)",!0,i,f),e.regression&&Object.entries(vt).forEach(([x,u])=>{const d=zt.filter(C=>C.sp===x),g=pt(d,C=>C.x),v=pt(d,C=>C.y),k=wt(d,C=>(C.x-g)*(C.y-v))/wt(d,C=>(C.x-g)**2),P=v-k*g,j=D(d,C=>C.x)-.1,q=B(d,C=>C.x)+.1;r.append("line").attr("x1",b(j)).attr("y1",y(k*j+P)).attr("x2",b(q)).attr("y2",y(k*q+P)).attr("stroke",u).attr("stroke-width",1.5).attr("stroke-dasharray","6,4").attr("opacity",.7)});const p=z(999),h=e.jitter==="light"?.12:e.jitter==="heavy"?.28:0,m={circle:kt,triangle:we,square:ve,cross:ye}[e.shape]||kt,l=(e.size+2)**2*6;zt.forEach(x=>{const u=h>0?(p()-.5)*h:0,d=h>0?(p()-.5)*h:0;r.append("path").attr("d",St().type(m).size(l)()).attr("transform",`translate(${b(x.x+u)},${y(x.y+d)})`).attr("fill",vt[x.sp]).attr("opacity",e.alpha).attr("stroke","none")});const n=r.append("g").attr("transform",`translate(${i+12},0)`);Object.entries(vt).forEach(([x,u],d)=>{const g=n.append("g").attr("transform",`translate(0,${d*22})`);g.append("path").attr("d",St().type(m).size(64)()).attr("transform","translate(7,7)").attr("fill",u).attr("opacity",e.alpha),g.append("text").attr("x",18).attr("y",11).attr("fill","#a1a1a6").style("font-size","10px").text(x)})}function Ae(t,e){const s={top:25,right:115,bottom:60,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=Ce,y=b.map(m=>m.cat),p=["Week 1","Week 8"],h=R().domain(y).range([0,i]).paddingInner(1-e.barWidth);if(e.arrangement==="grouped"){const m=R().domain(p).range([0,h.bandwidth()]).padding(.08),l=B(b,x=>B(x.values,u=>u.mean+(e.errorBars?u.se:0))),n=_().domain([0,l*1.12]).range([f,0]);r.append("g").call(E(n).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(h)).call($),r.append("g").call(E(n).ticks(5)).call($),A(r,"Mean Value",!0,i,f),b.forEach(x=>{const u=r.append("g").attr("transform",`translate(${h(x.cat)},0)`);x.values.forEach((d,g)=>{if(u.append("rect").attr("x",m(d.grp)).attr("y",n(d.mean)).attr("width",m.bandwidth()).attr("height",f-n(d.mean)).attr("fill",st[g]).attr("rx",3),e.errorBars){const v=m(d.grp)+m.bandwidth()/2;u.append("line").attr("x1",v).attr("x2",v).attr("y1",n(d.mean+d.se)).attr("y2",n(d.mean-d.se)).attr("stroke","#fff").attr("stroke-width",1.5).attr("opacity",.7),[-d.se,d.se].forEach(k=>{u.append("line").attr("x1",v-4).attr("x2",v+4).attr("y1",n(d.mean+k)).attr("y2",n(d.mean+k)).attr("stroke","#fff").attr("stroke-width",1.5).attr("opacity",.7)})}})})}else if(e.arrangement==="stacked"){const m=b.map(u=>{const d={cat:u.cat};return u.values.forEach(g=>{d[g.grp]=g.mean}),d}),l=dt().keys(p)(m),n=B(l[l.length-1],u=>u[1]),x=_().domain([0,n*1.1]).range([f,0]);r.append("g").call(E(x).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(h)).call($),r.append("g").call(E(x).ticks(5)).call($),A(r,"Total Value",!0,i,f),l.forEach((u,d)=>{r.selectAll(null).data(u).enter().append("rect").attr("x",g=>h(g.data.cat)).attr("y",g=>x(g[1])).attr("width",h.bandwidth()).attr("height",g=>x(g[0])-x(g[1])).attr("fill",st[d]).attr("rx",d===0?3:0)})}else{const m=b.map(x=>{const u=wt(x.values,g=>g.mean),d={cat:x.cat};return x.values.forEach(g=>{d[g.grp]=g.mean/u*100}),d}),l=dt().keys(p)(m),n=_().domain([0,100]).range([f,0]);r.append("g").call(E(n).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").call(E(n).ticks(5).tickFormat(x=>x+"%")).call($),r.append("g").attr("transform",`translate(0,${f})`).call(M(h)).call($),A(r,"Proportion (%)",!0,i,f),l.forEach((x,u)=>{r.selectAll(null).data(x).enter().append("rect").attr("x",d=>h(d.data.cat)).attr("y",d=>n(d[1])).attr("width",h.bandwidth()).attr("height",d=>n(d[0])-n(d[1])).attr("fill",st[u]).attr("rx",u===0?3:0)})}const c=r.append("g").attr("transform",`translate(${i+12},0)`);p.forEach((m,l)=>{const n=c.append("g").attr("transform",`translate(0,${l*22})`);n.append("rect").attr("width",12).attr("height",12).attr("fill",st[l]).attr("rx",2),n.append("text").attr("x",16).attr("y",11).attr("fill","#a1a1a6").style("font-size","10px").text(m)})}function _e(t,e){const s={top:25,right:110,bottom:55,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=["W0","W1","W2","W3","W4"],y=Pt().domain(b).range([0,i]).padding(.2),p=V.flatMap(n=>n.pts.map(x=>x.val)),h=_().domain([D(p)-8,B(p)+8]).range([f,0]);r.append("g").call(E(h).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(y)).call($),r.append("g").call(E(h).ticks(5)).call($),A(r,"Week",!1,i,f),A(r,"Response",!0,i,f);const c={solid:null,dashed:"8,4",dotted:"3,4"},m=e.smooth?It:pe;V.forEach(n=>{e.fillArea&&r.append("path").datum(n.pts).attr("d",J().x((u,d)=>y(b[d])).y0(f).y1(u=>h(u.val)).curve(m)).attr("fill",n.color).attr("opacity",.12);const x=r.append("path").datum(n.pts).attr("d",X().x((u,d)=>y(b[d])).y(u=>h(u.val)).curve(m)).attr("fill","none").attr("stroke",n.color).attr("stroke-width",e.lineWidth);c[e.lineType]&&x.attr("stroke-dasharray",c[e.lineType]),e.showPoints&&n.pts.forEach((u,d)=>{r.append("circle").attr("cx",y(b[d])).attr("cy",h(u.val)).attr("r",e.lineWidth+2).attr("fill",n.color).attr("stroke",Et).attr("stroke-width",1.5)})});const l=r.append("g").attr("transform",`translate(${i+12},0)`);V.forEach((n,x)=>{const u=l.append("g").attr("transform",`translate(0,${x*22})`);u.append("line").attr("x1",0).attr("x2",14).attr("y1",7).attr("y2",7).attr("stroke",n.color).attr("stroke-width",e.lineWidth),e.showPoints&&u.append("circle").attr("cx",7).attr("cy",7).attr("r",3).attr("fill",n.color),u.append("text").attr("x",18).attr("y",11).attr("fill","#a1a1a6").style("font-size","10px").text(n.grp)})}function Le(t,e){const s={top:25,right:30,bottom:50,left:60},{g:r,iW:i,iH:f}=T(t,540,380,s),b=Tt.map(c=>{const m=[...c.pts].sort((v,k)=>v-k),l=O(m,.25),n=O(m,.5),x=O(m,.75),u=x-l,d=e.whisker==="iqr"?Math.max(D(m),l-1.5*u):D(m),g=e.whisker==="iqr"?Math.min(B(m),x+1.5*u):B(m);return{name:c.name,q1:l,med:n,q3:x,iqr:u,wMin:d,wMax:g,outliers:m.filter(v=>v<d||v>g),mean:pt(m),notchLo:n-1.58*u/Math.sqrt(m.length),notchHi:n+1.58*u/Math.sqrt(m.length)}}),y=b.flatMap(c=>[c.wMin,c.wMax,...e.showOutliers?c.outliers:[]]),p=_().domain([D(y)-5,B(y)+5]).range([f,0]),h=R().domain(Tt.map(c=>c.name)).range([0,i]).padding(1-e.boxWidth);r.append("g").call(E(p).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(h)).call($),r.append("g").call(E(p).ticks(5)).call($),A(r,"Response Value",!0,i,f),b.forEach((c,m)=>{const l=h(c.name),n=h.bandwidth(),x=l+n/2,u=Gt[m];if(r.append("line").attr("x1",x).attr("x2",x).attr("y1",p(c.wMax)).attr("y2",p(c.wMin)).attr("stroke",u).attr("stroke-width",1.5).attr("opacity",.7),[c.wMin,c.wMax].forEach(d=>{r.append("line").attr("x1",x-n*.2).attr("x2",x+n*.2).attr("y1",p(d)).attr("y2",p(d)).attr("stroke",u).attr("stroke-width",1.5)}),e.notch){const d=Math.max(c.q1,c.notchLo),g=Math.min(c.q3,c.notchHi),v=n*.2;r.append("path").attr("d",[`M ${l} ${p(c.q1)}`,`L ${l+n} ${p(c.q1)}`,`L ${l+n} ${p(d)}`,`L ${l+n-v} ${p(c.med)}`,`L ${l+n} ${p(g)}`,`L ${l+n} ${p(c.q3)}`,`L ${l} ${p(c.q3)}`,`L ${l} ${p(g)}`,`L ${l+v} ${p(c.med)}`,`L ${l} ${p(d)}`,"Z"].join(" ")).attr("fill",u).attr("opacity",e.fillAlpha).attr("stroke",u).attr("stroke-width",1.5)}else r.append("rect").attr("x",l).attr("y",p(c.q3)).attr("width",n).attr("height",p(c.q1)-p(c.q3)).attr("fill",u).attr("opacity",e.fillAlpha).attr("stroke",u).attr("stroke-width",1.5).attr("rx",3);if(r.append("line").attr("x1",l).attr("x2",l+n).attr("y1",p(c.med)).attr("y2",p(c.med)).attr("stroke","#fff").attr("stroke-width",2),e.showMean){const g=p(c.mean);r.append("path").attr("d",`M ${x} ${g-5} L ${x+5} ${g} L ${x} ${g+5} L ${x-5} ${g} Z`).attr("fill","#fff").attr("opacity",.9)}e.showOutliers&&c.outliers.forEach(d=>{r.append("circle").attr("cx",x).attr("cy",p(d)).attr("r",3).attr("fill","none").attr("stroke",u).attr("stroke-width",1.5).attr("opacity",.7)})})}function Me(t,e){const s={top:25,right:20,bottom:50,left:60},{g:r,iW:i,iH:f}=T(t,540,380,s),b=rt.flatMap(g=>g.pts),y=D(b)-5,p=B(b)+5,h=ft(y,p,(p-y)/80),c=mt(e.bw*10),m=R().domain(rt.map(g=>g.name)).range([0,i]).padding(.3),l=_().domain([y,p]).range([f,0]),n=m.bandwidth()/2,x=rt.map(g=>bt(g.pts,c,h)),u=B(x,g=>B(g,v=>v.y)),d=_().domain([0,u]).range([0,n*.92]);r.append("g").call(E(l).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(m)).call($),r.append("g").call(E(l).ticks(5)).call($),A(r,"Response Value",!0,i,f),rt.forEach((g,v)=>{const k=m(g.name)+n,P=Gt[v],j=x[v],q=J().x0(C=>k-(e.halfViolin!=="right"?d(C.y):0)).x1(C=>k+(e.halfViolin!=="left"?d(C.y):0)).y(C=>l(C.x)).curve(It);if(r.append("path").datum(j).attr("d",q).attr("fill",P).attr("opacity",e.fillAlpha).attr("stroke",P).attr("stroke-width",1.5),e.showBoxplot){const C=[...g.pts].sort((Kt,Jt)=>Kt-Jt),I=O(C,.25),F=O(C,.5),Q=O(C,.75),Bt=Q-I,Zt=Math.max(D(C),I-1.5*Bt),Ut=Math.min(B(C),Q+1.5*Bt),tt=n*.22;r.append("line").attr("x1",k).attr("x2",k).attr("y1",l(Zt)).attr("y2",l(Ut)).attr("stroke","#fff").attr("stroke-width",1.5).attr("opacity",.8),r.append("rect").attr("x",k-tt).attr("y",l(Q)).attr("width",tt*2).attr("height",l(I)-l(Q)).attr("fill","#111318").attr("stroke","#fff").attr("stroke-width",1.5).attr("rx",2),r.append("line").attr("x1",k-tt).attr("x2",k+tt).attr("y1",l(F)).attr("y2",l(F)).attr("stroke","#fff").attr("stroke-width",2.5)}})}function We(t,e){const s={top:25,right:30,bottom:55,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=D(ot)-2,y=B(ot)+2,p=_().domain([b,y]).range([0,i]),h=ne().domain([b,y]).thresholds(e.bins)(ot),c=B(h,l=>l.length),m=_().domain([0,c*1.12]).range([f,0]);if(r.append("g").call(E(m).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(p).ticks(8)).call($),r.append("g").call(E(m).ticks(5)).call($),A(r,"Value",!1,i,f),A(r,"Count",!0,i,f),r.selectAll(".p7-hbar").data(h).enter().append("rect").attr("class","p7-hbar").attr("x",l=>p(l.x0)+1).attr("y",l=>m(l.length)).attr("width",l=>Math.max(0,p(l.x1)-p(l.x0)-1)).attr("height",l=>f-m(l.length)).attr("fill","#7EC8E3").attr("opacity",e.fillAlpha).attr("rx",2),e.densityOverlay){const l=mt(3.2),n=ft(b,y,(y-b)/100),x=bt(ot,l,n),u=B(x,g=>g.y),d=c/u;r.append("path").datum(x).attr("d",X().x(g=>p(g.x)).y(g=>m(g.y*d)).curve(Y)).attr("fill","none").attr("stroke","#F0B27A").attr("stroke-width",2.5).attr("opacity",.9),r.append("text").attr("x",i-4).attr("y",14).attr("fill","#F0B27A").style("font-size","10px").attr("text-anchor","end").text("密度曲线")}}function Se(t,e){const s={top:25,right:105,bottom:55,left:60},{g:r,iW:i,iH:f}=T(t,540,380,s),b=yt.flatMap(d=>d.pts),y=D(b)-5,p=B(b)+5,h=_().domain([y,p]).range([0,i]),c=mt(e.bw*5),m=ft(y,p,(p-y)/100),l=yt.map(d=>({...d,kde:bt(d.pts,c,m)})),n=B(l,d=>B(d.kde,g=>g.y)),x=_().domain([0,n*1.12]).range([f,0]);r.append("g").call(E(x).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(h).ticks(6)).call($),r.append("g").call(E(x).ticks(4).tickFormat(Ct(".3f"))).call($),A(r,"Value",!1,i,f),A(r,"Density",!0,i,f),l.forEach(d=>{r.append("path").datum(d.kde).attr("d",J().x(g=>h(g.x)).y0(f).y1(g=>x(g.y)).curve(Y)).attr("fill",d.color).attr("opacity",e.fillAlpha),r.append("path").datum(d.kde).attr("d",X().x(g=>h(g.x)).y(g=>x(g.y)).curve(Y)).attr("fill","none").attr("stroke",d.color).attr("stroke-width",2),e.showRug&&d.pts.forEach(g=>{r.append("line").attr("x1",h(g)).attr("x2",h(g)).attr("y1",f).attr("y2",f-6).attr("stroke",d.color).attr("opacity",.4)})});const u=r.append("g").attr("transform",`translate(${i+12},0)`);yt.forEach((d,g)=>{const v=u.append("g").attr("transform",`translate(0,${g*22})`);v.append("rect").attr("width",12).attr("height",3).attr("y",5).attr("fill",d.color).attr("rx",1),v.append("text").attr("x",16).attr("y",11).attr("fill","#a1a1a6").style("font-size","10px").text(d.grp)})}function De(t,e){const s={top:20,right:80,bottom:60,left:70},{g:r,iW:i,iH:f}=T(t,540,380,s),b=it.map(v=>v.gene),y=it[0].values.map(v=>v.cond),p=R().domain(y).range([0,i]).padding(.04),h=R().domain(b).range([0,f]).padding(.04),c=it.flatMap(v=>v.values.map(k=>k.val)),m=B(c.map(Math.abs)),l={rdbu:jt(he).domain([m,0,-m]),viridis:Mt(ue).domain([-m,m]),plasma:Mt(xe).domain([-m,m])},n=l[e.colorScheme]||l.rdbu;r.append("g").attr("transform",`translate(0,${f})`).call(M(p)).call(v=>{v.select(".domain").attr("stroke","#424245"),v.selectAll(".tick line").remove(),v.selectAll("text").attr("fill","#a1a1a6").style("font-size","10px")}),r.append("g").call(E(h)).call(v=>{v.select(".domain").attr("stroke","#424245"),v.selectAll(".tick line").remove(),v.selectAll("text").attr("fill","#a1a1a6").style("font-size","10px").attr("font-style","italic")}),it.forEach(v=>{v.values.forEach(k=>{r.append("rect").attr("x",p(k.cond)).attr("y",h(v.gene)).attr("width",p.bandwidth()).attr("height",h.bandwidth()).attr("fill",n(k.val)).attr("rx",3),e.showValues&&r.append("text").attr("x",p(k.cond)+p.bandwidth()/2).attr("y",h(v.gene)+h.bandwidth()/2+4).attr("text-anchor","middle").attr("fill",Math.abs(k.val)>m*.5?"#fff":"#444").style("font-size","9px").style("font-family","monospace").text(k.val.toFixed(1))})});const x=f,u=14,d=r.append("defs").append("linearGradient").attr("id","p7-hm-grad").attr("x1",0).attr("y1",1).attr("x2",0).attr("y2",0);[0,.25,.5,.75,1].forEach(v=>{d.append("stop").attr("offset",`${v*100}%`).attr("stop-color",n(-m+v*2*m))}),r.append("rect").attr("x",i+20).attr("y",0).attr("width",u).attr("height",x).attr("fill","url(#p7-hm-grad)").attr("rx",3);const g=_().domain([-m,m]).range([x,0]);r.append("g").attr("transform",`translate(${i+20+u},0)`).call(de(g).ticks(4).tickFormat(Ct(".1f"))).call(v=>{v.select(".domain").remove(),v.selectAll(".tick line").attr("stroke","#424245"),v.selectAll("text").attr("fill","#a1a1a6").style("font-size","9px")})}function ze(t,e){const s={top:25,right:110,bottom:55,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=["W0","W1","W2","W3","W4"],y=Pt().domain(b).range([0,i]).padding(.2),p=b.map((u,d)=>{const g={w:u};return V.forEach(v=>{g[v.grp]=v.pts[d].val}),g}),h=V.map(u=>u.grp),c=V.map(u=>u.color),m=(u,d)=>J().x((g,v)=>y(b[v])).y0(g=>d(g[0])).y1(g=>d(g[1])).curve(Wt),l=(u,d)=>X().x((g,v)=>y(b[v])).y(g=>d(g[1])).curve(Wt);let n;if(e.arrangement==="proportional"){const u=dt().keys(h).offset(ke)(p);n=_().domain([0,1]).range([f,0]),r.append("g").call(E(n).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(y)).call($),r.append("g").call(E(n).ticks(5).tickFormat(Ct(".0%"))).call($),A(r,"Week",!1,i,f),A(r,"Proportion",!0,i,f),u.forEach((d,g)=>{r.append("path").datum(d).attr("d",m(d,n)).attr("fill",c[g]).attr("opacity",e.fillAlpha),e.showLines&&r.append("path").datum(d).attr("d",l(d,n)).attr("fill","none").attr("stroke",c[g]).attr("stroke-width",1.5).attr("opacity",.8)})}else{const u=dt().keys(h)(p),d=B(u[u.length-1],g=>g[1]);n=_().domain([0,d*1.05]).range([f,0]),r.append("g").call(E(n).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(y)).call($),r.append("g").call(E(n).ticks(5)).call($),A(r,"Week",!1,i,f),A(r,"Response",!0,i,f),u.forEach((g,v)=>{r.append("path").datum(g).attr("d",m(g,n)).attr("fill",c[v]).attr("opacity",e.fillAlpha),e.showLines&&r.append("path").datum(g).attr("d",l(g,n)).attr("fill","none").attr("stroke",c[v]).attr("stroke-width",1.5).attr("opacity",.8)})}const x=r.append("g").attr("transform",`translate(${i+12},0)`);V.forEach((u,d)=>{const g=x.append("g").attr("transform",`translate(0,${d*22})`);g.append("rect").attr("width",12).attr("height",12).attr("fill",u.color).attr("opacity",e.fillAlpha).attr("rx",2),g.append("text").attr("x",16).attr("y",11).attr("fill","#a1a1a6").style("font-size","10px").text(u.grp)})}function Te(t,e){const s={top:25,right:30,bottom:65,left:55},{g:r,iW:i,iH:f}=T(t,540,380,s),b=e.errorType==="se"?"se":e.errorType==="sd"?"sd":"ci95",y=B(nt,l=>l.mean+l[b]),p=Math.max(0,D(nt,l=>l.mean-l[b])),h=R().domain(nt.map(l=>l.grp)).range([0,i]).padding(.5),c=_().domain([p*.85,y*1.15]).range([f,0]);r.append("g").call(E(c).ticks(5).tickSize(-i).tickFormat("")).call(W),r.append("g").attr("transform",`translate(0,${f})`).call(M(h)).call($).selectAll("text").attr("transform","rotate(-30)").attr("text-anchor","end").attr("dy","0.4em"),r.append("g").call(E(c).ticks(5)).call($),A(r,"Mean Value",!0,i,f),nt.forEach((l,n)=>{const x=h(l.grp)+h.bandwidth()/2,u=l[b],d=n<3?"#7EC8E3":"#F0B27A",g=e.capWidth*h.bandwidth();r.append("line").attr("x1",x).attr("x2",x).attr("y1",c(l.mean+u)).attr("y2",c(l.mean-u)).attr("stroke",d).attr("stroke-width",e.lineWidth),[-u,u].forEach(v=>{r.append("line").attr("x1",x-g).attr("x2",x+g).attr("y1",c(l.mean+v)).attr("y2",c(l.mean+v)).attr("stroke",d).attr("stroke-width",e.lineWidth)}),r.append("circle").attr("cx",x).attr("cy",c(l.mean)).attr("r",e.dotSize/2).attr("fill",d).attr("stroke",Et).attr("stroke-width",1.5)});const m={se:"Error bars: ±SE",sd:"Error bars: ±SD",ci95:"Error bars: 95% CI"};r.append("text").attr("x",i).attr("y",14).attr("text-anchor","end").attr("fill","#a1a1a6").style("font-size","10px").text(m[e.errorType])}function Fe(t,e){const a=e.horizontal?55:100,o=540,s=380,r={top:25,right:30,bottom:a,left:e.horizontal?80:55},{g:i,iW:f,iH:b}=T(t,o,s,r);let y=[...Ee];e.sortBy==="asc"&&y.sort((h,c)=>h.val-c.val),e.sortBy==="desc"&&y.sort((h,c)=>c.val-h.val);const p=B(y,h=>Math.abs(h.val))*1.15;if(e.horizontal){const h=R().domain(y.map(l=>l.gene)).range([0,b]).padding(.4),c=_().domain([-p,p]).range([0,f]),m=c(0);i.append("g").call(E(h).ticks(0).tickSize(-f).tickFormat("")).call(W),i.append("g").call(M(c).ticks(5).tickSize(-b).tickFormat("")).call(W),i.append("g").call(E(h)).call(l=>{l.select(".domain").attr("stroke","#424245"),l.selectAll(".tick line").remove(),l.selectAll("text").attr("fill","#a1a1a6").style("font-size","10px").attr("font-style","italic")}),i.append("g").attr("transform",`translate(0,${b})`).call(M(c).ticks(5)).call($),i.append("line").attr("x1",m).attr("x2",m).attr("y1",0).attr("y2",b).attr("stroke","rgba(255,255,255,0.15)").attr("stroke-width",1),A(i,"log2 Fold Change",!1,f,b),y.forEach(l=>{const n=h(l.gene)+h.bandwidth()/2,x=l.val>0?"#F0B27A":"#7EC8E3";i.append("line").attr("x1",m).attr("x2",c(l.val)).attr("y1",n).attr("y2",n).attr("stroke",x).attr("stroke-width",e.lineWidth).attr("opacity",.7),i.append("circle").attr("cx",c(l.val)).attr("cy",n).attr("r",e.dotSize/2).attr("fill",x)})}else{const h=R().domain(y.map(l=>l.gene)).range([0,f]).padding(.4),c=_().domain([-p,p]).range([b,0]),m=c(0);i.append("g").call(E(c).ticks(5).tickSize(-f).tickFormat("")).call(W),i.append("g").attr("transform",`translate(0,${b})`).call(M(h)).call($).selectAll("text").attr("transform","rotate(-35)").attr("text-anchor","end").attr("dy","0.4em").attr("font-style","italic"),i.append("g").call(E(c).ticks(5)).call($),i.append("line").attr("x1",0).attr("x2",f).attr("y1",m).attr("y2",m).attr("stroke","rgba(255,255,255,0.15)").attr("stroke-width",1),A(i,"Gene",!1,f,b),A(i,"log2 FC",!0,f,b),y.forEach(l=>{const n=h(l.gene)+h.bandwidth()/2,x=l.val>0?"#F0B27A":"#7EC8E3";i.append("line").attr("x1",n).attr("x2",n).attr("y1",m).attr("y2",c(l.val)).attr("stroke",x).attr("stroke-width",e.lineWidth).attr("opacity",.7),i.append("circle").attr("cx",n).attr("cy",c(l.val)).attr("r",e.dotSize/2).attr("fill",x)})}}function Re(t,e){const s={top:30,right:20,bottom:50,left:90},{g:r,iW:i,iH:f}=T(t,540,380,s),b=lt.flatMap(v=>v.pts),y=D(b)-5,p=B(b)+5,h=_().domain([y,p]).range([0,i]),c=mt(e.bw*5),m=ft(y,p,(p-y)/100),l=lt.length,n=f/(l+.5),x=lt.map(v=>bt(v.pts,c,m)),u=B(x,v=>B(v,k=>k.y)),d=n*(1+e.overlap),g=["#7EC8E3","#F0B27A","#95D5B2","#B8B8E8"];r.append("g").attr("transform",`translate(0,${f})`).call(M(h).ticks(6)).call($),A(r,"Value",!1,i,f),lt.forEach((v,k)=>{const P=x[k],j=f-k*n,q=g[k%g.length],C=_().domain([0,u]).range([0,-d]),I=r.append("g").attr("transform",`translate(0,${j})`);I.append("path").datum(P).attr("d",J().x(F=>h(F.x)).y0(0).y1(F=>C(F.y)).curve(Y)).attr("fill",q).attr("opacity",e.fillAlpha),I.append("line").attr("x1",0).attr("x2",i).attr("y1",0).attr("y2",0).attr("stroke","rgba(255,255,255,0.1)").attr("stroke-width",1),I.append("path").datum(P).attr("d",X().x(F=>h(F.x)).y(F=>C(F.y)).curve(Y)).attr("fill","none").attr("stroke",q).attr("stroke-width",2),I.append("text").attr("x",-8).attr("y",0).attr("text-anchor","end").attr("fill","#a1a1a6").style("font-size","10px").attr("dominant-baseline","middle").text(v.tp)})}const He={scatter:Be,bar:Ae,line:_e,boxplot:Le,violin:Me,histogram:We,density:Se,heatmap:De,area:ze,errorbar:Te,lollipop:Fe,ridgeline:Re},Pe={circle:"16",triangle:"17",square:"15",cross:"3"},Ie={solid:'"solid"',dashed:'"dashed"',dotted:'"dotted"'};function qe(t){const e=t.jitter!=="none"?`    position = position_jitter(
...
${a}  scale_color_manual(values = c(
  ...
  )`}function Ve(t){const e={grouped:"position_dodge(0.8)",stacked:"position_stack()",filled:"position_fill()"},a=t.errorBars?`  geom_errorbar(
...
${a}  scale_fill_manual(values = c(
  ...
  theme(
    ...
    legend.position    = "right"
  )`}function je(t){const e=t.fillArea?`  geom_area(alpha = 0.12, position = "identity") +
...
${a}${o}  scale_color_manual(values = c(
  ...
  theme(
    panel.grid.minor = element_blank(),
    legend.position  = "right"
  )`}function Oe(t){const e=t.whisker==="iqr"?`    # 须线默认 1.5×IQR
`:`    coef = 0,     # 须线延伸到最值
...
${s}  scale_fill_manual(values = c(
  ...
  theme(
    ...
    panel.grid.major.x = element_blank()
  )`}function Ge(t){const e=t.showBoxplot?`  geom_boxplot(
...
${e}${a}  scale_fill_manual(values = c(
  ...
  theme(
    legend.position    = "none",
    panel.grid.major.x = element_blank()
  )`}function Ne(t){const e=t.densityOverlay?`  geom_density(
...
${e}  labs(
  ...
  theme_minimal(base_size = 13) +
  theme(panel.grid.minor = element_blank())`}function Ye(t){const e=t.showRug?`  geom_rug(alpha = 0.3, sides = "b") +
`:"";return`library(ggplot2)
...
${e}  scale_fill_manual(values = c(
  ...
  theme_minimal(base_size = 13)`}function Ze(t){const e={rdbu:`scale_fill_gradient2(
...
`:""}  ${e[t.colorScheme]||e.rdbu} +
  ...
  )`}function Ue(t){const e={stacked:"position_stack()",proportional:"position_fill()"},a=t.arrangement==="proportional"?"Proportion":"Response",o=t.arrangement==="proportional"?`
...
${s}  scale_fill_manual(values = c(
  ...
  theme_minimal(base_size = 13)`}function Ke(t){const e={se:{ymin:"mean - se",ymax:"mean + se",note:"# se = sd / sqrt(n)"},sd:{ymin:"mean - sd",ymax:"mean + sd",note:"# sd = standard deviation"},ci95:{ymin:"mean - ci95",ymax:"mean + ci95",note:"# ci95 = 1.96 * se"}},a=e[t.errorType]||e.se;return`library(ggplot2)
...
ggplot(data, aes(x = group, y = mean)) +
  ...
  )`}function Je(t){const e=t.sortBy!=="none"?`  dplyr::mutate(gene = reorder(gene, ${t.sortBy==="asc"?"":"-"}log2fc)) |>
...
${a}  geom_hline(yintercept = 0, linetype = "dashed",
  ...
  )`}function Xe(t){return`library(ggplot2)
library(ggridges)
...
ggplot(data, aes(
  ...
  theme(legend.position = "none")`}const Nt={scatter:qe,bar:Ve,line:je,boxplot:Oe,violin:Ge,histogram:Ne,density:Ye,heatmap:Ze,area:Ue,errorbar:Ke,lollipop:Je,ridgeline:Xe};function S(t,e){return`<button class="p7-toggle${t?" p7-toggle--on":""}" data-toggle="${e}">
    <span class="p7-tog-track"><span class="p7-tog-thumb"></span></span>
    <span class="p7-tog-lbl">${t?"开启":"关闭"}</span>
  </button>`}function H(t,e,a){return`<div class="p7-opt-row">${t.map(o=>`<button class="p7-opt-btn${o.val===e?" active":""}" data-group="${a}" data-val="${o.val}">${o.label}</button>`).join("")}</div>`}function L(t,e,a,o,s){return`<div class="p7-ctrl-hdr">
  ...
  <input class="p7-slider" type="range" data-param="${t}"
    min="${e}" max="${a}" step="${o}" value="${s}">`}function Qe(t){return`
    ...
    <div class="p7-ctrl-group">${L("bw",.5,5,.1,t.bw)}</div>
    <button class="p7-reset-btn" data-reset="true">↺ 重置参数</button>`}const pa={scatter:Qe,bar:ta,line:ea,boxplot:aa,violin:ra,histogram:oa,density:ia,heatmap:na,area:la,errorbar:sa,lollipop:ca,ridgeline:da};function za(){const t=`<svg class="p7-chevron" width="16" height="16" viewBox="0 0 24 24"
...
<section class="p7-gallery-section" id="p7-gallery">
  <div class="p7-container">
    ...
    <div class="p7-chart-card" data-chart="${o.id}" id="p7-card-${o.id}"
      ...
      <div class="p7-thumb-wrap">${$e[o.id]||""}</div>
...
</div>`}function ct(t){if(!Z.find(o=>o.id===t))return;w.currentChart=t,document.querySelectorAll(".p7-chart-tab").forEach(o=>o.classList.toggle("active",o.dataset.chart===t)),document.querySelectorAll(".p7-chart-card").forEach(o=>o.classList.toggle("active",o.dataset.chart===t));const e=document.getElementById("p7-ws-title"),a=Z.find(o=>o.id===t);e&&a&&(e.textContent=a.name),Yt(),U(),ut(),fa()}function Yt(){const t=document.getElementById("p7-params-body");if(t&&(t.innerHTML=pa[w.currentChart](w.params[w.currentChart]),window.innerWidth<=768)){const e=t.closest(".p7-panel");e&&e.classList.contains("collapsed")&&(t.classList.add("p7-collapsed"),t.classList.remove("p7-expanded"))}}function U(){const t=document.getElementById("p7-d3-container");t&&He[w.currentChart](t,w.params[w.currentChart])}function ut(){if(!w.editor)return;const t=Nt[w.currentChart](w.params[w.currentChart]);w.editor.setCode(t)}function fa(){const t=document.getElementById("p7-preview-info");if(!t)return;const e=Z.find(a=>a.id===w.currentChart);e&&(t.textContent=e.info)}function Ft(t,e){w.params[w.currentChart][t]=e,U(),ut()}function ha(){w.params[w.currentChart]=JSON.parse(JSON.stringify($t[w.currentChart])),Yt(),U(),ut()}function ga(){if(window.innerWidth>768)return;[{hdrId:"p7-params-hdr",bodyId:"p7-params-body",expanded:!1},{hdrId:"p7-preview-hdr",bodyId:"p7-preview-body",expanded:!0},{hdrId:"p7-code-hdr",bodyId:"p7-code-body",expanded:!1}].forEach(e=>{const a=document.getElementById(e.bodyId);if(!a)return;e.expanded?a.classList.add("p7-expanded"):(a.classList.add("p7-collapsed"),a.closest(".p7-panel")?.classList.add("collapsed"));const o=document.getElementById(e.hdrId);if(!o)return;const s=()=>{a.classList.contains("p7-expanded")?(a.classList.replace("p7-expanded","p7-collapsed"),o.closest(".p7-panel")?.classList.add("collapsed")):(a.classList.replace("p7-collapsed","p7-expanded"),o.closest(".p7-panel")?.classList.remove("collapsed"))};o.addEventListener("click",s),w.cleanups.push(()=>o.removeEventListener("click",s))})}function ma(){const t=et.timeline({delay:.2});t.to("#p7-hero-eyebrow",{opacity:1,y:0,duration:.7,ease:"power3.out"},0),t.fromTo(".p7-hero-title",{y:30},{opacity:1,y:0,duration:.9,ease:"power3.out"},.15),t.fromTo(".p7-hero-sub",{y:20},{opacity:.5,y:0,duration:.8,ease:"power3.out"},.3),t.fromTo(".p7-hero-tagline",{y:20},{opacity:1,y:0,duration:.8,ease:"power3.out"},.45),t.fromTo("#p7-hero-nav",{y:20},{opacity:1,y:0,duration:.8,ease:"power3.out"},.6),et.from("#p7-gallery-hdr",{scrollTrigger:{trigger:"#p7-gallery",start:"top 85%"},opacity:0,y:50,duration:.8,ease:"power3.out"}),et.from("#p7-ws-layout",{scrollTrigger:{trigger:"#p7-workshop",start:"top 80%"},opacity:0,y:30,duration:.8,ease:"power3.out"}),et.from("#p7-footer-inner",{scrollTrigger:{trigger:"#p7-footer",start:"top 85%"},opacity:0,y:40,duration:.8,ease:"power3.out"})}function Ta(){const t=document.querySelectorAll(".p7-chart-card");if(t.length){const b=new IntersectionObserver(y=>{y.forEach(p=>{p.isIntersecting&&(p.target.classList.add("p7-card-vis"),b.unobserve(p.target))})},{threshold:.05,rootMargin:"0px 0px -10px 0px"});t.forEach(y=>b.observe(y)),w.cleanups.push(()=>b.disconnect())}const e=document.getElementById("p7-mobile-tabs");if(e){const b={params:"p7-params-panel",preview:"p7-preview-panel",code:"p7-code-panel"},y=h=>{e.querySelectorAll(".p7-mob-tab").forEach(c=>c.classList.toggle("active",c.dataset.panel===h)),Object.entries(b).forEach(([c,m])=>document.getElementById(m)?.classList.toggle("mob-active",c===h)),h==="preview"&&U()};window.innerWidth<=768&&y("preview");const p=h=>{const c=h.target.closest("[data-panel]");c&&(h.preventDefault(),y(c.dataset.panel))};e.addEventListener("click",p),w.cleanups.push(()=>e.removeEventListener("click",p))}const a=document.getElementById("p7-code-editor");a&&(w.editor=Qt(a,{code:Nt.scatter(w.params.scatter),language:"r"}));const o=document.getElementById("p7-copy-wrap");o&&(w.copyBtn=te(o,{getText:()=>w.editor?w.editor.getCode():"",label:"复制代码",successLabel:"已复制"})),ct("scatter");const s=document.getElementById("p7-chart-grid");if(s){const b=p=>{const h=p.target.closest("[data-chart]");h&&(ct(h.dataset.chart),document.getElementById("p7-workshop")?.scrollIntoView({behavior:"smooth",block:"start"}))},y=p=>{if(p.key==="Enter"||p.key===" "){const h=p.target.closest("[data-chart]");h&&(p.preventDefault(),ct(h.dataset.chart))}};s.addEventListener("click",b),s.addEventListener("keydown",y),w.cleanups.push(()=>{s.removeEventListener("click",b),s.removeEventListener("keydown",y)})}const r=document.getElementById("p7-chart-tabs");if(r){const b=y=>{const p=y.target.closest("[data-chart]");p&&ct(p.dataset.chart)};r.addEventListener("click",b),w.cleanups.push(()=>r.removeEventListener("click",b))}const i=document.getElementById("p7-params-body");if(i){const b=p=>{if(p.target.dataset.param){const h=p.target.dataset.param,c=parseFloat(p.target.value),m=document.getElementById(`p7-val-${h}`);m&&(m.textContent=c),Ft(h,c)}},y=p=>{const h=p.target.closest("[data-group][data-val]");if(h){const m=h.dataset.group,l=h.dataset.val;i.querySelectorAll(`[data-group="${m}"]`).forEach(n=>n.classList.remove("active")),h.classList.add("active"),Ft(m,l);return}const c=p.target.closest("[data-toggle]");if(c){const m=c.dataset.toggle,l=!w.params[w.currentChart][m];w.params[w.currentChart][m]=l,c.classList.toggle("p7-toggle--on",l);const n=c.querySelector(".p7-tog-lbl");n&&(n.textContent=l?"开启":"关闭"),U(),ut();return}p.target.closest("[data-reset]")&&ha()};i.addEventListener("input",b),i.addEventListener("click",y),w.cleanups.push(()=>{i.removeEventListener("input",b),i.removeEventListener("click",y)})}const f=document.getElementById("p7-export-btn");if(f){const b=()=>{const y=w.editor?w.editor.getCode():"",p=new Blob([y],{type:"text/plain"}),h=URL.createObjectURL(p),c=document.createElement("a");c.href=h,c.download=`${w.currentChart}_plot.R`,document.body.appendChild(c),c.click(),c.remove(),URL.revokeObjectURL(h)};f.addEventListener("click",b),w.cleanups.push(()=>f.removeEventListener("click",b))}document.querySelectorAll("#p7-hero-nav .hero-quicknav__item").forEach(b=>{b.addEventListener("click",()=>{document.querySelector(b.dataset.target)?.scrollIntoView({behavior:"smooth",block:"start"})})}),document.getElementById("p7-btn-prev")?.addEventListener("click",()=>At("m1-p6")),document.getElementById("p7-btn-next")?.addEventListener("click",()=>At("m1-p8")),ga(),ma()}function Fa(){Xt(),w.editor&&(w.editor.destroy(),w.editor=null),w.copyBtn&&(w.copyBtn.destroy(),w.copyBtn=null),w.cleanups.forEach(t=>t()),w.cleanups=[],w.currentChart="scatter",w.params=JSON.parse(JSON.stringify($t))}export{Fa as destroy,Ta as init,za as render};
