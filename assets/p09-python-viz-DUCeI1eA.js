import{k as tt,g as O,f as et}from"./ScrollAnimations-B5Kyk-Xq.js";import{c as V}from"./CodeEditor-BiI1SvFS.js";import{n as G}from"./index-CqhzZnE2.js";import{s as F,l as M}from"./transform-CrlstJ90.js";import{N as at,h as rt}from"./index-DOot-1bs.js";import{b as W}from"./band-CtrpxvT2.js";import{r as Z,c as J,s as ot}from"./ramp-CyHZMPny.js";import{s as it,x as nt,y as lt,l as T}from"./line-Ci26EkcQ.js";import{w as st,c as N}from"./path-CbwjOpE9.js";import{c as L}from"./catmullRom-Dm0ttBHj.js";import{a as X}from"./area-D7iSONw5.js";import{b as q,R,v as pt}from"./basis-Cga8ZuBJ.js";import"./math-CRUJxRjv.js";function dt(t,a){return t.parent===a.parent?1:2}function j(t){var a=t.children;return a?a[0]:t.t}function Y(t){var a=t.children;return a?a[a.length-1]:t.t}function ct(t,a,l){var b=l/(a.i-t.i);a.c-=b,a.s+=l,t.c+=b,a.z+=l,a.m+=l}function ft(t){for(var a=0,l=0,b=t.children,n=b.length,m;--n>=0;)m=b[n],m.z+=a,m.m+=a,a+=m.s+(l+=m.c)}function ht(t,a,l){return t.a.parent===a.parent?t.a:l}function H(t,a){this._=t,this.parent=null,this.children=null,this.A=null,this.a=this,this.z=0,this.m=0,this.c=0,this.s=0,this.t=null,this.i=a}H.prototype=Object.create(at.prototype);function xt(t){for(var a=new H(t,0),l,b=[a],n,m,d,s;l=b.pop();)if(m=l._.children)for(l.children=new Array(s=m.length),d=s-1;d>=0;--d)b.push(n=l.children[d]=new H(m[d],d)),n.parent=l;return(a.parent=new H(null,0)).children=[a],a}function yt(){var t=dt,a=1,l=1,b=null;function n(e){var w=xt(e);if(w.eachAfter(m),w.parent.m=-w.z,w.eachBefore(d),b)e.eachBefore(p);else{var x=e,g=e,y=e;e.eachBefore(function(r){r.x<x.x&&(x=r),r.x>g.x&&(g=r),r.depth>y.depth&&(y=r)});var o=x===g?1:t(x,g)/2,c=o-x.x,f=a/(g.x+o+c),h=l/(y.depth||1);e.eachBefore(function(r){r.x=(r.x+c)*f,r.y=r.depth*h})}return e}function m(e){var w=e.children,x=e.parent.children,g=e.i?x[e.i-1]:null;if(w){ft(e);var y=(w[0].z+w[w.length-1].z)/2;g?(e.z=g.z+t(e._,g._),e.m=e.z-y):e.z=y}else g&&(e.z=g.z+t(e._,g._));e.parent.A=s(e,g,e.parent.A||x[0])}function d(e){e._.x=e.z+e.parent.m,e.m+=e.parent.m}function s(e,w,x){if(w){for(var g=e,y=e,o=w,c=g.parent.children[0],f=g.m,h=y.m,r=o.m,v=c.m,E;o=Y(o),g=j(g),o&&g;)c=j(c),y=Y(y),y.a=e,E=o.z+r-g.z-f+t(o._,g._),E>0&&(ct(ht(o,e,x),e,E),f+=E,h+=E),r+=o.m,f+=g.m,v+=c.m,h+=y.m;o&&!Y(y)&&(y.t=o,y.m+=r-h),g&&!j(c)&&(c.t=g,c.m+=f-v,x=e)}return x}function p(e){e.x*=a,e.y=e.depth*l}return n.separation=function(e){return arguments.length?(t=e,n):t},n.size=function(e){return arguments.length?(b=!1,a=+e[0],l=+e[1],n):b?null:[a,l]},n.nodeSize=function(e){return arguments.length?(b=!0,a=+e[0],l=+e[1],n):b?[a,l]:null},n}var gt=new Array(3).concat("deebf79ecae13182bd","eff3ffbdd7e76baed62171b5","eff3ffbdd7e76baed63182bd08519c","eff3ffc6dbef9ecae16baed63182bd08519c","eff3ffc6dbef9ecae16baed64292c62171b5084594","f7fbffdeebf7c6dbef9ecae16baed64292c62171b5084594","f7fbffdeebf7c6dbef9ecae16baed64292c62171b508519c08306b").map(J);const mt=Z(gt);var ut=new Array(3).concat("fee6cefdae6be6550d","feeddefdbe85fd8d3cd94701","feeddefdbe85fd8d3ce6550da63603","feeddefdd0a2fdae6bfd8d3ce6550da63603","feeddefdd0a2fdae6bfd8d3cf16913d948018c2d04","fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d948018c2d04","fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d94801a636037f2704").map(J);const bt=Z(ut);class vt{constructor(a,l){this._context=a,this._x=l}areaStart(){this._line=0}areaEnd(){this._line=NaN}lineStart(){this._point=0}lineEnd(){(this._line||this._line!==0&&this._point===1)&&this._context.closePath(),this._line=1-this._line}point(a,l){switch(a=+a,l=+l,this._point){case 0:{this._point=1,this._line?this._context.lineTo(a,l):this._context.moveTo(a,l);break}case 1:this._point=2;default:{this._x?this._context.bezierCurveTo(this._x0=(this._x0+a)/2,this._y0,this._x0,l,a,l):this._context.bezierCurveTo(this._x0,this._y0=(this._y0+l)/2,a,this._y0,a,l);break}}this._x0=a,this._y0=l}}function wt(t){return new vt(t,!1)}function kt(t){return t.source}function Et(t){return t.target}function _t(t){let a=kt,l=Et,b=nt,n=lt,m=null,d=null,s=st(p);function p(){let e;const w=it.call(arguments),x=a.apply(this,w),g=l.apply(this,w);if(m==null&&(d=t(e=s())),d.lineStart(),w[0]=x,d.point(+b.apply(this,w),+n.apply(this,w)),w[0]=g,d.point(+b.apply(this,w),+n.apply(this,w)),d.lineEnd(),e)return d=null,e+""||null}return p.source=function(e){return arguments.length?(a=e,p):a},p.target=function(e){return arguments.length?(l=e,p):l},p.x=function(e){return arguments.length?(b=typeof e=="function"?e:N(+e),p):b},p.y=function(e){return arguments.length?(n=typeof e=="function"?e:N(+e),p):n},p.context=function(e){return arguments.length?(e==null?m=d=null:d=t(m=e),p):m},p}function $t(){return _t(wt)}const At={id:"Figure",label:"Figure",color:"#7EC8E3",desc:"整个图形的顶层容器，对应一张图片文件。",api:"plt.figure(figsize=(8,6), dpi=150)",children:[{id:"Axes",label:"Axes",color:"#95D5B2",desc:"单个坐标系，包含所有绘图元素。一个 Figure 可有多个 Axes。",api:"fig.add_subplot(1,1,1)  # 或 plt.subplots()",children:[{id:"Title",label:"Title",color:"#B8B8E8",desc:"图表标题文本对象。",api:'ax.set_title("标题", fontsize=14)',children:[]},{id:"XAxis",label:"XAxis",color:"#B8B8E8",desc:"X 轴（含刻度、标签、刻度线）。",api:`ax.set_xlabel("X轴")
...
# transparent=True`,r:`ggsave(
    ...
    dpi = 300
        ...
        <pre style="background:#1d1d1f;color:#f5f5f7;padding:12px 14px;border-radius:8px;font-size:12px;white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word;margin:0;font-family:var(--font-code);line-height:1.5">${w.data.api}</pre>`)}),p.filter(e=>e.data.id==="Figure").dispatch("click")}function D(t){let a=t;return()=>(a=a*1664525+1013904223&4294967295,(a>>>0)/4294967295)}function zt(t,a,l,b,n){t.selectAll("*").remove();const m={t:25,r:20,b:35,l:45},d=b-m.l-m.r,s=n-m.t-m.b,p=t.append("g").attr("transform",`translate(${m.l},${m.t})`);t.insert("rect","g").attr("width",b).attr("height",n).attr("fill","#1d1d1f").attr("rx",8);for(let o=1;o<=4;o++)p.append("line").attr("x1",0).attr("y1",o*s/4).attr("x2",d).attr("y2",o*s/4).attr("stroke","#2d2d2f").attr("stroke-width",1);p.append("line").attr("x1",0).attr("y1",s).attr("x2",d).attr("y2",s).attr("stroke","#424245").attr("stroke-width",1),p.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",s).attr("stroke","#424245").attr("stroke-width",1);const e=D(42),w=["A","B","C","D"],x={deep:["#4C72B0","#DD8452","#55A868","#C44E52"],Set2:["#66C2A5","#FC8D62","#8DA0CB","#E78AC3"],Set1:["#E41A1C","#377EB8","#4DAF4A","#984EA3"],pastel:["#AEC6CF","#FFD1DC","#B5EAD7","#FFDAC1"],viridis:["#440154","#31688E","#35B779","#FDE725"],muted:["#4878D0","#EE854A","#6ACC64","#D65F5F"],rocket:["#03051A","#4A0C5C","#B0298B","#F87060"],husl:["#F77189","#BB9832","#50B131","#36ADA4"]},g=l.palette&&x[l.palette]||["#7EC8E3","#95D5B2","#B8B8E8","#F0B27A"];function y(o,c,f,h="middle"){p.append("text").attr("x",o).attr("y",c).attr("text-anchor",h).attr("font-size",10).attr("fill","#a0a0a8").attr("font-family","sans-serif").text(f)}if(a==="scatter"){const o=Array.from({length:50},()=>({x:.05+e()*.9,y:.05+e()*.9,gi:Math.floor(e()*4)})),c=Math.max(2,Math.sqrt((l.size||60)/Math.PI)*1.1);p.selectAll("circle").data(o).join("circle").attr("cx",f=>f.x*d).attr("cy",f=>(1-f.y)*s).attr("r",c).attr("fill",f=>l.hue?g[f.gi]:g[0]).attr("opacity",l.alpha||.7)}else if(a==="line"){const c=Array.from({length:3},(h,r)=>({gi:r,pts:Array.from({length:10},(v,E)=>({x:E/9,y:Math.max(.02,Math.min(.92,.12+r*.22+e()*.08+Math.sin(E/3)*.06))}))})),f=T().x(h=>h.x*d).y(h=>(1-h.y)*s).curve(L);c.forEach(h=>{if(l.ci){const r=X().x(v=>v.x*d).y0(v=>(1-Math.max(.02,v.y-.06))*s).y1(v=>(1-Math.min(.92,v.y+.06))*s).curve(L);p.append("path").attr("d",r(h.pts)).attr("fill",g[h.gi]).attr("opacity",.2)}p.append("path").attr("d",f(h.pts)).attr("fill","none").attr("stroke",g[h.gi]).attr("stroke-width",2),l.markers&&p.selectAll(`.mk${h.gi}`).data(h.pts).join("circle").attr("class",`.mk${h.gi}`).attr("cx",r=>r.x*d).attr("cy",r=>(1-r.y)*s).attr("r",3.5).attr("fill",g[h.gi])}),[0,3,6,9].forEach(h=>y(h/9*d,s+14,`Q${h+1}`))}else if(a==="bar"){const o=w.map(()=>.35+e()*.45),c=o.map(f=>f*.1+.03);if(l.orient==="v"){const f=W().domain(w).range([0,d]).padding(.28);p.selectAll("rect").data(o).join("rect").attr("x",(h,r)=>f(w[r])).attr("y",h=>(1-h)*s).attr("width",f.bandwidth()).attr("height",h=>h*s).attr("fill",(h,r)=>g[r]).attr("rx",3),l.ci&&o.forEach((h,r)=>{const v=f(w[r])+f.bandwidth()/2,E=(1-(h+c[r]))*s,i=(1-(h-c[r]))*s;p.append("line").attr("x1",v).attr("y1",E).attr("x2",v).attr("y2",i).attr("stroke","#fff").attr("stroke-width",1.5),p.append("line").attr("x1",v-5).attr("y1",E).attr("x2",v+5).attr("y2",E).attr("stroke","#fff").attr("stroke-width",1.5),p.append("line").attr("x1",v-5).attr("y1",i).attr("x2",v+5).attr("y2",i).attr("stroke","#fff").attr("stroke-width",1.5)}),w.forEach((h,r)=>y(f(h)+f.bandwidth()/2,s+14,h))}else{const f=W().domain(w).range([0,s]).padding(.28);p.selectAll("rect").data(o).join("rect").attr("x",0).attr("y",(h,r)=>f(w[r])).attr("width",h=>h*d).attr("height",f.bandwidth()).attr("fill",(h,r)=>g[r]).attr("rx",3),l.ci&&o.forEach((h,r)=>{const v=f(w[r])+f.bandwidth()/2,E=(h+c[r])*d;p.append("line").attr("x1",E).attr("y1",v-6).attr("x2",E).attr("y2",v+6).attr("stroke","#fff").attr("stroke-width",1.5)}),w.forEach((h,r)=>y(-6,f(h)+f.bandwidth()/2+4,h,"end"))}}else if(a==="box"){const o=(l.width||.5)*d/5.5,c=!!l.notch;w.forEach((f,h)=>{const r=(h+.5)*(d/4),v=.35+e()*.28,E=Math.max(.04,v-.1-e()*.06),i=Math.min(.94,v+.1+e()*.06),u=Math.max(.01,E-.13),k=Math.min(.97,i+.13),$=g[h];if(p.append("line").attr("x1",r).attr("y1",(1-k)*s).attr("x2",r).attr("y2",(1-i)*s).attr("stroke",$).attr("stroke-width",1.5).attr("stroke-dasharray","3,2"),p.append("line").attr("x1",r).attr("y1",(1-E)*s).attr("x2",r).attr("y2",(1-u)*s).attr("stroke",$).attr("stroke-width",1.5).attr("stroke-dasharray","3,2"),p.append("line").attr("x1",r-o/3).attr("y1",(1-k)*s).attr("x2",r+o/3).attr("y2",(1-k)*s).attr("stroke",$).attr("stroke-width",1.5),p.append("line").attr("x1",r-o/3).attr("y1",(1-u)*s).attr("x2",r+o/3).attr("y2",(1-u)*s).attr("stroke",$).attr("stroke-width",1.5),c){const A=o*.45,z=(1-v)*s,_=(1-E)*s,S=(1-i)*s,B=`M${r-o/2},${S} L${r-o/2},${z-7} L${r-A/2},${z} L${r-o/2},${z+7} L${r-o/2},${_} L${r+o/2},${_} L${r+o/2},${z+7} L${r+A/2},${z} L${r+o/2},${z-7} L${r+o/2},${S}Z`;p.append("path").attr("d",B).attr("fill",$).attr("opacity",.7)}else p.append("rect").attr("x",r-o/2).attr("y",(1-i)*s).attr("width",o).attr("height",(i-E)*s).attr("fill",$).attr("opacity",.7).attr("rx",2);p.append("line").attr("x1",r-o/2).attr("y1",(1-v)*s).attr("x2",r+o/2).attr("y2",(1-v)*s).attr("stroke","#fff").attr("stroke-width",2),y(r,s+14,f)})}else if(a==="violin"){const o=Math.max(.4,Math.min(2.5,l.bw||1)),c=l.inner||"box";w.forEach((f,h)=>{const r=(h+.5)*(d/4),v=g[h],E=28,i=[];for(let S=0;S<E;S++){const B=S/(E-1),P=.05+B*.9,Q=Math.sin(Math.PI*B),K=Math.sin(Math.PI*B*1.6+h*.6)*.18,U=Math.max(1,(Q+K)*(.035+e()*.018)*o*d);i.push({y:P,w:U})}const u=i.map((S,B)=>`${B===0?"M":"L"}${r-S.w},${(1-S.y)*s}`).join(" ")+i.slice().reverse().map(S=>`L${r+S.w},${(1-S.y)*s}`).join(" ")+"Z";p.append("path").attr("d",u).attr("fill",v).attr("opacity",.65);const k=.38+e()*.22,$=Math.max(.06,k-.1),A=Math.min(.92,k+.1),z=Math.floor(E/2),_=i[z].w*.45;if(c==="box")p.append("rect").attr("x",r-_/2).attr("y",(1-A)*s).attr("width",_).attr("height",(A-$)*s).attr("fill","#1d1d1f").attr("stroke",v).attr("stroke-width",1),p.append("circle").attr("cx",r).attr("cy",(1-k)*s).attr("r",3).attr("fill","#fff");else if(c==="quartile")[$,k,A].forEach(S=>{p.append("line").attr("x1",r-_).attr("y1",(1-S)*s).attr("x2",r+_).attr("y2",(1-S)*s).attr("stroke",S===k?"#fff":"#aaa").attr("stroke-width",S===k?2:1)});else if(c==="point")for(let S=0;S<12;S++){const B=.08+e()*.84,P=(e()-.5)*_*1.8;p.append("circle").attr("cx",r+P).attr("cy",(1-B)*s).attr("r",1.5).attr("fill","#fff").attr("opacity",.75)}else if(c==="stick")for(let S=0;S<12;S++){const B=.08+e()*.84;p.append("line").attr("x1",r-_*.9).attr("y1",(1-B)*s).attr("x2",r+_*.9).attr("y2",(1-B)*s).attr("stroke","#fff").attr("stroke-width",.8).attr("opacity",.7)}y(r,s+14,f)})}else if(a==="hist"){const o=Math.max(4,Math.min(l.bins||20,50)),c=.45,f=.18,h=Array.from({length:o},(v,E)=>{const i=(E+.5)/o;return Math.exp(-Math.pow((i-c)/f,2)/2)*(.7+e()*.18)}),r=d/o;if(p.selectAll("rect").data(h).join("rect").attr("x",(v,E)=>E*r+1).attr("y",v=>(1-v)*s).attr("width",r-2).attr("height",v=>v*s).attr("fill",l.color||"#7EC8E3").attr("opacity",.85),l.kde){const v=Array.from({length:60},(E,i)=>{const u=i/59;return{x:u,y:Math.exp(-Math.pow((u-c)/f,2)/2)*.92}});p.append("path").attr("d",T().x(E=>E.x*d).y(E=>(1-E.y)*s).curve(q)(v)).attr("fill","none").attr("stroke","#F0D264").attr("stroke-width",2.5)}}else if(a==="kde"){const c=.12*Math.max(.3,l.bw||1),f=l.hue?3:1,h=[.28,.48,.68];for(let r=0;r<f;r++){const v=g[r],E=Array.from({length:60},(u,k)=>{const $=k/59;return{x:$,y:Math.exp(-Math.pow(($-h[r])/c,2)/2)*.88}}),i=T().x(u=>u.x*d).y(u=>(1-u.y)*s).curve(q);if(l.fill){const u=X().x(k=>k.x*d).y0(s).y1(k=>(1-k.y)*s).curve(q);p.append("path").attr("d",u(E)).attr("fill",v).attr("opacity",.2)}p.append("path").attr("d",i(E)).attr("fill","none").attr("stroke",v).attr("stroke-width",2.5)}}else if(a==="heatmap"){const c=d/4,f=s/4,h=[[1,.72,-.31,.54],[.72,1,.18,-.08],[-.31,.18,1,-.63],[.54,-.08,-.63,1]],v=ot({coolwarm:R,viridis:pt,RdBu:R,Blues:mt,Oranges:bt}[l.cmap]||R).domain([1,-1]),E=["X1","X2","X3","X4"];for(let i=0;i<4;i++)for(let u=0;u<4;u++)if(p.append("rect").attr("x",u*c+1).attr("y",i*f+1).attr("width",c-2).attr("height",f-2).attr("fill",v(h[i][u])).attr("rx",2),l.annot){const k=l.fmt===".2f"?2:1;p.append("text").attr("x",u*c+c/2).attr("y",i*f+f/2+4).attr("text-anchor","middle").attr("font-size",9).attr("fill","#fff").attr("font-weight","600").attr("font-family","JetBrains Mono, monospace").text(h[i][u].toFixed(k))}E.forEach((i,u)=>y(u*c+c/2,s+14,i))}else if(a==="pair"){const c=d/2,f=s/2,h=l.hue?3:1;for(let r=0;r<2;r++)for(let v=0;v<2;v++)if(p.append("rect").attr("x",v*c+2).attr("y",r*f+2).attr("width",c-4).attr("height",f-4).attr("fill","#2d2d2f").attr("rx",4),r===v)if(l.diag==="kde")for(let E=0;E<h;E++){const i=.25+E*.25,u=Array.from({length:20},(k,$)=>{const A=$/19;return{x:A,y:Math.exp(-Math.pow((A-i)/.16,2)/2)*.85}});p.append("path").attr("d",T().x(k=>v*c+4+k.x*(c-8)).y(k=>r*f+f-4-k.y*(f-8)).curve(q)(u)).attr("fill","none").attr("stroke",g[E]).attr("stroke-width",1.5)}else for(let i=0;i<h;i++)for(let u=0;u<6;u++){const k=(.15+e()*.55)*(f-8)*.8,$=(c-8)/6/h;p.append("rect").attr("x",v*c+4+u*(c-8)/6+i*$).attr("y",r*f+f-4-k).attr("width",$-1).attr("height",k).attr("fill",g[i]).attr("opacity",.85)}else for(let E=0;E<h;E++)for(let i=0;i<8;i++)p.append("circle").attr("cx",v*c+5+e()*(c-10)).attr("cy",r*f+5+e()*(f-10)).attr("r",2.5).attr("fill",l.hue?g[E]:g[0]).attr("opacity",.75);["V1","V2"].forEach((r,v)=>y(v*c+c/2,s+14,r))}else if(a==="reg"){const o=l.order||1,c=l.color||"#7EC8E3",f=(l.ci||95)/100*.07,h=Array.from({length:35},()=>({x:.05+e()*.9,y:0}));h.forEach(i=>{o===1?i.y=.1+i.x*.7+(e()-.5)*.16:o===2?i.y=.1+.1*i.x+.9*i.x*i.x+(e()-.5)*.13:i.y=.7-2.2*i.x+3.5*i.x*i.x-1.5*i.x*i.x*i.x+(e()-.5)*.1,i.y=Math.max(.02,Math.min(.95,i.y))}),l.scatter&&p.selectAll("circle").data(h).join("circle").attr("cx",i=>i.x*d).attr("cy",i=>(1-i.y)*s).attr("r",3.5).attr("fill",c).attr("opacity",.45);const r=Array.from({length:50},(i,u)=>{const k=.05+u/49*.9;let $;return o===1?$=.1+k*.7:o===2?$=.1+.1*k+.9*k*k:$=.7-2.2*k+3.5*k*k-1.5*k*k*k,{x:k,y:Math.max(.02,Math.min(.95,$))}}),v=r.map(i=>({x:i.x*d,y:(1-Math.min(.95,i.y+f))*s})),E=[...r].reverse().map(i=>({x:i.x*d,y:(1-Math.max(.02,i.y-f))*s}));p.append("path").attr("d",v.map((i,u)=>`${u===0?"M":"L"}${i.x},${i.y}`).join(" ")+" "+E.map(i=>`L${i.x},${i.y}`).join(" ")+"Z").attr("fill",c).attr("opacity",.2),p.append("path").attr("d",T().x(i=>i.x*d).y(i=>(1-i.y)*s).curve(L)(r)).attr("fill","none").attr("stroke",c).attr("stroke-width",2.5)}}function Mt(t){if(!t)return null;const a=t.querySelector(".sb-list"),l=t.querySelector(".sb-params"),b=t.querySelector(".sb-preview"),n=t.querySelector(".sb-code");if(!a||!l||!b||!n)return null;let m=I[0],d=Object.fromEntries(m.params.map(x=>[x.id,x.default])),s=null;I.forEach((x,g)=>{const y=document.createElement("div");y.className="sb-list-item",y.style.cssText="display:flex;gap:10px;align-items:center;padding:10px 12px;cursor:pointer;border-radius:8px;transition:background 0.2s;min-height:44px;min-width:0;",y.innerHTML=`<span style="font-size:16px;flex-shrink:0">${x.icon}</span><div style="min-width:0;overflow:hidden"><div style="font-weight:600;font-size:13px;color:var(--text-on-dark);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${x.name}</div><div style="font-size:11px;color:var(--text-on-dark-2);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${x.desc}</div></div>`,g===0&&(y.style.background="rgba(126,200,227,0.12)"),y.addEventListener("click",()=>{a.querySelectorAll(".sb-list-item").forEach(o=>o.style.background=""),y.style.background="rgba(126,200,227,0.12)",m=x,d=Object.fromEntries(x.params.map(o=>[o.id,o.default])),p(),e(),w()}),a.appendChild(y)});function p(){l.innerHTML=`<div style="font-weight:600;font-size:14px;color:var(--text-on-dark);margin-bottom:14px;font-family:var(--font-code)">${m.name}</div>`,m.params.forEach(x=>{const g=document.createElement("div");g.style.marginBottom="12px",x.type==="select"?g.innerHTML=`<label style="display:block;margin-bottom:4px;font-size:12px;color:var(--text-on-dark-2)">${x.label}</label>
          ...
          ${x.label}</label>`),l.appendChild(g)}),l.querySelectorAll("[data-pid]").forEach(x=>{x.addEventListener("change",()=>{const g=x.dataset.pid;x.type==="checkbox"?d[g]=x.checked:x.type==="range"?d[g]=parseFloat(x.value):d[g]=x.value;const y=l.querySelector(`.pval-${g}`);y&&(y.textContent=d[g]),e(),w()})})}function e(){b.innerHTML="";const x=Math.max(b.clientWidth||0,180),g=320,y=F(b).append("svg").attr("viewBox",`0 0 ${x} ${g}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("display","block");zt(y,m.id,d,x,g)}function w(){const x=m.genCode(d);s?s.setCode(x):s=V(n,{language:"python",code:x,readOnly:window.innerWidth<768})}return p(),e(),w(),{destroy(){if(s){try{s.destroy()}catch{}s=null}}}}function Bt(t,a){const n=F(t).append("svg").attr("viewBox","0 0 130 80").attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("display","block");n.append("rect").attr("width",130).attr("height",80).attr("fill","#1d1d1f").attr("rx",6);const m={t:10,r:10,b:16,l:18},d=n.append("g").attr("transform",`translate(${m.l},${m.t})`),s=130-m.l-m.r,p=80-m.t-m.b;d.append("line").attr("x1",0).attr("y1",p).attr("x2",s).attr("y2",p).attr("stroke","#424245").attr("stroke-width",.8),d.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",p).attr("stroke","#424245").attr("stroke-width",.8);const e=["#7EC8E3","#95D5B2","#B8B8E8","#F0B27A"],w=D(a.length*7+1);if(a==="散点图")for(let x=0;x<22;x++)d.append("circle").attr("cx",w()*s).attr("cy",w()*p).attr("r",2.5).attr("fill",e[Math.floor(w()*3)]).attr("opacity",.8);else if(a==="折线图"){const x=[.55,.35,.65,.45,.75,.6,.85],g=[.25,.15,.3,.2,.4,.28,.45],y=M().domain([0,6]).range([0,s]),o=M().domain([0,1]).range([p,0]),c=T().x((f,h)=>y(h)).y(f=>o(f)).curve(L);d.append("path").attr("d",c(x)).attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",1.8),d.append("path").attr("d",c(g)).attr("fill","none").attr("stroke","#95D5B2").attr("stroke-width",1.8)}else if(a==="柱状图"){const x=[.55,.8,.4,.65],g=W().domain([0,1,2,3]).range([0,s]).padding(.2);x.forEach((y,o)=>{const c=y*p;d.append("rect").attr("x",g(o)).attr("y",p-c).attr("width",g.bandwidth()).attr("height",c).attr("fill",e[o]).attr("rx",2).attr("opacity",.9)})}else if(a==="分面 Facet"){const x=(s-4)/2,g=(p-4)/2;[[0,0],[1,0],[0,1],[1,1]].forEach(([y,o],c)=>{const f=y*(x+4),h=o*(g+4);d.append("rect").attr("x",f).attr("y",h).attr("width",x).attr("height",g).attr("fill","#2a2a2d").attr("rx",2);const r=D(c*13+3);for(let v=0;v<5;v++)d.append("circle").attr("cx",f+3+r()*(x-6)).attr("cy",h+3+r()*(g-6)).attr("r",2).attr("fill",e[c]).attr("opacity",.85)})}else if(a==="主题样式"){[.25,.5,.75,1].forEach(c=>{d.append("line").attr("x1",0).attr("y1",c*p).attr("x2",s).attr("y2",c*p).attr("stroke","#333336").attr("stroke-dasharray","2,2").attr("stroke-width",.6)});const x=[.3,.5,.42,.68,.55,.78],g=M().domain([0,5]).range([0,s]),y=M().domain([0,1]).range([p,0]),o=T().x((c,f)=>g(f)).y(c=>y(c)).curve(L);d.append("path").attr("d",o(x)).attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",1.8)}else if(a==="配色 Scale"){const g=n.append("defs").append("linearGradient").attr("id",`cg${a.length}`).attr("x1","0%").attr("x2","100%");g.append("stop").attr("offset","0%").attr("stop-color","#3B4CC0"),g.append("stop").attr("offset","50%").attr("stop-color","#95D5B2"),g.append("stop").attr("offset","100%").attr("stop-color","#F0B27A"),d.append("rect").attr("x",0).attr("y",p/2-5).attr("width",s).attr("height",12).attr("fill",`url(#cg${a.length})`).attr("rx",3),["#3B4CC0","#6A8FD5","#95D5B2","#F0C070","#F0B27A"].forEach((y,o)=>{d.append("circle").attr("cx",(o+.5)*s/5).attr("cy",p/2-18).attr("r",6).attr("fill",y)})}else if(a==="标注 Annotate"){const x=[.25,.45,.38,.7,.55,.65],g=M().domain([0,5]).range([0,s]),y=M().domain([0,1]).range([p,0]),o=T().x((h,r)=>g(r)).y(h=>y(h)).curve(L);d.append("path").attr("d",o(x)).attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",1.8);const c=g(3),f=y(.7);d.append("circle").attr("cx",c).attr("cy",f).attr("r",4).attr("fill","#F0B27A"),d.append("line").attr("x1",c).attr("y1",f).attr("x2",c-15).attr("y2",f-18).attr("stroke","#F0B27A").attr("stroke-width",1.2),d.append("text").attr("x",c-16).attr("y",f-20).attr("fill","#F0B27A").attr("font-size",8).attr("text-anchor","end").attr("font-family","sans-serif").text("关键点")}else if(a==="保存图片"){const y=(s-32)/2,o=(p-42)/2-4;d.append("path").attr("d",`M${y},${o+8} L${y+8},${o} L${y+32},${o} L${y+32},${o+42} L${y},${o+42} Z`).attr("fill","#2a2a2d").attr("stroke","#424245").attr("stroke-width",1.2),d.append("path").attr("d",`M${y},${o+8} L${y+8},${o+8} L${y+8},${o}`).attr("fill","none").attr("stroke","#424245").attr("stroke-width",1);const c=y+32/2,f=o+42/2+4;d.append("line").attr("x1",c).attr("y1",f-8).attr("x2",c).attr("y2",f+6).attr("stroke","#7EC8E3").attr("stroke-width",1.5),d.append("path").attr("d",`M${c-4},${f+2} L${c},${f+7} L${c+4},${f+2}`).attr("fill","#7EC8E3"),d.append("text").attr("x",c).attr("y",o+42+12).attr("fill","#7EC8E3").attr("font-size",7).attr("text-anchor","middle").attr("font-family","sans-serif").text("PDF/SVG")}}function Tt(t){if(!t)return;const a=t.querySelector("#compare-rows"),l=t.querySelector(".compare-tabs");if(!a)return;const b=document.createElement("div");b.className="compare-header-row",b.style.cssText="display:grid;grid-template-columns:90px 140px 1fr 1fr;gap:12px;padding:8px 0 10px;border-bottom:2px solid var(--border-light);margin-bottom:4px;",b.innerHTML=`
    ...
    <div style="font-size:11px;font-weight:600;color:#95D5B2;text-transform:uppercase;letter-spacing:0.08em;padding-left:12px">📊 R / ggplot2</div>`,a.appendChild(b),St.forEach(n=>{const m=document.createElement("div");m.className="compare-row",m.style.cssText="display:grid;grid-template-columns:90px 140px 1fr 1fr;gap:12px;border-top:1px solid var(--border-light);padding:16px 0;align-items:start;",m.innerHTML=`
      ...
      <pre class="compare-r" style="background:#f5f5f7;color:#1d1d1f;padding:12px;border-radius:8px;font-size:11px;white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word;margin:0;font-family:var(--font-code);line-height:1.5;min-width:0">${n.r}</pre>`,a.appendChild(m),Bt(m.querySelector(".cmp-mini-wrap"),n.concept)}),window.innerWidth<=768&&l&&(l.style.display="flex",a.querySelectorAll(".compare-r").forEach(n=>n.style.display="none"),l.querySelectorAll(".compare-tab").forEach(n=>{n.addEventListener("click",()=>{l.querySelectorAll(".compare-tab").forEach(d=>{d.style.background="var(--bg-light-alt)",d.style.color="var(--text-on-light)",d.style.border="1px solid var(--border-light)"}),n.style.background="var(--accent)",n.style.color="#1d1d1f",n.style.border="none";const m=n.dataset.lang;a.querySelectorAll(".compare-python").forEach(d=>{d.style.display=m==="python"?"block":"none"}),a.querySelectorAll(".compare-r").forEach(d=>{d.style.display=m==="r"?"block":"none"})})}))}function Lt(t,a,l,b,n,m){const d=Math.atan2(n-l,b-a),s=10;t.strokeStyle=m,t.fillStyle=m,t.lineWidth=2,t.beginPath(),t.moveTo(a,l),t.lineTo(b,n),t.stroke(),t.beginPath(),t.moveTo(b,n),t.lineTo(b-s*Math.cos(d-.4),n-s*Math.sin(d-.4)),t.lineTo(b-s*Math.cos(d+.4),n-s*Math.sin(d+.4)),t.closePath(),t.fill()}function Ft(t,a){const l=t.type==="arrow"?Math.min(t.x1,t.x2):t.x,b=t.type==="arrow"?Math.min(t.y1,t.y2):t.y,n=t.type==="arrow"?Math.abs(t.x2-t.x1)+20:t.w||60,m=t.type==="arrow"?Math.abs(t.y2-t.y1)+20:t.h||40;return a.x>=l-10&&a.x<=l+n+10&&a.y>=b-10&&a.y<=b+m+10}function qt(t){if(!t)return null;const a=t.querySelector("#annotate-canvas"),l=t.querySelector(".annotate-toolbar"),b=t.querySelector(".ann-code-editor");if(!a||!l||!b)return null;const n=a.getContext("2d"),m=window.devicePixelRatio||1;let d=null;const s=[];let p="arrow",e=null,w={x:0,y:0},x=null;[{type:"arrow",label:"↗ 箭头"},{type:"text",label:"T 文字"},{type:"rect",label:"□ 方框"},{type:"highlight",label:"◆ 高亮"}].forEach(i=>{const u=document.createElement("button");u.textContent=i.label,u.dataset.type=i.type,u.style.cssText="padding:8px 14px;min-height:44px;background:#2d2d2f;border:1px solid var(--border-dark);border-radius:8px;color:var(--text-on-dark);cursor:pointer;font-size:13px;transition:background 0.2s;white-space:nowrap;",i.type==="arrow"&&(u.style.background="rgba(126,200,227,0.18)"),u.addEventListener("click",()=>{l.querySelectorAll("button[data-type]").forEach(k=>k.style.background="#2d2d2f"),u.style.background="rgba(126,200,227,0.18)",p=i.type}),l.appendChild(u)});const y=document.createElement("button");y.textContent="重置",y.style.cssText="padding:8px 14px;min-height:44px;background:transparent;border:1px solid var(--border-dark);border-radius:8px;color:var(--accent);cursor:pointer;font-size:13px;margin-left:auto;white-space:nowrap;",y.addEventListener("click",()=>{s.length=0,h(),v()}),l.appendChild(y);function o(){const i=a.parentElement.clientWidth||400,u=Math.round(Math.min(i*.55,380));a.width=Math.round(i*m),a.height=Math.round(u*m),a.style.width=i+"px",a.style.height=u+"px",n.setTransform(m,0,0,m,0,0),c(),f()}function c(){const i=a.clientWidth,u=a.clientHeight;n.fillStyle="#1d1d1f",n.fillRect(0,0,i,u),n.strokeStyle="#424245",n.lineWidth=1,n.beginPath(),n.moveTo(55,15),n.lineTo(55,u-30),n.lineTo(i-15,u-30),n.stroke();const k=[30,80,55,120,95,150,110,170,140,185],$=(i-80)/(k.length-1),A=(u-55)/200,z=k.map((_,S)=>({x:55+S*$,y:u-30-_*A}));n.strokeStyle="#7EC8E3",n.lineWidth=2,n.beginPath(),z.forEach((_,S)=>S===0?n.moveTo(_.x,_.y):n.lineTo(_.x,_.y)),n.stroke(),n.fillStyle="#7EC8E3",z.forEach(_=>{n.beginPath(),n.arc(_.x,_.y,3.5,0,Math.PI*2),n.fill()}),n.fillStyle="#6e6e73",n.font="11px sans-serif",n.fillText("时间",i/2-10,u-8),n.save(),n.translate(14,u/2),n.rotate(-Math.PI/2),n.fillText("值",-8,0),n.restore()}function f(){s.forEach(i=>{if(n.save(),i.type==="arrow")Lt(n,i.x1,i.y1,i.x2,i.y2,"#F0D264"),n.fillStyle="#F0D264",n.font="bold 11px sans-serif",n.fillText(i.label||"峰值",i.x2+6,i.y2-4);else if(i.type==="text"){n.font="12px sans-serif";const u=n.measureText(i.label||"标注").width;n.fillStyle="rgba(240,210,100,0.9)",n.fillRect(i.x-3,i.y-14,u+8,18),n.fillStyle="#1d1d1f",n.fillText(i.label||"标注",i.x+1,i.y)}else i.type==="rect"?(n.strokeStyle="#E07A7A",n.lineWidth=2,n.setLineDash([5,3]),n.strokeRect(i.x,i.y,i.w||70,i.h||45),n.setLineDash([])):i.type==="highlight"&&(n.fillStyle="rgba(240,178,122,0.22)",n.fillRect(i.x,i.y,i.w||70,i.h||45),n.strokeStyle="#F0B27A",n.lineWidth=1.5,n.strokeRect(i.x,i.y,i.w||70,i.h||45));n.restore()})}function h(){c(),f()}function r(i){const u=a.getBoundingClientRect(),k=a.clientWidth/u.width,$=a.clientHeight/u.height,A=i.clientX??i.touches?.[0]?.clientX??0,z=i.clientY??i.touches?.[0]?.clientY??0;return{x:(A-u.left)*k,y:(z-u.top)*$}}a.addEventListener("pointerdown",i=>{i.preventDefault(),a.setPointerCapture(i.pointerId);const u=r(i);e=s.slice().reverse().find(k=>Ft(k,u))||null,e?w={x:u.x-(e.x??e.x1),y:u.y-(e.y??e.y1)}:x=u}),a.addEventListener("pointermove",i=>{if(!e&&!x)return;const u=r(i);if(e){const k=u.x-w.x-(e.x??e.x1),$=u.y-w.y-(e.y??e.y1);e.type==="arrow"?(e.x1+=k,e.y1+=$,e.x2+=k,e.y2+=$):(e.x+=k,e.y+=$),w={x:u.x-(e.x??e.x1),y:u.y-(e.y??e.y1)},h()}}),a.addEventListener("pointerup",i=>{if(!e&&x){const u=r(i);if(p==="arrow")s.push({type:"arrow",x1:x.x,y1:x.y,x2:u.x,y2:u.y,label:"关键点"});else if(p==="text")s.push({type:"text",x:u.x,y:u.y,label:"标注文字"});else{const k=u.x-x.x,$=u.y-x.y;s.push({type:p,x:Math.min(x.x,u.x),y:Math.min(x.y,u.y),w:Math.abs(k)||70,h:Math.abs($)||45})}h(),v()}e=null,x=null});function v(){const i=a.clientWidth,u=a.clientHeight,k=_=>((_-55)/(i-80)*10).toFixed(1),$=_=>((u-30-_)/(u-55)*200).toFixed(0),A=["import matplotlib.pyplot as plt","","fig, ax = plt.subplots(figsize=(8, 6), dpi=150)","# ... 绘制图表数据 ...",""];s.forEach(_=>{_.type==="arrow"?(A.push(`ax.annotate("${_.label||"关键点"}",`),A.push(`    xy=(${k(_.x2)}, ${$(_.y2)}),`),A.push(`    xytext=(${k(_.x1)}, ${$(_.y1)}),`),A.push('    arrowprops=dict(arrowstyle="->", color="#F0D264"),'),A.push('    color="#F0D264", fontsize=10)')):_.type==="text"?(A.push(`ax.text(${k(_.x)}, ${$(_.y)}, "标注文字",`),A.push('    fontsize=10, color="#F0D264")')):(_.type==="rect"||_.type==="highlight")&&(A.push("from matplotlib.patches import FancyBboxPatch"),A.push(`rect = FancyBboxPatch((${k(_.x)}, ${$(_.y+(_.h||45))}),`),A.push(`    ${((_.w||70)/(i-80)*10).toFixed(1)}, ${((_.h||45)/(u-55)*200).toFixed(0)},`),A.push('    boxstyle="round,pad=0.1",'),A.push(`    fill=${_.type==="highlight"?"True":"False"},`),A.push('    alpha=0.2, color="#F0B27A")'),A.push("ax.add_patch(rect)")),A.push("")}),A.push("plt.tight_layout()");const z=A.join(`
`);d?d.setCode(z):d=V(b,{language:"python",code:z,readOnly:window.innerWidth<768})}o(),v();const E=()=>{o(),v()};return window.addEventListener("resize",E),{destroy(){if(window.removeEventListener("resize",E),d){try{d.destroy()}catch{}d=null}}}}function ee(){return`
...
`}function Ht(t){if(!t)return;t.innerHTML=`
    ...
    </div>`;const a=D(55),l=["A","B","C","D"],b={A:"#7EC8E3",B:"#95D5B2",C:"#F0B27A",D:"#B8B8E8"},n=Array.from({length:60},()=>{const o=l[Math.floor(a()*4)];return{x:.05+a()*.9,y:.05+a()*.9,g:o}}),m=480,d=280,s=F(t.querySelector(".cc-svg-wrap")).append("svg").attr("viewBox",`0 0 ${m} ${d}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","10px"),p={t:15,r:15,b:30,l:40},e=s.append("g").attr("transform",`translate(${p.l},${p.t})`),w=m-p.l-p.r,x=d-p.t-p.b;e.append("line").attr("x1",0).attr("y1",x).attr("x2",w).attr("y2",x).attr("stroke","#d2d2d7").attr("stroke-width",1),e.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",x).attr("stroke","#d2d2d7").attr("stroke-width",1);const g=e.selectAll("circle").data(n).join("circle").attr("cx",o=>o.x*w).attr("cy",o=>(1-o.y)*x).attr("r",5).attr("fill",o=>b[o.g]).attr("opacity",.75);function y(o){g.transition().duration(400).attr("fill",c=>o==="all"||c.g===o?b[c.g]:"#d2d2d7").attr("opacity",c=>o==="all"?.75:c.g===o?.9:.3),t.querySelectorAll(".cc-btn").forEach(c=>{const f=c.dataset.group===o;c.style.background=f?"var(--accent)":"transparent",c.style.color=f?"#1d1d1f":"var(--text-on-light-2)",c.style.fontWeight=f?"600":"400"})}t.querySelectorAll(".cc-btn").forEach(o=>{o.addEventListener("click",()=>y(o.dataset.group))})}function Wt(t){if(!t)return;t.innerHTML=`
    <div class="story-grid">
      <div>
    ...
    </div>`;const a=500,l=260,b=F(t.querySelector(".af-svg-wrap")).append("svg").attr("viewBox",`0 0 ${a} ${l}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","10px"),n={t:20,r:20,b:35,l:45},m=b.append("g").attr("transform",`translate(${n.l},${n.t})`),d=a-n.l-n.r,s=l-n.t-n.b;m.append("line").attr("x1",0).attr("y1",s).attr("x2",d).attr("y2",s).attr("stroke","#d2d2d7").attr("stroke-width",1),m.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",s).attr("stroke","#d2d2d7").attr("stroke-width",1);const p=[18,32,28,55,48,72,65,88,78,95],e=M().domain([0,9]).range([0,d]),w=M().domain([0,100]).range([s,0]),x=T().x((r,v)=>e(v)).y(r=>w(r)).curve(L);m.append("path").attr("d",x(p)).attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",2.5),m.selectAll("circle").data(p).join("circle").attr("cx",(r,v)=>e(v)).attr("cy",r=>w(r)).attr("r",4).attr("fill","#7EC8E3");const g=[{x:e(3),y:w(55),label:"转折点 ↑",tx:-15,ty:-32},{x:e(7),y:w(88),label:"高峰值",tx:-52,ty:22},{x:e(9),y:w(95),label:"终点 95",tx:-58,ty:28}],y=m.append("g").attr("class","ann-layer"),o=g.map(r=>{const v=y.append("g").style("opacity","0");return v.append("line").attr("x1",r.x).attr("y1",r.y).attr("x2",r.x+r.tx*.65).attr("y2",r.y+r.ty*.65).attr("stroke","#F0D264").attr("stroke-width",1.5).attr("marker-end","url(#arrow-marker)"),v.append("text").attr("x",r.x+r.tx).attr("y",r.y+r.ty).attr("fill","#F0D264").attr("font-size",11).attr("font-weight","600").attr("font-family","sans-serif").attr("text-anchor",r.tx<0?"end":"start").text(r.label),v});b.append("defs").append("marker").attr("id","arrow-marker").attr("markerWidth",8).attr("markerHeight",8).attr("refX",6).attr("refY",3).attr("orient","auto").append("path").attr("d","M0,0 L0,6 L8,3 z").attr("fill","#F0D264");let h=!1;t.querySelector("#af-play-btn").addEventListener("click",()=>{h||(h=!0,o.forEach(r=>r.style("opacity","0")),o.forEach((r,v)=>{O.to(r.node(),{opacity:1,duration:.5,delay:v*.8+.2,onComplete:v===o.length-1?()=>{h=!1}:void 0})}))})}function Dt(t){if(!t)return;t.innerHTML=`
    <div class="story-grid">
      <div>
    ...
    </div>`;const a=["一月","二月","三月","四月","五月","六月"],l=[42,68,55,80,63,91],b=["#7EC8E3","#95D5B2","#F0B27A","#B8B8E8","#E07A7A","#F0D264"],n=480,m=260,d=F(t.querySelector(".go-svg-wrap")).append("svg").attr("viewBox",`0 0 ${n} ${m}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","10px"),s={t:15,r:20,b:35,l:45},p=d.append("g").attr("transform",`translate(${s.l},${s.t})`),e=n-s.l-s.r,w=m-s.t-s.b;p.append("line").attr("x1",0).attr("y1",w).attr("x2",e).attr("y2",w).attr("stroke","#d2d2d7");const x=W().domain(a).range([0,e]).padding(.25),g=M().domain([0,100]).range([w,0]);p.selectAll("text.xt").data(a).join("text").attr("class","xt").attr("x",o=>x(o)+x.bandwidth()/2).attr("y",w+16).attr("text-anchor","middle").attr("font-size",11).attr("fill","#6e6e73").text(o=>o);const y=p.selectAll("rect").data(l).join("rect").attr("x",(o,c)=>x(a[c])).attr("y",o=>g(o)).attr("width",x.bandwidth()).attr("height",o=>w-g(o)).attr("fill",(o,c)=>b[c]).attr("rx",3).attr("opacity",.85).style("cursor","pointer");y.on("mouseover",function(o,c){const f=Array.from(this.parentNode.querySelectorAll("rect")).indexOf(this);y.transition().duration(200).attr("fill",(h,r)=>r===f?b[r]:"#d2d2d7").attr("opacity",(h,r)=>r===f?1:.5)}).on("mouseout",()=>{y.transition().duration(200).attr("fill",(o,c)=>b[c]).attr("opacity",.85)})}function Pt(t){if(!t)return;t.innerHTML=`
    <div class="story-grid">
      <div>
    ...
    </div>`;const a=[12,28,22,45,38,62,55,75,68,88],l=480,b=250,n=F(t.querySelector(".sr-svg-wrap")).append("svg").attr("viewBox",`0 0 ${l} ${b}`).attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","10px"),m={t:15,r:15,b:30,l:45},d=n.append("g").attr("transform",`translate(${m.l},${m.t})`),s=l-m.l-m.r,p=b-m.t-m.b;d.append("line").attr("x1",0).attr("y1",p).attr("x2",s).attr("y2",p).attr("stroke","#d2d2d7"),d.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",p).attr("stroke","#d2d2d7");const e=M().domain([0,9]).range([0,s]),w=M().domain([0,100]).range([p,0]),x=d.selectAll("circle.sr-dot").data(a).join("circle").attr("class","sr-dot").attr("cx",(f,h)=>e(h)).attr("cy",f=>w(f)).attr("r",5).attr("fill","#7EC8E3").attr("opacity",0),g=d.append("path").attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",2.5).attr("opacity",0);let y=null;const o=t.querySelector("#sr-step-label");function c(f){if(o&&(o.textContent=`${f} / ${a.length}`),x.attr("opacity",(h,r)=>r<f?.85:0),f>1){const h=a.slice(0,f),r=T().x((v,E)=>e(E)).y(v=>w(v)).curve(L);g.attr("d",r(h)).attr("opacity",1)}else g.attr("opacity",0)}t.querySelector("#sr-play-btn").addEventListener("click",()=>{if(y)return;c(0);let f=0;y=setInterval(()=>{f++,c(f),f>=a.length&&(clearInterval(y),y=null)},500)}),t.querySelector("#sr-reset-btn").addEventListener("click",()=>{y&&(clearInterval(y),y=null),c(0)})}function Rt(t){if(!t)return;t.innerHTML=`
    ...
    </div>`;const a=t.querySelector('div[style*="grid-template-columns"]');window.innerWidth<=600&&a&&(a.style.gridTemplateColumns="1fr");function l(n){const s=F(n).append("svg").attr("viewBox","0 0 300 180").attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","8px"),p={t:15,r:15,b:25,l:35},e=s.append("g").attr("transform",`translate(${p.l},${p.t})`),w=300-p.l-p.r,x=180-p.t-p.b,g=[20,35,28,55,48,70],y=M().domain([0,5]).range([0,w]),o=M().domain([0,80]).range([x,0]),c=T().x((h,r)=>y(r)).y(h=>o(h)).curve(L);e.append("path").attr("d",c(g)).attr("fill","none").attr("stroke","#7EC8E3").attr("stroke-width",2),[{x:y(1),y:o(35),label:"增长?",color:"#E64B35"},{x:y(2),y:o(28),label:"下降!",color:"#F0B27A"},{x:y(3),y:o(55),label:"最高点",color:"#4DBBD5"},{x:y(4),y:o(48),label:"又降了",color:"#00A087"},{x:y(5),y:o(70),label:"高点",color:"#3C5488"}].forEach(h=>{e.append("circle").attr("cx",h.x).attr("cy",h.y).attr("r",6).attr("fill",h.color).attr("opacity",.9),e.append("text").attr("x",h.x+6).attr("y",h.y-6).attr("fill",h.color).attr("font-size",9).attr("font-weight","bold").text(h.label)})}function b(n){const s=F(n).append("svg").attr("viewBox","0 0 300 180").attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","auto").style("background","var(--bg-light-alt)").style("border-radius","8px"),p={t:15,r:15,b:25,l:35},e=s.append("g").attr("transform",`translate(${p.l},${p.t})`),w=300-p.l-p.r,x=180-p.t-p.b,g=[20,35,28,55,48,70],y=M().domain([0,5]).range([0,w]),o=M().domain([0,80]).range([x,0]),c=T().x((r,v)=>y(v)).y(r=>o(r)).curve(L);e.append("path").attr("d",c(g)).attr("fill","none").attr("stroke","#d2d2d7").attr("stroke-width",2);const f=y(5),h=o(70);e.append("circle").attr("cx",f).attr("cy",h).attr("r",6).attr("fill","#7EC8E3"),e.append("line").attr("x1",f).attr("y1",h+8).attr("x2",f-30).attr("y2",h+28).attr("stroke","#7EC8E3").attr("stroke-width",1.5),e.append("text").attr("x",f-34).attr("y",h+38).attr("fill","#7EC8E3").attr("font-size",10).attr("font-weight","600").attr("text-anchor","end").text("季度最高：70")}l(t.querySelector(".sc-bad-wrap")),b(t.querySelector(".sc-good-wrap"))}function jt(t){t&&(Ht(t.querySelector("#story-color-contrast")),Wt(t.querySelector("#story-annotation-flow")),Dt(t.querySelector("#story-grey-out")),Pt(t.querySelector("#story-reveal")),Rt(t.querySelector("#story-compare")),["#story-color-contrast","#story-annotation-flow","#story-grey-out","#story-reveal"].forEach(a=>{const l=document.querySelector(a);l&&O.fromTo(l,{opacity:0,y:40},{opacity:1,y:0,duration:.7,ease:"power2.out",scrollTrigger:{trigger:l,start:"top 82%",toggleActions:"play none none none"}})}))}function ae(){C.cleanupFns=[],C.resizeObservers=[];const t=O.timeline({delay:.2});t.fromTo("#p9-root .hero-eyebrow",{opacity:0,y:20},{opacity:1,y:0,duration:.6,ease:"power3.out"},0),t.fromTo("#p9-root .page-hero-title",{y:30,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.15),t.fromTo("#p9-root .page-hero-sub",{y:20,opacity:0},{opacity:.5,y:0,duration:.8,ease:"power3.out"},.3),t.fromTo("#p9-root .p9-hero-tagline",{y:20,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.45),t.fromTo("#p9-root #p09-quicknav",{y:20,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.6),t.fromTo("#p9-root .p9-scroll-hint",{opacity:0,y:15},{opacity:1,y:0,duration:.6,ease:"power3.out"},.75),document.querySelectorAll("#p09-quicknav .hero-quicknav__item").forEach(b=>{const n=()=>{const m=document.querySelector(b.dataset.target);m&&m.scrollIntoView({behavior:"smooth",block:"start"})};b.addEventListener("click",n),C.cleanupFns.push(()=>b.removeEventListener("click",n))});const a=document.getElementById("p9-prev-btn"),l=document.getElementById("p9-next-btn");if(a){const b=()=>G("m1-p8");a.addEventListener("click",b),C.cleanupFns.push(()=>a.removeEventListener("click",b))}if(l){const b=()=>G("m1-p10");l.addEventListener("click",b),C.cleanupFns.push(()=>l.removeEventListener("click",b))}Ct(document.getElementById("s1-matplotlib-hierarchy")),C.sbGallery=Mt(document.getElementById("s2-seaborn-gallery")),Tt(document.getElementById("s3-mpl-vs-ggplot")),C.annCanvas=qt(document.getElementById("s4-annotate-canvas")),jt(document.getElementById("s5-storytelling")),["#s1-matplotlib-hierarchy h2","#s1-matplotlib-hierarchy p","#s2-seaborn-gallery h2","#s2-seaborn-gallery > div > p","#s3-mpl-vs-ggplot h2","#s3-mpl-vs-ggplot > div > p","#s4-annotate-canvas h2","#s4-annotate-canvas > div > p","#s5-storytelling h2","#s5-storytelling > div > p"].forEach(b=>{const n=document.querySelector(b);n&&et(n,{y:40,stagger:0})})}function re(){tt(),C.cleanupFns.forEach(l=>{try{l()}catch{}}),C.cleanupFns=[];const t=document.querySelector("#s1-matplotlib-hierarchy .mpl-hierarchy-svg svg");t&&t.remove(),C.sbGallery&&(C.sbGallery.destroy(),C.sbGallery=null);const a=document.getElementById("compare-rows");a&&(a.innerHTML=""),C.annCanvas&&(C.annCanvas.destroy(),C.annCanvas=null),C.resizeObservers.forEach(l=>l.disconnect()),C.resizeObservers=[],["#story-color-contrast","#story-annotation-flow","#story-grey-out","#story-reveal","#story-compare"].forEach(l=>{const b=document.querySelector(l);b&&(b.innerHTML="")})}export{re as destroy,ae as init,ee as render};
