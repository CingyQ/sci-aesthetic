const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BTO2Mx9C.js","assets/index-Bzarkv04.css"])))=>i.map(i=>d[i]);
import{_ as I,n as w,g as _}from"./index-BTO2Mx9C.js";import{k as T,g as u,S as C,s as z,c as F,f as v}from"./ScrollAnimations-B5Kyk-Xq.js";const k=[{label:"封面",before:`<div style="width:100%;height:100%;box-sizing:border-box;background:linear-gradient(135deg,#c8d8ee,#dde8ff);padding:40px;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center;">
    ...
    </div>`,after:`<div style="width:100%;height:100%;box-sizing:border-box;background:#1d1d1f;padding:48px;display:flex;flex-direction:column;justify-content:center;">
    ...
    </div>`,caption:"同样的信息，不同的表达"},{label:"图表",before:`<div style="width:100%;height:100%;box-sizing:border-box;background:#fff;padding:40px;">
    ...
    </div>`,after:`<div style="width:100%;height:100%;box-sizing:border-box;background:#fff;padding:44px;display:flex;flex-direction:column;justify-content:center;">
    ...
    </div>`,caption:"8 种颜色变 2 种——数据更清晰"},{label:"结论",before:`<div style="width:100%;height:100%;box-sizing:border-box;background:#fff;padding:40px;display:flex;flex-direction:column;justify-content:center;">
    ...
    <div class="page-scroll home-page">
      ...
      <!-- ====== 模块导航（交错排列）====== -->
      ${M.map((e,s)=>{const t=s%2===1,i=t?"section-dark":"section-light",l=a[e.id]||0;return`
      <section class="${i} home-module-section" id="module-${e.id}">
        <div class="content-wrapper">
          <div class="home-module-card ${t?"reverse":""}" data-color="${e.color}">
            <div class="home-module-visual">
              ...
              <div class="home-module-number" style="color: ${e.color}">${String(s+1).padStart(2,"0")}</div>
            </div>
            <div class="home-module-info">
              ...
              <ul class="home-module-highlights">
                ${e.highlights.map(r=>`<li><span class="highlight-dot" style="background:${e.color}"></span>${r}</li>`).join("")}
              </ul>
              <div class="home-module-footer">
                ...
                <div class="home-module-progress" data-module="${e.id}">
                  <div class="progress-bar-bg">
                    <div class="progress-bar-fill" style="width:${l}%;background:${e.color}"></div>
                  </div>
                  <span class="progress-label">${l>0?`${l}% 已探索`:`${e.pages} 个词条`}</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="section-light home-path-section" id="home-path">
        <div class="content-wrapper">
          ...
          <div class="home-role-selector">
            ${y.map((e,s)=>`
            <button class="home-role-btn ${s===0?"active":""}" data-role="${e.id}">
          ...
          <div class="home-path-display" id="path-display">
            <div class="home-path-tip" id="path-tip">${y[0].tip}</div>
  ...
  `}function S(a){return a.map((e,s)=>`
    <div class="home-path-step" data-step="${s}">
      <div class="home-path-step-num" style="background:${B[e]}">${s+1}</div>
      <div class="home-path-step-info">
        <span class="home-path-step-title" style="color:${B[e]}">${L[e]}</span>
      </div>
      ${s<a.length-1?'<div class="home-path-connector"></div>':""}
    </div>
  `).join("")}let b=null;function j(){const a=document.getElementById("hero-canvas");if(!a)return;const e=a.getContext("2d"),s=window.devicePixelRatio||1;let t,i;const l=window.innerWidth<768,r=l?30:60,x=l?120:160,n=[];function h(){const o=a.parentElement.getBoundingClientRect();t=o.width,i=o.height,a.width=t*s,a.height=i*s,a.style.width=t+"px",a.style.height=i+"px",e.setTransform(s,0,0,s,0,0)}function g(){n.length=0;for(let o=0;o<r;o++)n.push({x:Math.random()*t,y:Math.random()*i,vx:(Math.random()-.5)*.4,vy:(Math.random()-.5)*.4,r:Math.random()*2+1,opacity:Math.random()*.5+.2})}function p(){e.clearRect(0,0,t,i);for(let o=0;o<n.length;o++)for(let m=o+1;m<n.length;m++){const f=n[o].x-n[m].x,E=n[o].y-n[m].y,A=Math.sqrt(f*f+E*E);if(A<x){const $=(1-A/x)*.15;e.strokeStyle=`rgba(126, 200, 227, ${$})`,e.lineWidth=.5,e.beginPath(),e.moveTo(n[o].x,n[o].y),e.lineTo(n[m].x,n[m].y),e.stroke()}}for(const o of n)e.beginPath(),e.arc(o.x,o.y,o.r,0,Math.PI*2),e.fillStyle=`rgba(126, 200, 227, ${o.opacity})`,e.fill()}function d(){for(const o of n)o.x+=o.vx,o.y+=o.vy,(o.x<0||o.x>t)&&(o.vx*=-1),(o.y<0||o.y>i)&&(o.vy*=-1),o.x=Math.max(0,Math.min(t,o.x)),o.y=Math.max(0,Math.min(i,o.y))}function c(){d(),p(),b=requestAnimationFrame(c)}h(),g(),c(),window.__heroResizeHandler=()=>{h(),g()},window.addEventListener("resize",window.__heroResizeHandler)}function N(){j();const a=document.getElementById("hero-explore-btn");a&&a.addEventListener("click",()=>{const t=document.getElementById("module-m1");t&&t.scrollIntoView({behavior:"smooth"})});const e=document.getElementById("hero-search-btn");e&&e.addEventListener("click",()=>{I(()=>import("./index-BTO2Mx9C.js").then(t=>t.S),__vite__mapDeps([0,1])).then(t=>t.openSearch())}),P(),document.querySelectorAll(".home-module-btn[data-route]").forEach(t=>{t.addEventListener("click",i=>{i.preventDefault(),w(t.dataset.route)})}),document.querySelectorAll('[data-route="ref"]').forEach(t=>{t.addEventListener("click",i=>{i.preventDefault(),w("ref")})}),document.querySelectorAll('[data-route="m4-p1"]').forEach(t=>{t.addEventListener("click",i=>{i.preventDefault(),w("m4-p1")})}),u.from(".home-hero-title",{opacity:0,y:40,duration:1,delay:.2,ease:"power3.out"}),u.from(".home-hero-slogan",{opacity:0,y:30,duration:.8,delay:.5,ease:"power3.out"}),u.from(".home-hero-sub",{opacity:0,y:20,duration:.8,delay:.7,ease:"power3.out"}),u.from(".home-hero-actions",{opacity:0,y:20,duration:.8,delay:.9,ease:"power3.out"});const s=document.getElementById("scroll-hint");s&&C.create({trigger:"#home-hero",start:"top top",end:"bottom top",onUpdate:t=>{s.style.opacity=String(1-t.progress*3)}}),document.querySelectorAll(".home-module-card").forEach(t=>{z(t,{scale:.95,start:"top 85%"})}),document.querySelectorAll(".home-stat-num").forEach(t=>{const i=parseInt(t.dataset.target,10);F(t,i,2)}),v(".home-stat-item",{stagger:.2,y:40}),v("#home-showcase .home-showcase-header",{y:40}),v(".home-showcase-wrap",{y:50,duration:.8}),v(".home-path-header",{y:40}),v(".home-role-selector",{y:30}),z(document.querySelector(".home-path-display"),{scale:.95}),R(),O(),v(".home-ref-section .content-wrapper",{y:40})}function P(){const a=document.getElementById("home-showcase-frame"),e=document.getElementById("home-showcase-before"),s=document.getElementById("home-showcase-after"),t=document.getElementById("home-showcase-caption"),i=document.getElementById("home-showcase-label"),l=document.getElementById("home-showcase-tabs");if(!a||!e||!s||!l)return;let r=0,x="before",n=null;k.forEach((p,d)=>{const c=document.createElement("button");c.className="home-showcase-tab"+(d===0?" active":""),c.dataset.idx=d,c.textContent=p.label,c.style.cssText="padding:8px 18px;border-radius:20px;border:1px solid rgba(255,255,255,0.15);background:transparent;color:rgba(255,255,255,0.5);cursor:pointer;font-size:14px;transition:all 0.3s;margin:0 4px;",l.appendChild(c)});function h(p,d){r=p,x=d;const c=k[p];e.innerHTML=c.before,s.innerHTML=c.after,d==="before"?(e.style.opacity="1",s.style.opacity="0",i&&(i.textContent="BEFORE")):(e.style.opacity="0",s.style.opacity="1",i&&(i.textContent="AFTER")),t&&(t.style.opacity="0",setTimeout(()=>{t.textContent=d==="after"?c.caption:"",t.style.opacity=d==="after"?"1":"0"},200)),l.querySelectorAll(".home-showcase-tab").forEach((o,m)=>{const f=m===p;o.style.background=f?"#F0B27A":"transparent",o.style.borderColor=f?"#F0B27A":"rgba(255,255,255,0.15)",o.style.color=f?"#1d1d1f":"rgba(255,255,255,0.5)"})}h(0,"before"),l.addEventListener("click",p=>{const d=p.target.closest(".home-showcase-tab");d&&(h(parseInt(d.dataset.idx),"before"),clearInterval(n),g())}),a.addEventListener("click",()=>{h(r,x==="before"?"after":"before"),clearInterval(n),g()});function g(){n=setInterval(()=>{x==="before"?h(r,"after"):h((r+1)%k.length,"before")},2500)}g(),window.__homeShowcaseTimer=n,window.__homeShowcaseStartAutoPlay=g}function R(){const a=document.querySelectorAll(".home-role-btn");a.forEach(e=>{e.addEventListener("click",()=>{a.forEach(r=>r.classList.remove("active")),e.classList.add("active");const s=e.dataset.role,t=y.find(r=>r.id===s);if(!t)return;const i=document.getElementById("path-steps"),l=document.getElementById("path-tip");l&&(l.textContent=t.tip),i&&(i.style.opacity="0",i.style.transform="translateY(10px)",setTimeout(()=>{i.innerHTML=S(t.path),requestAnimationFrame(()=>{i.style.opacity="1",i.style.transform="translateY(0)"})},200))})})}function O(){document.querySelectorAll(".home-path-step").forEach((e,s)=>{u.from(e,{scrollTrigger:{trigger:e,start:"top 85%",toggleActions:"play none none none"},opacity:0,x:-20,duration:.5,delay:s*.15,ease:"power3.out"})})}function W(){b&&(cancelAnimationFrame(b),b=null),window.__heroResizeHandler&&(window.removeEventListener("resize",window.__heroResizeHandler),delete window.__heroResizeHandler),window.__homeShowcaseTimer&&(clearInterval(window.__homeShowcaseTimer),delete window.__homeShowcaseTimer,delete window.__homeShowcaseStartAutoPlay),T()}export{W as destroy,N as init,q as render};
