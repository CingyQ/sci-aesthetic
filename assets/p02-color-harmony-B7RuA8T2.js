import{k as J,g as N,f as U,s as S}from"./ScrollAnimations-B5Kyk-Xq.js";import{c as W}from"./ChartPreview-BOKNAzxt.js";import{c as O}from"./TabSwitcher-B5dsPqHB.js";import{c as Q}from"./CopyButton-2sIiwDp8.js";import{g as K,r as Z,d as tt,h as et,b as at}from"./color-math-Dw8FC2aa.js";import{n as H}from"./index-B7QL69Hz.js";import{b as T,l as C,a as F,c as D,d as A}from"./transform-B0CMyjPe.js";import{m as rt}from"./max-DBeXZoyG.js";import{l as nt,c as ot}from"./line-rQPvecky.js";import{a as j}from"./arc-BKWW_vAI.js";import{p as it}from"./pie-CAPf6xSx.js";import{s as st,m as lt}from"./stack-Cnqjp3GV.js";import{a as ct}from"./area-CnIeoxsb.js";import"./path-CbwjOpE9.js";import"./math-CRUJxRjv.js";const L={nature:[{name:"Nature Reviews (NPG)",colors:["#E64B35","#4DBBD5","#00A087","#3C5488","#F39B7F","#8491B4","#91D1C2","#DC0000"]},{name:"Nature Methods",colors:["#E64B35","#4DBBD5","#00A087","#3C5488","#F39B7F","#8491B4","#91D1C2","#7E6148"]},{name:"Nature Cell Biology",colors:["#631879","#3C5488","#0072B5","#00A087","#4DBBD5","#E64B35","#F39B7F","#8491B4"]}],science:[{name:"Science (AAAS)",colors:["#3B4992","#EE0000","#008B45","#631879","#008280","#BB0021","#5F559B","#A20056"]},{name:"JAMA",colors:["#374E55","#DF8F44","#00A1D5","#B24745","#79AF97","#6A6599","#80796B","#000000"]},{name:"NEJM",colors:["#BC3C29","#0072B5","#E18727","#20854E","#7876B1","#6F99AD","#FFDC91","#EE4C97"]}],ggsci:[{name:"ggsci npg",colors:["#E64B35","#4DBBD5","#00A087","#3C5488","#F39B7F","#8491B4","#91D1C2","#DC0000"]},{name:"ggsci Lancet",colors:["#00468B","#ED0000","#42B540","#0099B4","#925E9F","#FDAF91","#AD002A","#ADB6B6"]},{name:"ggsci JAMA",colors:["#374E55","#DF8F44","#00A1D5","#B24745","#79AF97","#6A6599","#80796B","#000000"]},{name:"ggsci D3",colors:["#1F77B4","#FF7F0E","#2CA02C","#D62728","#9467BD","#8C564B","#E377C2","#7F7F7F"]}],colorbrewer:[{name:"ColorBrewer Set1",colors:["#E41A1C","#377EB8","#4DAF4A","#984EA3","#FF7F00","#FFFF33","#A65628","#F781BF"]},{name:"ColorBrewer Set2",colors:["#66C2A5","#FC8D62","#8DA0CB","#E78AC3","#A6D854","#FFD92F","#E5C494","#B3B3B3"]},{name:"ColorBrewer Dark2",colors:["#1B9E77","#D95F02","#7570B3","#E7298A","#66A61E","#E6AB02","#A6761D","#666666"]}],colorblind:[{name:"Wong (色盲安全)",colors:["#000000","#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"]},{name:"Tol (色盲安全)",colors:["#332288","#117733","#44AA99","#88CCEE","#DDCC77","#CC6677","#AA4499","#882255"]},{name:"Okabe-Ito",colors:["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7","#000000"]}]},pt=[{id:"nature",label:"Nature"},{id:"science",label:"Science"},{id:"ggsci",label:"ggsci"},{id:"colorbrewer",label:"ColorBrewer"},{id:"colorblind",label:"色盲安全"}],X=[{id:"complementary",label:"互补"},{id:"analogous",label:"类似"},{id:"triadic",label:"三角"},{id:"split-complementary",label:"分裂互补"},{id:"square",label:"方形"}],dt={complementary:"色轮上相隔 180° 的两种颜色，产生最大对比。适合强调数据差异，如对照组 vs 实验组。",analogous:"色轮上相邻的 3 种颜色（±30°），自然和谐。适合表示同类数据的渐变或分组。",triadic:"色轮上均匀分布的 3 种颜色（间隔 120°），活力十足。适合展示 3 个独立类别。","split-complementary":"一种颜色和其互补色两侧各 30° 的颜色，比互补更柔和。保留对比同时避免冲突。",square:"色轮上均匀分布的 4 种颜色（间隔 90°），丰富且均衡。适合 4 组数据的可视化。"},R=[{primary:"#f5f5f7",secondary:"#3C5488",accent:"#E64B35"},{primary:"#0a1628",secondary:"#4DBBD5",accent:"#F39B7F"},{primary:"#f0faf6",secondary:"#00A087",accent:"#DC0000"},{primary:"#2d1b4e",secondary:"#B8B8E8",accent:"#E69F00"}];let a={harmonyType:"complementary",baseHue:0,harmonyCanvas:null,harmonyCtx:null,harmonyAnimFrame:null,harmonyTabSwitcher:null,harmonyChartPreview:null,proportions:[60,30,10],rule603010Colors:{primary:"#f5f5f7",secondary:"#3C5488",accent:"#E64B35"},presetIndex:0,isDraggingDivider:!1,activeDivider:-1,deltaColor1:"#E64B35",deltaColor2:"#4DBBD5",paletteCategory:"nature",paletteTabSwitcher:null,paletteBrowserChart:null,activePaletteColors:null,chartType:"bar",copyButtons:[],cleanupFns:[],resizeObservers:[]};function Ht(){return`
  ...
  `}function jt(){const t=N.timeline({delay:.2});t.to(".m1p2-eyebrow",{opacity:1,y:0,duration:.6,ease:"power3.out"},0),t.fromTo(".m1p2-hero-title",{y:30},{opacity:1,y:0,duration:.8,ease:"power3.out"},.15),t.fromTo(".m1p2-hero-sub",{y:20},{opacity:.5,y:0,duration:.8,ease:"power3.out"},.3),t.fromTo(".m1p2-hero-tagline",{y:20},{opacity:1,y:0,duration:.8,ease:"power3.out"},.45),t.fromTo(".m1p2-hero-nav",{y:20},{opacity:1,y:0,duration:.8,ease:"power3.out"},.6);const e=document.getElementById("m1p2-prev-btn"),r=document.getElementById("m1p2-next-btn");e&&e.addEventListener("click",()=>H("m1-p1")),r&&r.addEventListener("click",()=>H("m1-p3")),ht(),ft(),gt(),yt(),wt(),mt()}function mt(){document.querySelectorAll("#m1p2-hero-nav .hero-quicknav__item").forEach(t=>{const e=()=>{const r=document.querySelector(t.dataset.target);r&&r.scrollIntoView({behavior:"smooth",block:"start"})};t.addEventListener("click",e),a.cleanupFns.push(()=>t.removeEventListener("click",e))})}function ht(){const t=document.getElementById("m1p2-harmony-wheel");if(!t)return;a.harmonyCanvas=t,a.harmonyCtx=t.getContext("2d");const e=window.devicePixelRatio||1,r=600;t.width=r*e,t.height=r*e,a.harmonyCtx.scale(e,e);const i=document.getElementById("m1p2-harmony-tabs");i&&(a.harmonyTabSwitcher=O(i,{tabs:X,activeId:"complementary",onChange:s=>{a.harmonyType=s,$()},variant:"pill"}));const n=document.getElementById("m1p2-hue-slider"),p=document.getElementById("m1p2-hue-value");if(n){const s=()=>{a.baseHue=parseInt(n.value),p&&(p.textContent=a.baseHue+"°"),$()};n.addEventListener("input",s),a.cleanupFns.push(()=>n.removeEventListener("input",s))}const f=s=>{const o=t.getBoundingClientRect(),h=o.width/2,g=o.height/2,c=s.clientX-o.left-h,d=s.clientY-o.top-g,u=Math.sqrt(c*c+d*d),y=Math.min(h,g)*.85,l=y*.55;if(u>=l&&u<=y){let v=Math.atan2(d,c)*180/Math.PI+90;v<0&&(v+=360),a.baseHue=Math.round(v)%360,n&&(n.value=a.baseHue),p&&(p.textContent=a.baseHue+"°"),$()}};t.addEventListener("pointerdown",f),a.cleanupFns.push(()=>t.removeEventListener("pointerdown",f));const m=document.getElementById("m1p2-harmony-chart");m&&(a.harmonyChartPreview=W(m,{width:500,height:280,margin:{top:30,right:30,bottom:40,left:40},bgColor:"#ffffff"})),$()}function $(){const t=a.harmonyCtx,e=a.harmonyCanvas;if(!t||!e)return;const r=600,i=r/2,n=r/2,p=r*.42,f=p*.55;t.clearRect(0,0,r,r);for(let c=0;c<360;c+=1){const d=(c-91)*Math.PI/180,u=(c-89)*Math.PI/180;t.beginPath(),t.arc(i,n,p,d,u),t.arc(i,n,f,u,d,!0),t.closePath(),t.fillStyle=`hsl(${c}, 75%, 55%)`,t.fill()}t.beginPath(),t.arc(i,n,f-2,0,Math.PI*2),t.fillStyle="#fafafa",t.fill();const m=K(a.baseHue,a.harmonyType),s=(p+f)/2;m.length>1&&(t.beginPath(),m.forEach((c,d)=>{const u=(c-90)*Math.PI/180,y=i+Math.cos(u)*s,l=n+Math.sin(u)*s;d===0?t.moveTo(y,l):t.lineTo(y,l)}),t.closePath(),t.strokeStyle="rgba(29,29,31,0.5)",t.lineWidth=2,t.setLineDash([6,4]),t.stroke(),t.setLineDash([]));const o=[];m.forEach(c=>{const d=(c-90)*Math.PI/180,u=i+Math.cos(d)*s,y=n+Math.sin(d)*s,l=et(c,75,55),v=Z(l.r,l.g,l.b);o.push(v),t.beginPath(),t.arc(u,y,16,0,Math.PI*2),t.fillStyle="#fff",t.fill(),t.strokeStyle="rgba(0,0,0,0.15)",t.lineWidth=2,t.stroke(),t.beginPath(),t.arc(u,y,12,0,Math.PI*2),t.fillStyle=v,t.fill()}),t.fillStyle="#1d1d1f",t.font="600 14px Inter, Noto Sans SC, sans-serif",t.textAlign="center",t.textBaseline="middle";const h=X.find(c=>c.id===a.harmonyType);h&&(t.fillText(h.label,i,n-8),t.fillStyle="#86868b",t.font="12px Inter, Noto Sans SC, sans-serif",t.fillText(m.length+" 色",i,n+12)),ut(o);const g=document.getElementById("m1p2-harmony-desc");g&&(g.textContent=dt[a.harmonyType]||""),vt(o)}function ut(t){const e=document.getElementById("m1p2-harmony-swatches");e&&(e.innerHTML=t.map(r=>`
  ...
  `).join(""))}function vt(t){const e=a.harmonyChartPreview;if(!e)return;const r=e.clear(),{innerWidth:i,innerHeight:n}=e,p=t.map((s,o)=>({label:"Var "+(o+1),value:40+Math.sin(o*1.2+.5)*30+20,color:s})),f=T().domain(p.map(s=>s.label)).range([0,i]).padding(.3),m=C().domain([0,110]).range([n,0]);r.append("g").attr("transform",`translate(0,${n})`).call(F(f).tickSize(0)).call(s=>s.select(".domain").attr("stroke","#e0e0e0")).selectAll("text").attr("fill","#888").attr("font-size","11px"),r.append("g").call(D(m).ticks(5).tickSize(-i)).call(s=>s.select(".domain").remove()).call(s=>s.selectAll(".tick line").attr("stroke","#e0e0e0").attr("stroke-dasharray","3,3")).selectAll("text").attr("fill","#888").attr("font-size","11px"),r.selectAll(".bar").data(p).join("rect").attr("class","bar").attr("x",s=>f(s.label)).attr("width",f.bandwidth()).attr("rx",4).attr("fill",s=>s.color).attr("y",n).attr("height",0).transition().duration(500).ease(A).attr("y",s=>m(s.value)).attr("height",s=>n-m(s.value))}function ft(){M(),Y(),I();const t=document.getElementById("m1p2-proportion-bar");if(!t)return;const e=n=>{const p=t.getBoundingClientRect(),f=(n.clientX-p.left)/p.width*100,m=a.proportions[0],s=a.proportions[0]+a.proportions[1],o=Math.abs(f-m),h=Math.abs(f-s);(o<8||h<8)&&(a.isDraggingDivider=!0,a.activeDivider=o<h?0:1,n.preventDefault())},r=n=>{if(!a.isDraggingDivider)return;const p=t.getBoundingClientRect(),f=Math.max(0,Math.min(100,(n.clientX-p.left)/p.width*100));if(a.activeDivider===0){const m=a.proportions[0]+a.proportions[1]-5,s=Math.max(10,Math.min(m,f)),o=s-a.proportions[0];a.proportions[0]=Math.round(s),a.proportions[1]=Math.round(Math.max(5,a.proportions[1]-o)),a.proportions[2]=100-a.proportions[0]-a.proportions[1]}else{const m=a.proportions[0]+5,s=Math.max(m,Math.min(95,f));a.proportions[1]=Math.round(s-a.proportions[0]),a.proportions[2]=Math.round(100-a.proportions[0]-a.proportions[1])}a.proportions[2]<3&&(a.proportions[2]=3,a.proportions[1]=100-a.proportions[0]-3),M(),G(),I()},i=()=>{a.isDraggingDivider=!1,a.activeDivider=-1};t.addEventListener("pointerdown",e),document.addEventListener("pointermove",r),document.addEventListener("pointerup",i),a.cleanupFns.push(()=>{t.removeEventListener("pointerdown",e),document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",i)})}function M(){const t=document.getElementById("m1p2-proportion-bar");if(!t)return;const[e,r,i]=a.proportions,{primary:n,secondary:p,accent:f}=a.rule603010Colors;t.innerHTML=`
    <div style="position:absolute;inset:0;display:flex;">
      ...
      <div style="width:${i}%;background:${f};transition:width 0.1s;display:flex;align-items:center;justify-content:center;">
        <span style="font-size:${i>6?"var(--text-small)":"10px"};font-weight:600;color:${z(f)?"#1d1d1f":"#f5f5f7"};opacity:0.8;">${i>6?i+"%":""}</span>
      </div>
    </div>
  ...
  `,G()}function G(){const t=document.getElementById("m1p2-proportion-labels");if(!t)return;const{primary:e,secondary:r,accent:i}=a.rule603010Colors,[n,p,f]=a.proportions;t.innerHTML=[{label:"背景 / 底色",color:e,pct:n},{label:"主数据色",color:r,pct:p},{label:"强调色",color:i,pct:f}].map(m=>`
  ...
  `).join(""),t.querySelectorAll(".m1p2-preset-btn").forEach(e=>{const r=()=>{const i=parseInt(e.dataset.idx);a.presetIndex=i,a.rule603010Colors={...R[i]},a.proportions=[60,30,10],Y(),M(),I()};e.addEventListener("click",r),a.cleanupFns.push(()=>e.removeEventListener("click",r))}))}function I(){const t=document.getElementById("m1p2-rule-preview");if(!t)return;const{primary:e,secondary:r,accent:i}=a.rule603010Colors,n=z(e),p=n?"#1d1d1f":"#f5f5f7",f=n?"#666":"#aaa";t.innerHTML=`
    <div style="background:${e};border-radius:var(--radius-sm);padding:var(--space-md);min-height:200px;position:relative;transition:background 0.3s;">
      ...
      <div style="display:flex;gap:8px;margin-top:4px;">
        ${["A","B","C","D","E*"].map(m=>`<div style="flex:1;text-align:center;font-size:10px;color:${f};">${m}</div>`).join("")}
      </div>
  ...
  `).join(""),e.forEach((r,i)=>{const n=t.querySelector(`.m1p2-palette-actions[data-idx="${i}"]`);if(!n)return;const p=Q(n,{getText:()=>r.colors.join(", "),label:"复制 HEX",successLabel:"已复制",className:"btn-small"});a.copyButtons.push(p);const f=document.createElement("button");f.className="btn-ghost btn-small",f.textContent="应用到图表",f.style.cssText="font-size:var(--text-small);padding:8px 16px;color:var(--text-on-dark-2);border-color:var(--border-dark);";const m=()=>{a.activePaletteColors=r.colors,P();const s=document.getElementById("m1p2-palette-chart");s&&s.scrollIntoView({behavior:"smooth",block:"center"}),t.querySelectorAll(".m1p2-palette-card").forEach((o,h)=>{o.style.borderColor=h===i?"var(--accent)":"var(--border-dark)"})};f.addEventListener("click",m),n.appendChild(f),a.cleanupFns.push(()=>{f.removeEventListener("click",m),f.remove()})})}function P(){const t=a.paletteBrowserChart;if(!t)return;const e=a.activePaletteColors||L.nature[0].colors,r=a.chartType||"bar",i=t.clear(),{innerWidth:n,innerHeight:p}=t,f="#333",m="#888",s="#e0e0e0",o=(h,g,c=-15)=>{const d=h.length,u=Math.min(60,n/d),y=d*u,l=n-y,v=i.append("g").attr("transform",`translate(${l}, ${c})`);h.forEach((b,B)=>{const x=v.append("g").attr("transform",`translate(${B*u}, 0)`);x.append("rect").attr("width",10).attr("height",10).attr("rx",2).attr("fill",g[B]),x.append("text").attr("x",14).attr("y",9).attr("fill",m).attr("font-size","10px").text(b)})};if(r==="bar"){const h=["Group A","Group B","Group C","Group D"],g=e.slice(0,5).map((l,v)=>({name:"S"+(v+1),color:l})),c=h.flatMap((l,v)=>g.map((b,B)=>({category:l,series:b.name,value:20+Math.sin(v*1.5+B*.7)*30+40,color:b.color}))),d=T().domain(h).range([0,n]).padding(.2),u=T().domain(g.map(l=>l.name)).range([0,d.bandwidth()]).padding(.08),y=C().domain([0,100]).range([p,0]);i.append("g").attr("transform",`translate(0,${p})`).call(F(d).tickSize(0)).call(l=>l.select(".domain").attr("stroke",s)).selectAll("text").attr("fill",m).attr("font-size","11px"),i.append("g").call(D(y).ticks(5).tickSize(-n)).call(l=>l.select(".domain").remove()).call(l=>l.selectAll(".tick line").attr("stroke",s).attr("stroke-dasharray","3,3")).selectAll("text").attr("fill",m).attr("font-size","11px"),i.selectAll(".bar").data(c).join("rect").attr("class","bar").attr("x",l=>d(l.category)+u(l.series)).attr("width",u.bandwidth()).attr("rx",3).attr("fill",l=>l.color).attr("y",p).attr("height",0).transition().duration(600).delay((l,v)=>v*20).ease(A).attr("y",l=>y(l.value)).attr("height",l=>p-y(l.value)),o(g.map(l=>l.name),g.map(l=>l.color))}else if(r==="line"){const h=Math.min(e.length,6),g=8,c=C().domain([0,g-1]).range([0,n]),d=C().domain([0,100]).range([p,0]);i.append("g").attr("transform",`translate(0,${p})`).call(F(c).ticks(g).tickFormat(u=>"T"+u)).call(u=>u.select(".domain").attr("stroke",s)).selectAll("text").attr("fill",m).attr("font-size","11px"),i.append("g").call(D(d).ticks(5).tickSize(-n)).call(u=>u.select(".domain").remove()).call(u=>u.selectAll(".tick line").attr("stroke",s).attr("stroke-dasharray","3,3")).selectAll("text").attr("fill",m).attr("font-size","11px");for(let u=0;u<h;u++){const y=15+u*8,l=5+u*1.2,v=[0,3,-2,4,-1,5,2,3],b=Array.from({length:g},(E,k)=>({x:k,y:Math.min(95,Math.max(5,y+l*k+v[k%v.length]))})),B=nt().x(E=>c(E.x)).y(E=>d(E.y)).curve(ot),x=i.append("path").datum(b).attr("d",B).attr("fill","none").attr("stroke",e[u]).attr("stroke-width",2.5).attr("stroke-linecap","round"),w=x.node().getTotalLength();x.attr("stroke-dasharray",w).attr("stroke-dashoffset",w).transition().duration(800).delay(u*100).ease(A).attr("stroke-dashoffset",0),i.selectAll(`.dot-${u}`).data(b).join("circle").attr("class",`dot-${u}`).attr("cx",E=>c(E.x)).attr("cy",E=>d(E.y)).attr("r",0).attr("fill",e[u]).transition().duration(400).delay((E,k)=>800+u*100+k*40).attr("r",3.5)}o(Array.from({length:h},(u,y)=>"S"+(y+1)),e.slice(0,h))}else if(r==="donut"){const h=Math.min(e.length,8),g=Array.from({length:h},(v,b)=>({value:10+Math.sin(b*1.4)*5+8,color:e[b],label:"Cat "+(b+1)})),c=Math.min(n,p)/2-10,d=j().innerRadius(c*.55).outerRadius(c),y=it().value(v=>v.value).sort(null).padAngle(.02)(g),l=i.append("g").attr("transform",`translate(${n/2},${p/2})`);l.selectAll(".arc").data(y).join("path").attr("class","arc").attr("fill",v=>v.data.color).attr("d",j().innerRadius(c*.55).outerRadius(c*.55)).transition().duration(700).delay((v,b)=>b*60).ease(A).attr("d",d),l.append("text").attr("text-anchor","middle").attr("dy","-0.2em").attr("fill",f).attr("font-size","18px").attr("font-weight","700").text("Total"),l.append("text").attr("text-anchor","middle").attr("dy","1.2em").attr("fill",m).attr("font-size","13px").text(g.reduce((v,b)=>v+b.value,0).toFixed(0)),y.forEach((v,b)=>{const[B,x]=d.centroid(v);v.endAngle-v.startAngle>.3&&l.append("text").attr("x",B).attr("y",x).attr("text-anchor","middle").attr("fill","#fff").attr("font-size","10px").attr("font-weight","600").text(Math.round(v.data.value/g.reduce((w,E)=>w+E.value,0)*100)+"%").attr("opacity",0).transition().delay(700+b*60).duration(300).attr("opacity",1)}),o(g.map(v=>v.label),g.map(v=>v.color))}else if(r==="scatter"){const h=Math.min(e.length,5),g=C().domain([0,100]).range([0,n]),c=C().domain([0,100]).range([p,0]);i.append("g").attr("transform",`translate(0,${p})`).call(F(g).ticks(5)).call(d=>d.select(".domain").attr("stroke",s)).selectAll("text").attr("fill",m).attr("font-size","11px"),i.append("g").call(D(c).ticks(5).tickSize(-n)).call(d=>d.select(".domain").remove()).call(d=>d.selectAll(".tick line").attr("stroke",s).attr("stroke-dasharray","3,3")).selectAll("text").attr("fill",m).attr("font-size","11px"),i.append("text").attr("x",n/2).attr("y",p+38).attr("text-anchor","middle").attr("fill",m).attr("font-size","11px").text("Variable X"),i.append("text").attr("transform","rotate(-90)").attr("x",-p/2).attr("y",-38).attr("text-anchor","middle").attr("fill",m).attr("font-size","11px").text("Variable Y");for(let d=0;d<h;d++){const u=Array.from({length:12},()=>({x:10+d*15+Math.random()*30,y:20+Math.random()*60+Math.sin(d)*10}));i.selectAll(`.scatter-${d}`).data(u).join("circle").attr("class",`scatter-${d}`).attr("cx",y=>g(y.x)).attr("cy",y=>c(y.y)).attr("r",0).attr("fill",e[d]).attr("opacity",.7).transition().duration(500).delay((y,l)=>d*80+l*20).ease(A).attr("r",5)}o(Array.from({length:h},(d,u)=>"Group "+(u+1)),e.slice(0,h))}else if(r==="area"){const h=Math.min(e.length,5),g=10,c=C().domain([0,g-1]).range([0,n]),d=Array.from({length:g},(x,w)=>{const E={x:w};for(let k=0;k<h;k++)E["s"+k]=8+Math.sin(w*.6+k*1.3)*6+10;return E}),u=Array.from({length:h},(x,w)=>"s"+w),l=st().keys(u)(d),v=rt(l[l.length-1],x=>x[1]),b=C().domain([0,v*1.1]).range([p,0]);i.append("g").attr("transform",`translate(0,${p})`).call(F(c).ticks(g).tickFormat(x=>"T"+x)).call(x=>x.select(".domain").attr("stroke",s)).selectAll("text").attr("fill",m).attr("font-size","11px"),i.append("g").call(D(b).ticks(5).tickSize(-n)).call(x=>x.select(".domain").remove()).call(x=>x.selectAll(".tick line").attr("stroke",s).attr("stroke-dasharray","3,3")).selectAll("text").attr("fill",m).attr("font-size","11px");const B=ct().x((x,w)=>c(d[w].x)).y0(x=>b(x[0])).y1(x=>b(x[1])).curve(lt);l.forEach((x,w)=>{i.append("path").datum(x).attr("d",B).attr("fill",e[w]).attr("opacity",0).transition().duration(600).delay(w*80).ease(A).attr("opacity",.8)}),o(Array.from({length:h},(x,w)=>"S"+(w+1)),e.slice(0,h))}}function wt(){U(".page-hero-title, .page-hero-sub"),S("#m1p2-harmony-wheel"),S("#m1p2-proportion-bar"),S("#m1p2-palette-list")}function Rt(){J();const t=document.getElementById("m1p2-styles");t&&t.remove(),a.harmonyTabSwitcher&&a.harmonyTabSwitcher.destroy(),a.paletteTabSwitcher&&a.paletteTabSwitcher.destroy(),a.harmonyChartPreview&&a.harmonyChartPreview.destroy(),a.paletteBrowserChart&&a.paletteBrowserChart.destroy(),a.copyButtons.forEach(e=>e.destroy()),a.harmonyAnimFrame&&cancelAnimationFrame(a.harmonyAnimFrame),a.cleanupFns.forEach(e=>e()),a.resizeObservers.forEach(e=>e.disconnect()),a={harmonyType:"complementary",baseHue:0,harmonyCanvas:null,harmonyCtx:null,harmonyAnimFrame:null,harmonyTabSwitcher:null,harmonyChartPreview:null,proportions:[60,30,10],rule603010Colors:{primary:"#f5f5f7",secondary:"#3C5488",accent:"#E64B35"},presetIndex:0,isDraggingDivider:!1,activeDivider:-1,deltaColor1:"#E64B35",deltaColor2:"#4DBBD5",paletteCategory:"nature",paletteTabSwitcher:null,paletteBrowserChart:null,activePaletteColors:null,chartType:"bar",copyButtons:[],cleanupFns:[],resizeObservers:[]}}function q(t){let e=(t||"").trim();return e.startsWith("#")||(e="#"+e),/^#[0-9A-Fa-f]{6}$/.test(e)?e:/^#[0-9A-Fa-f]{3}$/.test(e)?"#"+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]:null}function z(t){const e=at(t);return e?(.299*e.r+.587*e.g+.114*e.b)/255>.55:!0}export{Rt as destroy,jt as init,Ht as render};
