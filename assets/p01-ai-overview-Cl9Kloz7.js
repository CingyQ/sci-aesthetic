import{k as T,g as L,f as g}from"./ScrollAnimations-B5Kyk-Xq.js";import{n as w}from"./index-BTO2Mx9C.js";let k=[],h=[];function B(){return`<div class="page-scroll">
<style>
...
Style: clean English labels, white background, vector-art style, #1a5276 / #27ae60 palette.`},{id:"carbon",label:"碳循环机制",img:"assets/m2/p01-s4-02-carbon.webp",desc:"森林生态系统碳固存与释放的自然循环机制，含大气-植物-土壤三界面",prompt:`Ecosystem conceptual diagram, natural science style, green-brown palette.
...
Style: naturalistic green vegetation, brown soil, flux values annotated on each arrow.`},{id:"remote",label:"遥感分析 Pipeline",img:"assets/m2/p01-s4-03-remote.webp",desc:"从卫星获取影像到最终地表分类结果的技术分析流程",prompt:`Technical flowchart, dark blue-purple tech style (dark background #1a1a2e, light text).
...
Each step in a rounded rectangle with small icon. Tools annotated: ENVI / Google Earth Engine.`},{id:"micro",label:"微塑料迁移路径",img:"assets/m2/p01-s4-04-micro.webp",desc:"微塑料从塑料制品源头经陆地-水体传输到达海洋的完整迁移过程",prompt:`Environmental science diagram, blue-green palette, natural style, white background.
...
Blue-green gradient from land to ocean. Microplastics shown as orange particles.`},{id:"eco",label:"生态系统服务评估",img:"assets/m2/p01-s4-05-eco.webp",desc:"森林生态系统提供调节/供给/文化/支撑四类服务及其价值框架",prompt:`Academic framework diagram, green color theme, white background.
