import{k as N,g as E,S as R}from"./ScrollAnimations-B5Kyk-Xq.js";import{c as C}from"./CodeEditor-BiI1SvFS.js";import{n as D}from"./index-B4YcIoVC.js";import{s as W,l as B,c as T}from"./transform-CrlstJ90.js";import{l as A}from"./line-Ci26EkcQ.js";import{m as $}from"./monotone-KI2q-aQs.js";import"./path-CbwjOpE9.js";let P=null,S=[];const z=[{num:"01",title:"数据整理",en:"Data Cleaning",icon:"🗂",desc:"在绘图前整理数据，确保格式正确、缺失值处理妥当，是出版级图表的基础。",code:`# R 数据整理示例
library(tidyverse)
...
</div>`}],j=[{id:"svg",name:"SVG",type:"vector",color:"#7EC8E3",best:"网页、演示文稿、可编辑图表",dpi:"无限缩放（分辨率无关）",size:"极小（通常 <100KB）",support:"Inkscape / Illustrator / 浏览器",desc:"Scalable Vector Graphics，基于 XML 的矢量格式。图形由数学路径描述，无论放大到多少倍都保持清晰。可在 Illustrator 中直接编辑各元素，是科研图表后期精调的首选中间格式。",code:`# ggplot2 导出 SVG
...
# \\includegraphics[width=\\columnwidth]{figure1.eps}`}],M=[{name:"Nature",group:"Nature Portfolio",single:"89mm",oneHalf:"120mm",double:"183mm",dpi_line:1e3,dpi_halftone:300,dpi_combo:500,formats:"PDF / EPS / TIFF / PSD",color:"RGB (屏幕) / CMYK (印刷，需向编辑确认)",maxSize:"单图 ≤ 10MB",fonts:"嵌入所有字体；推荐 Helvetica / Arial",notes:"图片在投稿时可先提交低分辨率，接受后再上传高分辨率版本。坐标轴标签不小于 7pt（印刷后）。"},{name:"Science",group:"AAAS",single:"57mm",oneHalf:"120mm",double:"178mm",dpi_line:1e3,dpi_halftone:300,dpi_combo:500,formats:"PDF / EPS / TIFF",color:"CMYK 优先（印刷版），RGB 可接受",maxSize:"单图 ≤ 20MB",fonts:"嵌入字体；禁止 Times New Roman",notes:"Science 单栏比 Nature 更窄（57mm vs 89mm），需特别注意字号换算。图注文字要简洁，不超过 200 字。"},{name:"Cell",group:"Cell Press / Elsevier",single:"85mm",oneHalf:"114mm",double:"174mm",dpi_line:600,dpi_halftone:300,dpi_combo:600,formats:"PDF / EPS / TIFF / PSD",color:"RGB（提交时），CMYK（印刷转换由期刊处理）",maxSize:"单图 ≤ 20MB",fonts:"嵌入字体；推荐 Arial / Helvetica",notes:"Cell 系列线图要求 600 DPI TIFF（而非 300），注意与 Nature 的区别。接受 PSD 分层文件，便于编辑后期调整。"},{name:"PNAS",group:"National Academy of Sciences",single:"87mm",oneHalf:"114mm",double:"178mm",dpi_line:1e3,dpi_halftone:300,dpi_combo:500,formats:"PDF / EPS / TIFF / PNG",color:"RGB 或 CMYK 均可",maxSize:"单图 ≤ 10MB",fonts:"嵌入字体；Arial / Helvetica 常用",notes:"PNAS 接受 PNG 格式（其他顶刊较少），但建议仍使用 TIFF/PDF。图表需清楚标注实验重复次数和统计方法。"},{name:"Lancet",group:"Elsevier / Lancet",single:"83mm",oneHalf:"N/A",double:"171mm",dpi_line:1e3,dpi_halftone:300,dpi_combo:500,formats:"TIFF / EPS",color:"CMYK（印刷导向）",maxSize:"单图 ≤ 5MB",fonts:"嵌入字体；最小 6pt",notes:"Lancet 系列医学期刊对图表格式要求较严格，偏好 TIFF。统计图必须包含置信区间或误差线，数据点不得少于 5 个。"},{name:"NEJM",group:"Massachusetts Medical Society",single:"84mm",oneHalf:"113mm",double:"171mm",dpi_line:1e3,dpi_halftone:300,dpi_combo:600,formats:"PDF / TIFF / EPS",color:"CMYK 或 Grayscale",maxSize:"单图 ≤ 10MB",fonts:"嵌入字体；Times New Roman 或 Arial",notes:"NEJM 允许使用 Times New Roman（罕见的顶刊）。临床数据图表须包含样本量（n）。彩色图表在线版免费，印刷版收费。"}];function ot(){const n=z.map((t,l)=>`
    ...
    ${l<z.length-1?`<div class="p10-wf-connector" id="p10-conn-${l}"></div>`:""}
  `).join(""),o=z.map((t,l)=>`
...
`}function rt(){document.querySelectorAll("#p10-quicknav .hero-quicknav__item").forEach(o=>{o.addEventListener("click",()=>{const a=document.querySelector(o.dataset.target);a&&a.scrollIntoView({behavior:"smooth",block:"start"})})});const n=E.timeline({delay:.2});n.fromTo("#p10-hero .hero-eyebrow",{opacity:0,y:20},{opacity:1,y:0,duration:.6,ease:"power3.out"},0),n.fromTo("#p10-hero .page-hero-title",{y:30,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.15),n.fromTo("#p10-hero .page-hero-sub",{y:20,opacity:0},{opacity:.5,y:0,duration:.8,ease:"power3.out"},.3),n.fromTo("#p10-hero .p10-hero-tagline",{y:20,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.45),n.fromTo("#p10-hero #p10-quicknav",{y:20,opacity:0},{opacity:1,y:0,duration:.8,ease:"power3.out"},.6),n.fromTo("#p10-hero .p10-scroll-hint",{opacity:0,y:15},{opacity:1,y:0,duration:.6,ease:"power3.out"},.75),document.getElementById("p10-prev-btn")?.addEventListener("click",()=>D("m1-p9")),document.getElementById("p10-next-btn")?.addEventListener("click",()=>D("m2-p1")),H(),J(),O(),X(),K(),E&&R&&window.innerWidth>=769&&["#p10-workflow","#p10-format","#p10-dpi","#p10-calc","#p10-journal"].forEach(a=>{const s=document.querySelector(a);if(!s)return;const i=s.querySelectorAll(".p10-section-eyebrow, .p10-section-title, .p10-section-sub");i.length&&E.from(i,{scrollTrigger:{trigger:s,start:"top 85%"},opacity:0,y:40,duration:.8,stagger:.12,ease:"power3.out"})})}function st(){N(),P&&(window.removeEventListener("scroll",P),P=null),S.forEach(n=>{try{n.destroy()}catch{}}),S=[]}function H(){const n=window.innerWidth<=900;z.forEach((o,a)=>{const s=document.getElementById(`p10-wf-code-${a}`);if(s)try{const i=C(s,{code:o.code,language:"r",readOnly:!0});i&&i.destroy&&S.push(i)}catch{s.innerHTML=`<pre style="background:#1a1a2e;padding:16px;border-radius:8px;font-family:var(--font-code);font-size:0.78rem;color:#a1a1a6;white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word;overflow:hidden;">${o.code.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</pre>`}}),n?G():q()}function G(){const n=document.querySelectorAll(".p10-wf-dot"),o=document.querySelectorAll(".p10-wf-panel");function a(s){n.forEach((i,t)=>i.classList.toggle("active",t===s)),o.forEach((i,t)=>{i.style.display=t===s?"flex":"none"})}a(0),o.forEach((s,i)=>{i>0&&(s.style.display="none")}),n.forEach((s,i)=>{s.addEventListener("click",()=>a(i))})}function q(){const n=document.getElementById("p10-wf-body"),o=document.getElementById("p10-wf-left");if(!n||!o)return;let a=0;const s=z.length;function i(f){a=f,document.querySelectorAll(".p10-wf-dot").forEach((c,e)=>{c.classList.toggle("active",e===f)}),document.querySelectorAll(".p10-wf-connector").forEach((c,e)=>{c.classList.toggle("passed",e<f)})}const t=n.offsetHeight,l=o.offsetHeight,m=Math.max(0,t-l);let u=!1;function d(){u||(u=!0,requestAnimationFrame(()=>{const f=Math.max(0,-n.getBoundingClientRect().top);o.style.transform=`translateY(${Math.min(f,m)}px)`;const c=Math.min(s-1,Math.max(0,Math.floor(f/window.innerHeight)));c!==a&&i(c),u=!1}))}P=d,window.addEventListener("scroll",d,{passive:!0}),d(),document.querySelectorAll(".p10-wf-dot").forEach((f,c)=>{f.addEventListener("click",()=>{const e=document.getElementById(`p10-wf-panel-${c}`);e&&e.scrollIntoView({behavior:"smooth",block:"start"})})})}function J(){const n=document.querySelectorAll(".p10-format-tab"),o=document.querySelectorAll(".p10-format-panel");n.forEach(a=>{a.addEventListener("click",()=>{const s=parseInt(a.dataset.fmt);n.forEach((i,t)=>i.classList.toggle("active",t===s)),o.forEach((i,t)=>i.classList.toggle("active",t===s)),requestAnimationFrame(()=>_(s))})}),_(0),j.forEach((a,s)=>{const i=document.getElementById(`p10-fmt-code-${s}`);if(i)try{const t=C(i,{code:a.code,language:"r",readOnly:!0});t&&t.destroy&&S.push(t)}catch{i.innerHTML=`<pre style="background:#0d1117;padding:14px;border-radius:8px;font-size:0.75rem;color:#a1a1a6;white-space:pre-wrap;word-wrap:break-word;overflow-wrap:break-word;overflow:hidden;">${a.code.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}</pre>`}})}function _(n){const o=j[n],a=document.getElementById(`p10-fmt-svg-${n}`);!a||a._rendered||(a._rendered=!0,o.type==="vector"?V(a,o):Y(a,o))}function V(n,o){const a=W(n).append("svg").attr("viewBox","0 0 420 230").attr("preserveAspectRatio","xMidYMid meet").style("width","100%").style("height","100%");a.append("rect").attr("width",420).attr("height",230).attr("fill","#0d1117"),a.append("text").attr("x",210).attr("y",22).attr("text-anchor","middle").attr("fill",o.color).attr("font-size",12).attr("font-family","JetBrains Mono, monospace").text("矢量格式：无限缩放不失真"),a.append("line").attr("x1",210).attr("y1",34).attr("x2",210).attr("y2",210).attr("stroke","#2a2a3a").attr("stroke-width",1).attr("stroke-dasharray","4,3");const s=[0,1,2,3,4,5].map(r=>({x:r,y:[2.1,3.8,2.9,4.5,3.2,5.1][r]})),i=B().domain([0,5]).range([32,188]),t=B().domain([0,6]).range([195,46]);a.append("line").attr("x1",32).attr("y1",195).attr("x2",188).attr("y2",195).attr("stroke","#3a3a4a").attr("stroke-width",1),a.append("line").attr("x1",32).attr("y1",46).attr("x2",32).attr("y2",195).attr("stroke","#3a3a4a").attr("stroke-width",1),[1,3,5].forEach(r=>{a.append("line").attr("x1",28).attr("y1",t(r)).attr("x2",32).attr("y2",t(r)).attr("stroke","#3a3a4a").attr("stroke-width",1)});const l=A().x(r=>i(r.x)).y(r=>t(r.y)).curve($);a.append("path").attr("d",l(s)).attr("fill","none").attr("stroke",o.color).attr("stroke-width",2).attr("stroke-dasharray",function(){return this.getTotalLength()}).attr("stroke-dashoffset",function(){return this.getTotalLength()}).transition().duration(1200).ease(T).attr("stroke-dashoffset",0),s.forEach(r=>{a.append("circle").attr("cx",i(r.x)).attr("cy",t(r.y)).attr("r",0).attr("fill",o.color).attr("stroke","#0d1117").attr("stroke-width",1).transition().delay(1e3).duration(300).attr("r",3.5)}),a.append("text").attr("x",110).attr("y",215).attr("text-anchor","middle").attr("fill","#555").attr("font-size",10).attr("font-family","JetBrains Mono, monospace").text("100% 原始大小"),a.append("rect").attr("x",222).attr("y",38).attr("width",174).attr("height",162).attr("fill","#111520").attr("rx",4);const u=s.slice(1,5),d=B().domain([1,4]).range([234,382]),f=B().domain([2,6]).range([185,50]);a.append("line").attr("x1",234).attr("y1",185).attr("x2",382).attr("y2",185).attr("stroke","#3a3a4a").attr("stroke-width",.8),a.append("line").attr("x1",234).attr("y1",50).attr("x2",234).attr("y2",185).attr("stroke","#3a3a4a").attr("stroke-width",.8);const c=A().x(r=>d(r.x)).y(r=>f(r.y)).curve($);a.append("path").attr("d",c(u)).attr("fill","none").attr("stroke",o.color).attr("stroke-width",2.8).attr("stroke-dasharray",function(){return this.getTotalLength()}).attr("stroke-dashoffset",function(){return this.getTotalLength()}).transition().delay(300).duration(1e3).ease(T).attr("stroke-dashoffset",0),u.forEach(r=>{a.append("circle").attr("cx",d(r.x)).attr("cy",f(r.y)).attr("r",0).attr("fill",o.color).attr("stroke","#0d1117").attr("stroke-width",1.5).transition().delay(1200).duration(300).attr("r",6)}),a.append("rect").attr("x",222).attr("y",38).attr("width",48).attr("height",18).attr("fill",o.color).attr("rx",3),a.append("text").attr("x",246).attr("y",51).attr("text-anchor","middle").attr("fill","#000").attr("font-size",10).attr("font-weight","bold").attr("font-family","JetBrains Mono, monospace").text("×4 zoom"),a.append("text").attr("x",309).attr("y",215).attr("text-anchor","middle").attr("fill",o.color).attr("font-size",10).attr("font-family","JetBrains Mono, monospace").text("依然清晰 ✓")}function Y(n,o){const a=document.createElement("canvas"),s=420,i=230;a.width=s,a.height=i,a.style.width="100%",a.style.height="100%",n.appendChild(a);const t=a.getContext("2d");t.roundRect||(t.roundRect=function(p,v,y,x,w){this.beginPath(),this.moveTo(p+w,v),this.arcTo(p+y,v,p+y,v+x,w),this.arcTo(p+y,v+x,p,v+x,w),this.arcTo(p,v+x,p,v,w),this.arcTo(p,v,p+y,v,w),this.closePath()}),t.fillStyle="#0d1117",t.fillRect(0,0,s,i),t.fillStyle=o.color,t.font='12px "JetBrains Mono", monospace',t.textAlign="center",t.fillText("位图格式：放大后像素化",s/2,22),t.strokeStyle="#2a2a3a",t.setLineDash([4,3]),t.lineWidth=1,t.beginPath(),t.moveTo(210,34),t.lineTo(210,210),t.stroke(),t.setLineDash([]);const l=10,m=36;t.strokeStyle="#3a3a4a",t.lineWidth=1,t.beginPath(),t.moveTo(36+l,36+m),t.lineTo(36+l,158+m),t.stroke(),t.beginPath(),t.moveTo(36+l,158+m),t.lineTo(168+l,158+m),t.stroke();const u=[[36,120],[58,88],[80,108],[102,68],[124,84],[146,54]].map(([p,v])=>[p+l,v+m]);t.strokeStyle=o.color,t.lineWidth=2,t.beginPath(),u.forEach(([p,v],y)=>y===0?t.moveTo(p,v):t.lineTo(p,v)),t.stroke(),u.forEach(([p,v])=>{t.beginPath(),t.arc(p,v,3,0,Math.PI*2),t.fillStyle=o.color,t.fill(),t.strokeStyle="#0d1117",t.lineWidth=1,t.stroke()}),t.fillStyle="#555",t.font='10px "JetBrains Mono", monospace',t.textAlign="center",t.fillText("100% 原始大小",107,215),t.fillStyle="#111520",t.beginPath(),t.roundRect(222,38,174,162,4),t.fill();const d=13,f=228,c=48,e="#0d1117",r=o.color,g=o.color+"88",h=o.color+"33",b=[[e,e,e,g,r,r,g,e,e,e,e,e],[e,e,g,r,r,g,e,e,e,e,e,e],[e,g,r,r,g,e,e,e,e,e,e,e],[g,r,r,h,e,e,e,e,e,e,e,e],[r,r,h,e,e,e,g,r,g,e,e,e],[r,h,e,e,e,g,r,r,g,e,e,e],[h,e,e,e,g,r,r,h,e,e,e,e],[e,e,e,g,r,r,h,e,e,e,e,e],[e,e,g,r,h,e,e,e,g,r,g,e],[e,g,r,h,e,e,e,e,g,r,g,e]];for(let p=0;p<b.length;p++)for(let v=0;v<b[p].length;v++)t.fillStyle=b[p][v],t.fillRect(f+v*d,c+p*d,d-1,d-1);t.strokeStyle="rgba(255,255,255,0.05)",t.lineWidth=.5;for(let p=0;p<=12;p++)t.beginPath(),t.moveTo(f+p*d,c),t.lineTo(f+p*d,c+b.length*d),t.stroke();for(let p=0;p<=b.length;p++)t.beginPath(),t.moveTo(f,c+p*d),t.lineTo(f+12*d,c+p*d),t.stroke();t.fillStyle=o.color,t.beginPath(),t.roundRect(222,38,48,18,3),t.fill(),t.fillStyle="#000",t.font='bold 10px "JetBrains Mono", monospace',t.textAlign="center",t.fillText("×4 zoom",246,51),t.fillStyle="#E07A7A",t.font='10px "JetBrains Mono", monospace',t.textAlign="center",t.fillText("像素化 ✗",309,215)}function O(){const n=[72,150,300,600],o={72:"屏幕显示（模糊）",150:"一般印刷",300:"期刊标准 ✓",600:"顶刊线条图 ✓"};function a(l,m){l.width=300,l.height=300;const d=l.getContext("2d");d.fillStyle="#ffffff",d.fillRect(0,0,300,300);const f=document.createElement("canvas"),c=Math.max(8,Math.round(300*m/300/4));f.width=c,f.height=c;const e=f.getContext("2d");e.fillStyle="#ffffff",e.fillRect(0,0,c,c),e.beginPath(),e.arc(c*.35,c*.4,c*.22,0,Math.PI*2),e.fillStyle="#7EC8E3",e.fill(),e.lineWidth=Math.max(.5,c*.02),e.strokeStyle="#1d1d1f",e.stroke(),e.beginPath(),e.moveTo(c*.1,c*.75),e.lineTo(c*.6,c*.55),e.lineTo(c*.9,c*.7),e.strokeStyle="#95D5B2",e.lineWidth=Math.max(.5,c*.025),e.stroke(),e.font=`${Math.max(4,c*.15)}px Arial`,e.fillStyle="#1d1d1f",e.fillText("ABC",c*.55,c*.4),d.imageSmoothingEnabled=m>=300,d.drawImage(f,0,0,300,300),d.fillStyle="#1d1d1f",d.font="bold 20px Inter, sans-serif",d.textAlign="center",d.fillText(`${m} DPI`,300/2,284)}n.forEach(l=>{const m=document.getElementById(`p10-dpi-canvas-${l}`);m&&a(m,l)});const s=document.querySelectorAll(".p10-dpi-mobile-tab"),i=document.getElementById("p10-dpi-mobile-canvas"),t=document.getElementById("p10-dpi-mobile-label");i&&(a(i,72),t&&(t.textContent=`72 DPI — ${o[72]}`)),s.forEach(l=>{l.addEventListener("click",()=>{const m=parseInt(l.dataset.dpi);s.forEach(u=>u.classList.toggle("active",u.dataset.dpi==m)),i&&a(i,m),t&&(t.textContent=`${m} DPI — ${o[m]||""}`)})})}function X(){const n=document.getElementById("p10-calc-width"),o=document.getElementById("p10-calc-height"),a=document.getElementById("p10-calc-dpi"),s=document.getElementById("p10-calc-format"),i=document.getElementById("p10-res-w"),t=document.getElementById("p10-res-h"),l=document.getElementById("p10-res-mp"),m=document.getElementById("p10-res-size"),u=document.getElementById("p10-calc-code"),d=document.getElementById("p10-calc-warning"),f=document.getElementById("p10-calc-warning-text");if(!n||!i)return;function c(){const e=parseFloat(n.value)||8.9,r=parseFloat(o.value)||6,g=parseInt(a.value)||300,h=s.value,b=Math.round(e/2.54*g),p=Math.round(r/2.54*g),v=b*p,y=(v/1e6).toFixed(2);let x=0;h==="png"?x=v*.6:h==="tiff"?x=v*1.2:h==="jpeg"&&(x=v*.4);const w=x>0?(x/1024/1024).toFixed(1):"—";let k="";h==="png"?k="无损压缩，适合网页与演示文稿":h==="tiff"?k="LZW 无损压缩，期刊提交首选":h==="jpeg"?k="有损压缩，不建议用于期刊投稿":k="矢量格式，ggsave 生成 PDF 文件",i&&(i.innerHTML=`${b.toLocaleString()} <span class="p10-calc-result-unit">px</span>`),t&&(t.innerHTML=`${p.toLocaleString()} <span class="p10-calc-result-unit">px</span>`),l&&(l.innerHTML=`${y} <span class="p10-calc-result-unit">MP</span>`),m&&(m.innerHTML=x>0?`<span class="p10-calc-result-value">${w} MB</span><p class="p10-calc-result-note">${k}</p>`:`<span class="p10-calc-result-value">矢量</span><p class="p10-calc-result-note">${k}</p>`);const I=h==="svg"?"pdf":h,L=I==="tiff"?`,
