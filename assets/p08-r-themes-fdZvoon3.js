...
<section id="p8-patchwork" class="p8-patchwork-section">
  <div class="p8-patchwork-inner">
    ...
    <p class="p8-layout-desc" id="p8-layout-desc">${V[0].desc}</p>
...
</div>`}function ae(){n.cleanupFns=[],n.resizeObservers=[],n.codeEditor=null,n.patchEditor=null;const t=et[0],e=t.groups[0].palettes[0];n.activePkg=t.id,n.activePal=e,n.chartType="bar",n.patchworkLayout="h2",G.fromTo("#p8-hero .hero-eyebrow",{opacity:0,y:30},{opacity:1,y:0,duration:.7,ease:"power3.out",delay:.1}),G.fromTo("#p8-hero .page-hero-title",{opacity:0,y:40},{opacity:1,y:0,duration:.8,ease:"power3.out",delay:.25}),G.fromTo("#p8-hero .page-hero-sub",{opacity:0,y:30},{opacity:.5,y:0,duration:.7,ease:"power3.out",delay:.4}),G.fromTo("#p8-hero .p8-hero-tagline",{opacity:0,y:20},{opacity:1,y:0,duration:.8,ease:"power3.out",delay:.55}),G.fromTo("#p8-quicknav",{opacity:0,y:20},{opacity:1,y:0,duration:.8,ease:"power3.out",delay:.6}),G.fromTo("#p8-hero .p8-scroll-hint",{opacity:0},{opacity:1,duration:.5,ease:"power3.out",delay:.8}),document.querySelectorAll("#p8-quicknav .hero-quicknav__item").forEach(a=>{const l=()=>{const g=document.querySelector(a.dataset.target);g&&g.scrollIntoView({behavior:"smooth",block:"start"})};a.addEventListener("click",l),n.cleanupFns.push(()=>a.removeEventListener("click",l))}),Q(["#p8-browser .p8-sec-header"],{y:40,start:"top 85%"}),Q(["#p8-theme  .p8-sec-header"],{y:40,start:"top 85%"}),Q(["#p8-ggsave .p8-sec-header"],{y:40,start:"top 85%"}),Q(["#p8-patchwork .p8-sec-header"],{y:40,start:"top 85%"}),Mt(),It(),Rt(),qt(),Gt()}function Mt(){document.querySelectorAll("[data-pkg-toggle]").forEach(t=>{const e=()=>{const a=t.dataset.pkgToggle,l=t.nextElementSibling,g=t.querySelector(".p8-pkg-chevron"),c=l.classList.contains("open");document.querySelectorAll(".p8-pkg-body").forEach(d=>d.classList.remove("open")),document.querySelectorAll(".p8-pkg-chevron").forEach(d=>d.classList.remove("open")),document.querySelectorAll(".p8-pkg-header").forEach(d=>d.classList.remove("active")),c||(l.classList.add("open"),g.classList.add("open"),t.classList.add("active"),n.activePkg=a)};t.addEventListener("click",e),n.cleanupFns.push(()=>t.removeEventListener("click",e))}),document.querySelectorAll(".p8-pal-row").forEach(t=>{const e=()=>{document.querySelectorAll(".p8-pal-row").forEach(d=>d.classList.remove("active")),t.classList.add("active");const a=t.dataset.pkg,l=t.dataset.pal,g=et.find(d=>d.id===a);let c=null;g.groups.forEach(d=>{const s=d.palettes.find(m=>m.name===l);s&&(c=s)}),c&&(n.activePkg=a,n.activePal=c,ot(),xt())};t.addEventListener("click",e),n.cleanupFns.push(()=>t.removeEventListener("click",e))}),document.querySelectorAll("#p8-chart-type-tabs .p8-chart-tab").forEach(t=>{const e=()=>{document.querySelectorAll("#p8-chart-type-tabs .p8-chart-tab").forEach(a=>a.classList.remove("active")),t.classList.add("active"),n.chartType=t.dataset.chart,ot()};t.addEventListener("click",e),n.cleanupFns.push(()=>t.removeEventListener("click",e))}),X("p8-copy-color",()=>document.getElementById("p8-scale-color-code")?.textContent||""),X("p8-copy-fill",()=>document.getElementById("p8-scale-fill-code")?.textContent||""),ot(),xt()}function jt(){const t=n.activePal;return t?t.colors:["#7EC8E3","#F0B27A","#95D5B2","#B8B8E8","#E07A7A","#F0D264"]}function ot(){const t=document.getElementById("p8-chart-wrap");if(!t)return;const e=jt();t.innerHTML="";const a=480,l=300,g=nt(t).append("svg").attr("viewBox",`0 0 ${a} ${l}`).attr("preserveAspectRatio","xMidYMid meet");g.append("rect").attr("width",a).attr("height",l).attr("fill","#ffffff");const c={top:20,right:20,bottom:36,left:44},d=a-c.left-c.right,s=l-c.top-c.bottom,m=g.append("g").attr("transform",`translate(${c.left},${c.top})`);if(n.chartType==="bar"){const u=wt.slice(0,Math.min(e.length,6)),i=Pt.slice(0,u.length),p=_t().domain(u).range([0,d]).padding(.25),f=T().domain([0,ht(i)*1.1]).range([s,0]);m.append("g").attr("class","grid").call(S(f).tickSize(-d).tickFormat("")).call(o=>{o.select(".domain").remove(),o.selectAll("line").attr("stroke","#e8e8e8")}),m.selectAll(".bar").data(u).join("rect").attr("class","bar").attr("x",o=>p(o)).attr("y",(o,r)=>f(i[r])).attr("width",p.bandwidth()).attr("height",(o,r)=>s-f(i[r])).attr("fill",(o,r)=>e[r%e.length]).attr("rx",2),m.append("g").attr("transform",`translate(0,${s})`).call(H(p)).call(o=>{o.select(".domain").attr("stroke","#ccc"),o.selectAll("text").attr("fill","#666").attr("font-size","10px"),o.selectAll("line").remove()}),m.append("g").call(S(f).ticks(5)).call(o=>{o.select(".domain").remove(),o.selectAll("text").attr("fill","#666").attr("font-size","10px"),o.selectAll("line").remove()})}else if(n.chartType==="scatter"){const u=[...new Set(tt.map(o=>o.g))].slice(0,Math.min(e.length,4)),i=tt.filter(o=>u.includes(o.g)),p=T().domain([0,9]).range([0,d]),f=T().domain([0,10]).range([s,0]);m.append("g").call(S(f).tickSize(-d).tickFormat("")).call(o=>{o.select(".domain").remove(),o.selectAll("line").attr("stroke","#e8e8e8")}),m.append("g").attr("transform",`translate(0,${s})`).call(H(p).tickSize(-s).tickFormat("")).call(o=>{o.select(".domain").remove(),o.selectAll("line").attr("stroke","#e8e8e8")}),m.selectAll("circle").data(i).join("circle").attr("cx",o=>p(o.x)).attr("cy",o=>f(o.y)).attr("r",4.5).attr("fill",o=>e[o.g%e.length]).attr("opacity",.85),m.append("g").attr("transform",`translate(0,${s})`).call(H(p).ticks(5)).call(o=>{o.select(".domain").attr("stroke","#ccc"),o.selectAll("text").attr("fill","#666").attr("font-size","10px"),o.selectAll("line").remove()}),m.append("g").call(S(f).ticks(5)).call(o=>{o.select(".domain").remove(),o.selectAll("text").attr("fill","#666").attr("font-size","10px"),o.selectAll("line").remove()})}else{const u=Tt.slice(0,Math.min(e.length,4)),i=u.flatMap(r=>r.pts),p=T().domain([0,12]).range([0,d]),f=T().domain([zt(i,r=>r.y)-5,ht(i,r=>r.y)+5]).range([s,0]);m.append("g").call(S(f).tickSize(-d).tickFormat("")).call(r=>{r.select(".domain").remove(),r.selectAll("line").attr("stroke","#e8e8e8")});const o=St().x(r=>p(r.x)).y(r=>f(r.y)).curve(Lt.alpha(.5));u.forEach((r,b)=>{m.append("path").datum(r.pts).attr("fill","none").attr("stroke",e[b%e.length]).attr("stroke-width",2.5).attr("d",o),m.selectAll(`.dot-${b}`).data(r.pts).join("circle").attr("cx",y=>p(y.x)).attr("cy",y=>f(y.y)).attr("r",3).attr("fill",e[b%e.length])}),m.append("g").attr("transform",`translate(0,${s})`).call(H(p).ticks(5)).call(r=>{r.select(".domain").attr("stroke","#ccc"),r.selectAll("text").attr("fill","#666").attr("font-size","10px"),r.selectAll("line").remove()}),m.append("g").call(S(f).ticks(5)).call(r=>{r.select(".domain").remove(),r.selectAll("text").attr("fill","#666").attr("font-size","10px"),r.selectAll("line").remove()})}}function xt(){const t=et.find(m=>m.id===n.activePkg),e=n.activePal;if(!t||!e)return;const a=document.getElementById("p8-active-pal-name"),l=document.getElementById("p8-active-pkg-name"),g=document.getElementById("p8-scale-color-code"),c=document.getElementById("p8-scale-fill-code");a&&(a.textContent=e.name),l&&(l.textContent=t.label);let d="",s="";t.id==="RColorBrewer"?(d=`scale_color_brewer(palette = "${e.name}")`,s=`scale_fill_brewer(palette = "${e.name}")`):t.id==="viridis"?(d=`scale_color_viridis_d(option = "${e.name}")`,s=`scale_fill_viridis_c(option = "${e.name}")`):t.id==="ggsci"?(d=`scale_color_${e.name}()`,s=`scale_fill_${e.name}()`):t.id==="wesanderson"?(d=`scale_color_manual(values = wes_palette("${e.name}"))`,s=`scale_fill_manual(values = wes_palette("${e.name}"))`):t.id==="MetBrewer"&&(d=`scale_color_met_d("${e.name}")`,s=`scale_fill_met_d("${e.name}")`),g&&(g.textContent=d),c&&(c.textContent=s)}function It(){const t=n.themeParams;function e(i,p,f){document.querySelectorAll(`${i} .p8-btn-opt`).forEach(o=>{const r=()=>{document.querySelectorAll(`${i} .p8-btn-opt`).forEach(b=>b.classList.remove("active")),o.classList.add("active"),t[p]=o.dataset[f],z(),P()};o.addEventListener("click",r),n.cleanupFns.push(()=>o.removeEventListener("click",r))})}document.querySelectorAll("#p8-ctrl-tabs .p8-ctrl-tab").forEach(i=>{const p=()=>{document.querySelectorAll("#p8-ctrl-tabs .p8-ctrl-tab").forEach(o=>o.classList.remove("active")),document.querySelectorAll(".p8-ctrl-group-panel").forEach(o=>o.classList.remove("active")),i.classList.add("active");const f=document.querySelector(`.p8-ctrl-group-panel[data-panel="${i.dataset.panel}"]`);f&&f.classList.add("active")};i.addEventListener("click",p),n.cleanupFns.push(()=>i.removeEventListener("click",p))}),e("#p8-base-theme-btns","baseTheme","theme"),e("#p8-font-family-btns","fontFamily","font"),e("#p8-grid-btns","gridLines","grid"),e("#p8-grid-color-btns","gridColor","gridcolor"),e("#p8-axis-btns","axisLines","axis"),e("#p8-ticks-btns","axisTicks","ticks"),e("#p8-legend-pos-btns","legendPos","legendpos"),e("#p8-legend-dir-btns","legendDir","legenddir"),e("#p8-legend-box-btns","legendBox","legendbox"),e("#p8-legend-key-btns","legendKey","legendkey"),e("#p8-title-align-btns","titleAlign","align"),document.querySelectorAll("#p8-mini-pals .p8-mini-pal").forEach(i=>{const p=()=>{document.querySelectorAll("#p8-mini-pals .p8-mini-pal").forEach(o=>o.classList.remove("active")),i.classList.add("active"),t.paletteIdx=parseInt(i.dataset.palIdx);const f=document.getElementById("p8-palette-name-val");f&&(f.textContent=O[t.paletteIdx].name),z(),P()};i.addEventListener("click",p),n.cleanupFns.push(()=>i.removeEventListener("click",p))}),document.querySelectorAll("#p8-bg-swatches .p8-bg-swatch").forEach(i=>{const p=()=>{document.querySelectorAll("#p8-bg-swatches .p8-bg-swatch").forEach(f=>f.classList.remove("active")),i.classList.add("active"),t.bgColor=i.dataset.bg,z(),P()};i.addEventListener("click",p),n.cleanupFns.push(()=>i.removeEventListener("click",p))});const a=document.getElementById("p8-fontsize"),l=document.getElementById("p8-fontsize-val");if(a){const i=()=>{t.fontSize=parseInt(a.value),l&&(l.textContent=t.fontSize),z(),P()};a.addEventListener("input",i),n.cleanupFns.push(()=>a.removeEventListener("input",i))}const g=document.getElementById("p8-axis-angle"),c=document.getElementById("p8-axis-angle-val");if(g){const i=()=>{t.axisAngle=parseInt(g.value),c&&(c.textContent=t.axisAngle+"°"),z(),P()};g.addEventListener("input",i),n.cleanupFns.push(()=>g.removeEventListener("input",i))}const d=document.getElementById("p8-show-title");if(d){const i=()=>{t.showTitle=d.checked;const p=document.getElementById("p8-title-align-group");p&&(p.style.opacity=t.showTitle?"1":"0.4"),z(),P()};d.addEventListener("change",i),n.cleanupFns.push(()=>d.removeEventListener("change",i))}const s=document.getElementById("p8-show-caption");if(s){const i=()=>{t.showCaption=s.checked,z(),P()};s.addEventListener("change",i),n.cleanupFns.push(()=>s.removeEventListener("change",i))}const m=document.getElementById("p8-show-regline");if(m){const i=()=>{t.showRegline=m.checked,z(),P()};m.addEventListener("change",i),n.cleanupFns.push(()=>m.removeEventListener("change",i))}const u=document.getElementById("p8-theme-editor");u&&(n.codeEditor=kt(u,{code:rt(),language:"r",readOnly:!0})),X("p8-theme-copy-btn",()=>rt()),z()}function z(){const t=document.getElementById("p8-theme-chart-box");if(!t)return;const e=n.themeParams;t.innerHTML="";const a=580,l=390,g=nt(t).append("svg").attr("viewBox",`0 0 ${a} ${l}`).attr("preserveAspectRatio","xMidYMid meet"),c=e.bgColor==="#1d1d1f"||e.baseTheme==="dark2",d=c?"#e8e8e8":"#222222",s=c?"#aaaaaa":"#555555",m=O[e.paletteIdx].colors,u=Math.min(m.length,4),i={sans:"Helvetica, Arial, sans-serif",serif:'Georgia, "Times New Roman", serif',mono:'"Courier New", monospace'},p=i[e.fontFamily]||i.sans,f={minimal:{plotBg:e.bgColor,gridMajC:c?"rgba(255,255,255,0.1)":"#e5e5e5",gridMinC:c?"rgba(255,255,255,0.05)":"#f2f2f2",axisLineC:"none",outerBorder:!1},classic:{plotBg:e.bgColor,gridMajC:"none",gridMinC:"none",axisLineC:c?"#aaaaaa":"#333333",outerBorder:!1},bw:{plotBg:e.bgColor,gridMajC:c?"rgba(255,255,255,0.14)":"#dddddd",gridMinC:"none",axisLineC:"none",outerBorder:!0,borderColor:c?"#888888":"#444444"},void:{plotBg:e.bgColor,gridMajC:"none",gridMinC:"none",axisLineC:"none",outerBorder:!1},dark2:{plotBg:"#2a2a2e",gridMajC:"rgba(255,255,255,0.1)",gridMinC:"rgba(255,255,255,0.04)",axisLineC:"none",outerBorder:!1}},o=f[e.baseTheme]||f.minimal,r={light:c?"rgba(255,255,255,0.1)":"#e8e8e8",medium:c?"rgba(255,255,255,0.2)":"#cccccc",white:"rgba(255,255,255,0.9)"},b=o.gridMajC==="none"?"none":r[e.gridColor]||o.gridMajC,y=o.gridMinC==="none"?"none":e.gridColor==="white"?"rgba(255,255,255,0.5)":c?"rgba(255,255,255,0.05)":"#f2f2f2",F=e.legendDir==="horizontal",A=e.legendPos==="none",L=Math.max(7,e.fontSize*.65),E={small:7,medium:9,large:13}[e.legendKey]||9,$=["Group A","Group B","Group C","Group D"].slice(0,u),K=62,N=E+10,M=F?$.length*K:74,j=F?N+4:$.length*N+4,it=e.showTitle,ct=e.showCaption,pt=it?32:0,dt=ct?18:0,Ft=e.axisAngle>30?14:0,h={top:14+pt+(e.legendPos==="top"&&!A?j+6:0),right:e.legendPos==="right"&&!A?M+10:16,bottom:36+dt+Ft+(e.legendPos==="bottom"&&!A?j+8:0),left:e.legendPos==="left"&&!A?M+10:46},k=a-h.left-h.right,w=l-h.top-h.bottom,Et=e.baseTheme==="dark2"?"#1a1a2e":c?"#2a2a2e":"#f0f0f0";g.append("rect").attr("width",a).attr("height",l).attr("fill",Et);const C=g.append("g").attr("transform",`translate(${h.left},${h.top})`);C.append("rect").attr("width",k).attr("height",w).attr("fill",o.plotBg).attr("stroke",o.outerBorder?o.borderColor:"none").attr("stroke-width",o.outerBorder?1:0);const Y=T().domain([0,9]).range([0,k]),I=T().domain([0,10]).range([w,0]);if(e.gridLines!=="none"&&b!=="none"&&(C.append("g").call(S(I).tickSize(-k).tickFormat("").ticks(5)).call(v=>{v.select(".domain").remove(),v.selectAll("line").attr("stroke",b).attr("stroke-width",.7)}),C.append("g").attr("transform",`translate(0,${w})`).call(H(Y).tickSize(-w).tickFormat("").ticks(5)).call(v=>{v.select(".domain").remove(),v.selectAll("line").attr("stroke",b).attr("stroke-width",.7)})),e.gridLines==="both"&&y!=="none"&&C.append("g").call(S(I).tickSize(-k).tickFormat("").ticks(10)).call(v=>{v.select(".domain").remove(),v.selectAll("line").attr("stroke",y).attr("stroke-width",.35).attr("stroke-dasharray","2,3")}),e.axisLines==="show"&&o.axisLineC!=="none"||e.baseTheme==="classic"){const v=o.axisLineC!=="none"?o.axisLineC:c?"#888":"#444";C.append("line").attr("x1",0).attr("y1",w).attr("x2",k).attr("y2",w).attr("stroke",v).attr("stroke-width",.9),C.append("line").attr("x1",0).attr("y1",0).attr("x2",0).attr("y2",w).attr("stroke",v).attr("stroke-width",.9)}if(e.baseTheme==="bw"&&(C.append("line").attr("x1",k).attr("y1",0).attr("x2",k).attr("y2",w).attr("stroke",o.borderColor).attr("stroke-width",.8),C.append("line").attr("x1",0).attr("y1",0).attr("x2",k).attr("y2",0).attr("stroke",o.borderColor).attr("stroke-width",.8)),e.showRegline)for(let v=0;v<u;v++){const x=tt.filter(D=>D.g===v);if(x.length<2)continue;const B=x.length,R=x.reduce((D,_)=>D+_.x,0),q=x.reduce((D,_)=>D+_.y,0),J=x.reduce((D,_)=>D+_.x*_.x,0),U=x.reduce((D,_)=>D+_.x*_.y,0),at=(B*U-R*q)/(B*J-R*R),ft=(q-at*R)/B,vt=0,bt=9,Bt=Math.max(0,Math.min(10,at*vt+ft)),At=Math.max(0,Math.min(10,at*bt+ft));C.append("line").attr("x1",Y(vt)).attr("y1",I(Bt)).attr("x2",Y(bt)).attr("y2",I(At)).attr("stroke",m[v%m.length]).attr("stroke-width",1.2).attr("stroke-dasharray","5,3").attr("opacity",.55)}const Ct=Math.max(3,Math.min(5.5,e.fontSize*.28));tt.filter(v=>v.g<u).forEach(v=>{C.append("circle").attr("cx",Y(v.x)).attr("cy",I(v.y)).attr("r",Ct).attr("fill",m[v.g%m.length]).attr("opacity",.85).attr("stroke",o.plotBg).attr("stroke-width",.5)});const W=c?"#666":"#aaa",gt=Math.max(8,e.fontSize*.72)+"px",mt={outside:4,inside:-4,none:0}[e.axisTicks]||4;if(e.baseTheme!=="void"){const v=C.append("g").attr("transform",`translate(0,${w})`).call(H(Y).ticks(5).tickSize(mt));v.select(".domain").attr("stroke",W),v.selectAll("text").attr("fill",s).attr("font-size",gt).attr("font-family",p),v.selectAll("line").attr("stroke",W),e.axisTicks==="none"&&v.selectAll("line").remove(),e.axisAngle>0&&v.selectAll("text").attr("transform",`rotate(${e.axisAngle})`).attr("text-anchor","start").attr("dx","0.4em");const x=C.append("g").call(S(I).ticks(5).tickSize(mt));x.select(".domain").attr("stroke",W),x.selectAll("text").attr("fill",s).attr("font-size",gt).attr("font-family",p),x.selectAll("line").attr("stroke",W),e.axisTicks==="none"&&x.selectAll("line").remove();const B=Math.max(9,e.fontSize*.82)+"px";g.append("text").attr("x",h.left+k/2).attr("y",l-dt-3).attr("text-anchor","middle").attr("font-size",B).attr("fill",d).attr("font-family",p).text("X Variable"),g.append("text").attr("transform",`translate(12,${h.top+w/2}) rotate(-90)`).attr("text-anchor","middle").attr("font-size",B).attr("fill",d).attr("font-family",p).text("Y Variable")}if(it){const v={left:h.left,center:a/2,right:a-h.right},x={left:"start",center:"middle",right:"end"},B=Math.max(11,e.fontSize*1.05)+"px";g.append("text").attr("x",v[e.titleAlign]||h.left).attr("y",12+pt*.55).attr("text-anchor",x[e.titleAlign]||"start").attr("font-size",B).attr("font-weight",700).attr("fill",d).attr("font-family",p).text("Gene Expression vs. Treatment")}if(ct&&g.append("text").attr("x",a-h.right).attr("y",l-3).attr("text-anchor","end").attr("font-size",Math.max(7,e.fontSize*.6)+"px").attr("fill",s).attr("font-family",p).text("Source: Gene Expression Dataset, 2024"),!A){let v,x;e.legendPos==="right"?(v=h.left+k+8,x=h.top+(w-j)/2):e.legendPos==="bottom"?(v=h.left+(k-M)/2,x=h.top+w+28):e.legendPos==="top"?(v=h.left+(k-M)/2,x=h.top-j-6):e.legendPos==="left"?(v=4,x=h.top+(w-j)/2):(v=h.left+k-M,x=h.top+8);const B=g.append("g").attr("transform",`translate(${v},${x})`);e.legendBox==="rect"&&B.append("rect").attr("x",-4).attr("y",-4).attr("width",M+4).attr("height",j+4).attr("fill","none").attr("stroke",c?"#555":"#ccc").attr("stroke-width",.8).attr("rx",3),$.forEach((R,q)=>{const J=F?q*K:0,U=F?0:q*N;B.append("circle").attr("cx",J+E/2).attr("cy",U+E/2).attr("r",Math.max(3,E/2)).attr("fill",m[q%m.length]),B.append("text").attr("x",J+E+4).attr("y",U+E/2+3.5).attr("font-size",L+"px").attr("fill",d).attr("font-family",p).text(R)})}}function rt(){const t=n.themeParams,a={"#ffffff":'"white"',"#fafafa":'"grey98"',"#f5f5f5":'"grey97"',"#f0f4f8":'"#f0f4f8"',"#fffbf0":'"#fffbf0"',"#1d1d1f":'"#1d1d1f"'}[t.bgColor]||`"${t.bgColor}"`,l={sans:'"Helvetica"',serif:'"Georgia"',mono:'"Courier New"'}[t.fontFamily]||'"Helvetica"',c=O[t.paletteIdx].colors.map(E=>`"${E}"`).join(", "),d=t.gridLines==="none"?"element_blank()":t.gridColor==="light"?'element_line(color = "grey90",  linewidth = 0.4)':t.gridColor==="medium"?'element_line(color = "grey80",  linewidth = 0.5)':'element_line(color = "white",   linewidth = 0.5)',s=t.gridLines==="both"?'element_line(color = "grey95", linewidth = 0.2)':"element_blank()",m=t.axisLines==="show"?'element_line(color = "grey70", linewidth = 0.5)':"element_blank()",u=t.axisTicks==="none"?"element_blank()":'element_line(color = "grey70", linewidth = 0.4)',i=t.axisTicks==="inside"?'unit(-0.15, "cm")':'unit(0.15, "cm")',p=t.axisAngle>0?`element_text(angle = ${t.axisAngle}, hjust = 1, vjust = 1)`:"element_text()",f=`"${t.legendPos}"`,o=`"${t.legendDir}"`,r=t.legendBox==="rect"?'element_rect(color = "grey70", linewidth = 0.5)':"element_blank()",b={small:'unit(0.8, "lines")',medium:'unit(1, "lines")',large:'unit(1.4, "lines")'}[t.legendKey]||'unit(1, "lines")',y=t.titleAlign==="left"?0:t.titleAlign==="center"?.5:1,F=t.showTitle?`element_text(size = ${Math.round(t.fontSize*1.1)}, face = "bold", hjust = ${y})`:"element_blank()",A=t.showCaption?`element_text(size = ${Math.round(t.fontSize*.7)}, hjust = 1, color = "grey50")`:"element_blank()",L=t.showRegline?`
  geom_smooth(method = "lm", se = FALSE,
              linetype = "dashed", alpha = 0.6) +`:"";return`library(ggplot2)

# 配色方案：${O[t.paletteIdx].name}
palette_colors <- c(${c})
...
# print(p)
# dev.off()`,r=document.getElementById("p8-ggsave-code");r&&(r.textContent=o)}function qt(){document.querySelectorAll("#p8-layout-tabs .p8-layout-tab").forEach(e=>{const a=()=>{document.querySelectorAll("#p8-layout-tabs .p8-layout-tab").forEach(l=>l.classList.remove("active")),e.classList.add("active"),n.patchworkLayout=e.dataset.layout,yt()};e.addEventListener("click",a),n.cleanupFns.push(()=>e.removeEventListener("click",a))});const t=document.getElementById("p8-patchwork-editor");t&&(n.patchEditor=kt(t,{code:V[0].code,language:"r",readOnly:!0})),X("p8-patchwork-copy",()=>{const e=V.find(a=>a.id===n.patchworkLayout);return e?e.code:""}),yt()}function yt(){const t=V.find(r=>r.id===n.patchworkLayout);if(!t)return;const e=document.getElementById("p8-layout-desc");e&&(e.textContent=t.desc),n.patchEditor&&n.patchEditor.setCode(t.code);const a=document.getElementById("p8-patchwork-box");if(!a)return;a.innerHTML="";const l=700,g=240,c=nt(a).append("svg").attr("viewBox",`0 0 ${l} ${g}`).attr("preserveAspectRatio","xMidYMid meet");c.append("rect").attr("width",l).attr("height",g).attr("fill","#1a1a2e");const d=["#7EC8E3","#F0B27A","#95D5B2","#B8B8E8"],s=16,m=14,u=8,i=[[.15,.3],[.35,.55],[.55,.25],[.7,.7],[.25,.75],[.8,.4],[.45,.4],[.6,.6]];function p(r,b,y,F,A,L){const E=c.append("g");E.append("rect").attr("x",r).attr("y",b).attr("width",y).attr("height",F).attr("fill",d[L]).attr("opacity",.18).attr("rx",u).attr("stroke",d[L]).attr("stroke-width",1.5);const $=20;i.forEach(([K,N])=>{E.append("circle").attr("cx",r+$+K*(y-$*2)).attr("cy",b+$+N*(F-$*2)).attr("r",2.5).attr("fill",d[L]).attr("opacity",.65)}),E.append("text").attr("x",r+10).attr("y",b+22).attr("font-family","monospace").attr("font-size",m).attr("font-weight",700).attr("fill",d[L]).text(A)}const f=l-s*2,o=g-s*2;if(t.id==="h2"){const r=(f-12)/2;p(s,s,r,o,"A",0),p(s+r+12,s,r,o,"B",1)}else if(t.id==="v2"){const r=(o-12)/2;p(s,s,f,r,"A",0),p(s,s+r+12,f,r,"B",1)}else if(t.id==="h2v"){const r=o*.55,b=o-r-12,y=(f-12)/2;p(s,s,y,r,"A",0),p(s+y+12,s,y,r,"B",1),p(s,s+r+12,f,b,"C",2)}else{const r=(f-12)/2,b=(o-12)/2;p(s,s,r,b,"A",0),p(s+r+12,s,r,b,"B",1),p(s,s+b+12,r,b,"C",2),p(s+r+12,s+b+12,r,b,"D",3)}}function Gt(){const t=document.getElementById("p8-prev-btn"),e=document.getElementById("p8-next-btn");if(t){const a=()=>ut("m1-p7");t.addEventListener("click",a),n.cleanupFns.push(()=>t.removeEventListener("click",a))}if(e){const a=()=>ut("m1-p9");e.addEventListener("click",a),n.cleanupFns.push(()=>e.removeEventListener("click",a))}}function X(t,e){const a=document.getElementById(t);if(!a)return;const l=async()=>{try{await navigator.clipboard.writeText(e()),a.textContent="已复制 ✓",a.classList.add("copied"),setTimeout(()=>{a.textContent="复制",a.classList.remove("copied")},2e3)}catch{}};a.addEventListener("click",l),n.cleanupFns.push(()=>a.removeEventListener("click",l))}function oe(){if(Dt(),n.cleanupFns.forEach(t=>{try{t()}catch{}}),n.cleanupFns=[],n.codeEditor){try{n.codeEditor.destroy()}catch{}n.codeEditor=null}if(n.patchEditor){try{n.patchEditor.destroy()}catch{}n.patchEditor=null}n.resizeObservers.forEach(t=>t.disconnect()),n.resizeObservers=[]}export{oe as destroy,ae as init,ee as render};
