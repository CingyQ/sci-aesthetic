// ref.js — 速查手册（Quick Reference）
// Hero → TabSwitcher (5 tabs) → Footer CTA
...
const CHART_DATA = [
  { cat: '比较', items: [
    { name: '柱状图', en: 'Bar Chart', use: '比较不同类别的数值大小', avoid: '类别超过 12 个' },
    { name: '分组柱状图', en: 'Grouped Bar', use: '比较多组数据在各类别的差异', avoid: '组数超过 4 个' },
    { name: '堆叠柱状图', en: 'Stacked Bar', use: '显示各部分占总体的比例', avoid: '需要精确比较各部分' },
    { name: '棒棒糖图', en: 'Lollipop', use: '替代柱状图，更简洁', avoid: '数据量少于 3 个' },
  ]},
  { cat: '分布', items: [
    { name: '直方图', en: 'Histogram', use: '展示连续变量的频率分布', avoid: '样本量 < 30' },
    { name: '箱线图', en: 'Box Plot', use: '比较多组的中位数和离散度', avoid: '样本量极小（< 5）' },
    { name: '小提琴图', en: 'Violin', use: '展示数据分布形状', avoid: '观众不熟悉统计图表' },
    { name: '密度图', en: 'Density', use: '展示连续变量的概率密度', avoid: '需要展示具体数值' },
  ]},
  { cat: '关系', items: [
    { name: '散点图', en: 'Scatter', use: '展示两个连续变量的关系', avoid: '数据点重叠严重' },
    { name: '气泡图', en: 'Bubble', use: '散点图 + 第三维度（大小）', avoid: '气泡大小差异不明显' },
    { name: '热力图', en: 'Heatmap', use: '展示矩阵数据的模式', avoid: '类别数 < 3' },
    { name: '相关矩阵', en: 'Correlation', use: '展示多变量间的相关性', avoid: '变量 > 20 个' },
  ]},
  { cat: '构成', items: [
    { name: '饼图', en: 'Pie', use: '展示各部分占总体的比例', avoid: '类别 > 5 个；需精确比较' },
    { name: '环形图', en: 'Donut', use: '饼图的现代替代，中心可放数字', avoid: '同饼图' },
    { name: '瀑布图', en: 'Waterfall', use: '展示增减变化过程', avoid: '步骤过多' },
    { name: '面积图', en: 'Area', use: '展示趋势和累积量', avoid: '多系列重叠遮挡' },
  ]},
  { cat: '趋势', items: [
    { name: '折线图', en: 'Line', use: '展示随时间变化的趋势', avoid: '时间点 < 3 个' },
    { name: '阶梯图', en: 'Step', use: '展示离散时间点的变化', avoid: '数据连续变化' },
    { name: '斜率图', en: 'Slope', use: '比较两个时间点的排名变化', avoid: '超过 2 个时间点' },
    { name: '脊线图', en: 'Ridgeline', use: '比较多组分布随时间的变化', avoid: '组数 < 3' },
  ]},
];
...
const PALETTE_DATA = [
  { group: '期刊配色', palettes: [
    ...
    { name: 'Science (AAAS)', colors: ['#3B4992','#EE0000','#008B45','#631879','#008280','#BB0021'] },
    { name: 'Lancet', colors: ['#00468B','#ED0000','#42B540','#0099B4','#925E9F','#FDAF91'] },
    { name: 'JAMA', colors: ['#374E55','#DF8F44','#00A1D5','#B24745','#79AF97','#6A6599'] },
  ]},
  { group: '色盲安全', palettes: [
    { name: 'Okabe-Ito', colors: ['#E69F00','#56B4E9','#009E73','#F0E442','#0072B2','#D55E00','#CC79A7'] },
    { name: 'Wong', colors: ['#000000','#E69F00','#56B4E9','#009E73','#F0E442','#0072B2','#D55E00'] },
    { name: 'Tol Bright', colors: ['#4477AA','#EE6677','#228833','#CCBB44','#66CCEE','#AA3377','#BBBBBB'] },
  ]},
  { group: 'ColorBrewer', palettes: [
    { name: 'Set1', colors: ['#E41A1C','#377EB8','#4DAF4A','#984EA3','#FF7F00','#A65628'] },
    { name: 'Set2', colors: ['#66C2A5','#FC8D62','#8DA0CB','#E78AC3','#A6D854','#FFD92F'] },
    { name: 'Dark2', colors: ['#1B9E77','#D95F02','#7570B3','#E7298A','#66A61E','#E6AB02'] },
    { name: 'Paired', colors: ['#A6CEE3','#1F78B4','#B2DF8A','#33A02C','#FB9A99','#E31A1C'] },
  ]},
  { group: '渐变配色', palettes: [
    { name: 'Viridis', colors: ['#440154','#482777','#3E4989','#31688E','#26828E','#1F9E89','#6DCD59','#FDE725'] },
    { name: 'Plasma', colors: ['#0D0887','#5B02A3','#9A179B','#CB4678','#EB7852','#FBB32F','#F0F921'] },
    { name: 'RdBu', colors: ['#B2182B','#D6604D','#F4A582','#FDDBC7','#D1E5F0','#92C5DE','#4393C3','#2166AC'] },
  ]},
];

const JOURNAL_SPECS = [
  { name: 'Nature', single: '89mm', oneHalf: '120mm', double: '183mm', dpi: '300 (halftone)\n500 (combo)', formats: 'PDF, EPS, TIFF', font: 'Helvetica/Arial', fontSize: '5\u20137pt', notes: '无阴影、无 3D' },
  { name: 'Science', single: '57mm', oneHalf: '120mm', double: '178mm', dpi: '300 (halftone)\n500 (combo)', formats: 'PDF, EPS, TIFF', font: 'Helvetica', fontSize: '6\u20138pt', notes: '禁用衬线字体' },
  { name: 'Cell', single: '85mm', oneHalf: '114mm', double: '178mm', dpi: '300 (halftone)\n600 (line art)', formats: 'PDF, EPS, TIFF', font: 'Arial/Helvetica', fontSize: '6\u20138pt', notes: '白色背景' },
  { name: 'PNAS', single: '87mm', oneHalf: '114mm', double: '178mm', dpi: '300\u2013600', formats: 'PDF, EPS, TIFF, PNG', font: 'Arial', fontSize: '6\u20138pt', notes: '接受 PNG' },
  { name: 'Lancet', single: '83mm', oneHalf: '\u2014', double: '171mm', dpi: '300 (halftone)', formats: 'TIFF, EPS', font: 'Arial', fontSize: '6\u20138pt', notes: '仅 TIFF/EPS' },
  { name: 'NEJM', single: '84mm', oneHalf: '113mm', double: '171mm', dpi: '600 (combo)', formats: 'PDF, EPS, TIFF', font: 'Times New Roman', fontSize: '8\u201310pt', notes: '允许 Times' },
];

const EXPORT_FORMATS = [
  { format: 'SVG', type: '矢量', best: 'Web / 演示文稿', dpi: '无限', size: '<100KB', code: "ggsave('fig.svg', width=8, height=6)" },
  { format: 'PDF', type: '矢量', best: 'Nature/Science 投稿', dpi: '无限', size: '100KB\u20132MB', code: "ggsave('fig.pdf', width=8, height=6)" },
  { format: 'PNG', type: '位图', best: 'PPT / 社交媒体', dpi: '300', size: '500KB\u20135MB', code: "ggsave('fig.png', width=8, height=6, dpi=300)" },
  { format: 'TIFF', type: '位图', best: 'Cell/Lancet 投稿', dpi: '600', size: '5\u201350MB', code: "ggsave('fig.tiff', width=8, height=6, dpi=600, compression='lzw')" },
  { format: 'EPS', type: '矢量', best: 'LaTeX / 旧版期刊', dpi: '无限', size: '100KB\u20131MB', code: "ggsave('fig.eps', width=8, height=6, device=cairo_ps)" },
];

const SHORTCUTS = [
  { cat: '选择', items: [
    { key: 'V', name: '选择工具', desc: '移动/选中对象' },
    { key: 'A', name: '直接选择', desc: '选中锚点/路径' },
  ]},
  { cat: '绘制', items: [
    { key: 'P', name: '钢笔工具', desc: '绘制贝塞尔路径' },
    { key: 'L', name: '直线工具', desc: '绘制直线段' },
    { key: 'M', name: '矩形工具', desc: '绘制矩形/圆角矩形' },
  ]},
  { cat: '编辑', items: [
    { key: 'Ctrl+Z', name: '撤销', desc: '撤销上一步操作' },
    { key: 'Ctrl+G', name: '编组', desc: '将选中对象编组' },
    { key: 'Ctrl+Shift+G', name: '取消编组', desc: '解散当前编组' },
  ]},
  { cat: '视图', items: [
    { key: 'Ctrl+Y', name: '轮廓模式', desc: '切换轮廓/预览视图' },
    { key: 'Ctrl++', name: '放大', desc: '放大视图' },
    { key: 'Ctrl+0', name: '适合画板', desc: '将画板适配到窗口' },
    { key: 'Space', name: '手形工具', desc: '按住拖动平移画布' },
  ]},
];
...
function renderChartsTab() {
  return CHART_DATA.map(group => `
    <div class="ref-chart-group">
      <div class="ref-chart-group-title">${group.cat}</div>
      <div class="ref-chart-grid">
        ${group.items.map(c => `
          <div class="ref-chart-card">
            <div class="ref-chart-name">${c.name}</div>
            <div class="ref-chart-en">${c.en}</div>
            <div class="ref-chart-row"><span>适用：</span>${c.use}</div>
            <div class="ref-chart-row ref-chart-avoid"><span>避免：</span>${c.avoid}</div>
          </div>
        `).join('')}
      </div>
    </div>
...
function renderPalettesTab() {
  return PALETTE_DATA.map(group => `
    <div class="ref-palette-group">
      <div class="ref-palette-group-title">${group.group}</div>
      ${group.palettes.map(p => `
        <div class="ref-palette-row">
          <div class="ref-palette-name">${p.name}</div>
          <div class="ref-palette-swatches">
            ${p.colors.map(c => `<div class="ref-swatch" data-color="${c}" style="background:${c};" title="${c}"></div>`).join('')}
          </div>
        </div>
      `).join('')}
    </div>
    ...
    <div class="ref-table-wrap">
      <table class="ref-table">
        ...
        <tbody>
          ${JOURNAL_SPECS.map(j => `
            <tr>
              <td>${j.name}</td><td>${j.single}</td><td>${j.oneHalf}</td><td>${j.double}</td>
              <td class="ref-dpi-cell">${j.dpi}</td><td>${j.formats}</td>
              <td>${j.font}</td><td>${j.fontSize}</td><td>${j.notes}</td>
            </tr>
          `).join('')}
        </tbody>
      </table>
...
function renderShortcutsTab() {
  return SHORTCUTS.map(group => `
    <div class="ref-shortcut-group">
      <div class="ref-shortcut-group-title">${group.cat}</div>
      <div class="ref-shortcut-list">
        ${group.items.map(s => `
          <div class="ref-shortcut-item">
            <span class="ref-key">${s.key}</span>
            <span class="ref-shortcut-name">${s.name}</span>
            <span class="ref-shortcut-desc">${s.desc}</span>
          </div>
        `).join('')}
      </div>
    </div>
...
function showToast(text) {
  ...
  toast.classList.add('ref-toast-show');
  if (_toastTimer) clearTimeout(_toastTimer);
  _toastTimer = setTimeout(() => {
    toast.classList.remove('ref-toast-show');
  }, 1200);
}
...
function renderTab(id) {
  ...
  const renderers = {
    ...
    palettes: renderPalettesTab,
    journals: renderJournalsTab,
...
function bindTabInteractions(id, container) {
  if (id === 'palettes') {
    const swatches = container.querySelectorAll('.ref-swatch');
    swatches.forEach(sw => {
      const handler = () => copyToClipboard(sw.dataset.color);
      sw.addEventListener('click', handler);
      _eventHandlers.push({ el: sw, type: 'click', fn: handler });
    });
  }

  if (id === 'export') {
    const copyBtns = container.querySelectorAll('.ref-copy-btn');
    copyBtns.forEach(btn => {
      const handler = () => copyToClipboard(btn.dataset.copy);
      btn.addEventListener('click', handler);
      _eventHandlers.push({ el: btn, type: 'click', fn: handler });
    });
  }
}
...
export function init() {
  ...
  heroTl.fromTo('.ref-hero .hero-eyebrow',
    { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.6, ease: 'power3.out' }, 0);
  heroTl.fromTo('.ref-hero .page-hero-title',
    { y: 30, opacity: 0 }, { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' }, 0.15);
  heroTl.fromTo('.ref-hero .page-hero-sub',
    { y: 20, opacity: 0 }, { opacity: 0.5, y: 0, duration: 0.8, ease: 'power3.out' }, 0.3);
  heroTl.fromTo('.ref-hero-tagline',
    { y: 20, opacity: 0 }, { opacity: 1, y: 0, duration: 0.8, ease: 'power3.out' }, 0.45);
  heroTl.fromTo('.ref-scroll-hint',
    { opacity: 0, y: 15 }, { opacity: 1, y: 0, duration: 0.6, ease: 'power3.out' }, 0.6);

  // ── TabSwitcher ──
  const mount = document.getElementById('ref-tabs-mount');
  if (mount) {
    _tabSwitcher = createTabSwitcher(mount, {
      tabs: [
        { id: 'charts', label: '图表选择' },
        { id: 'palettes', label: '配色方案' },
        { id: 'journals', label: '期刊规格' },
        { id: 'export', label: '导出格式' },
        { id: 'shortcuts', label: '快捷键' },
      ],
      activeId: 'charts',
      variant: 'pill',
      onChange: (id) => { renderTab(id); }
    });
  ...
  // ── Tab section fadeIn ──
  fadeIn('#ref-tabs-section', { y: 40, duration: 0.8 });
  ...
  // ── Footer 导航 ──
  const prev = document.getElementById('ref-prev-btn');
  const next = document.getElementById('ref-next-btn');
  if (prev) addEvt(prev, 'click', () => navigateTo('m4-p4'));
  if (next) addEvt(next, 'click', () => navigateTo('home'));
}
